; ModuleID = 'test_add_root_preserves_validity.bc'
source_filename = "test_add_root_preserves_validity.c"
...
@.str = private unnamed_addr constant [9 x i8] c"root_key\00", align 1
@.str.1 = private unnamed_addr constant [11 x i8] c"root_value\00", align 1
@.str.2 = private unnamed_addr constant [44 x i8] c"treetable_add(table, &key, &value) == CC_OK\00", align 1
@.str.3 = private unnamed_addr constant [35 x i8] c"test_add_root_preserves_validity.c\00", align 1
@__PRETTY_FUNCTION__.test_add_root_preserves_validity = private unnamed_addr constant [44 x i8] c"void test_add_root_preserves_validity(void)\00", align 1
@.str.4 = private unnamed_addr constant [27 x i8] c"treetable_size(table) == 1\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_add_root_preserves_validity() #0 !dbg !1053 {
entry:
  %key = alloca i32, align 4
  %value = alloca i32, align 4
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata i32* %key, metadata !1056, metadata !DIExpression()), !dbg !1057
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32 10), !dbg !1058
  store i32 %call, i32* %key, align 4, !dbg !1057
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1059, metadata !DIExpression()), !dbg !1060
  %call1 = call i32 @symbolic_int(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i32 100), !dbg !1061
  store i32 %call1, i32* %value, align 4, !dbg !1060
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1062, metadata !DIExpression()), !dbg !1063
  %call2 = call %struct.treetable_s* @make_table(), !dbg !1064
  store %struct.treetable_s* %call2, %struct.treetable_s** %table, align 8, !dbg !1063
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1065
  %1 = bitcast i32* %key to i8*, !dbg !1065
  %2 = bitcast i32* %value to i8*, !dbg !1065
  %call3 = call i32 @treetable_add(%struct.treetable_s* %0, i8* %1, i8* %2), !dbg !1065
  %cmp = icmp eq i32 %call3, 0, !dbg !1065
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1065

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i64 0, i64 0), i32 23, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__PRETTY_FUNCTION__.test_add_root_preserves_validity, i64 0, i64 0)) #6, !dbg !1065
  unreachable, !dbg !1065

cond.end:                                         ; preds = %entry
  %3 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1066
  %call4 = call i64 @treetable_size(%struct.treetable_s* %3), !dbg !1066
  %cmp5 = icmp eq i64 %call4, 1, !dbg !1066
  br i1 %cmp5, label %cond.end8, label %cond.false7, !dbg !1066

cond.false7:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i64 0, i64 0), i32 24, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__PRETTY_FUNCTION__.test_add_root_preserves_validity, i64 0, i64 0)) #6, !dbg !1066
  unreachable, !dbg !1066

cond.end8:                                        ; preds = %cond.end
  %4 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1067
  %call9 = call i32 @balanced(%struct.treetable_s* %4), !dbg !1067
  %tobool = icmp ne i32 %call9, 0, !dbg !1067
  br i1 %tobool, label %cond.end12, label %cond.false11, !dbg !1067

cond.false11:                                     ; preds = %cond.end8
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i64 0, i64 0), i32 25, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__PRETTY_FUNCTION__.test_add_root_preserves_validity, i64 0, i64 0)) #6, !dbg !1067
  unreachable, !dbg !1067

cond.end12:                                       ; preds = %cond.end8
  %5 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1068
  %call13 = call i32 @sorted(%struct.treetable_s* %5), !dbg !1068
  %tobool14 = icmp ne i32 %call13, 0, !dbg !1068
  br i1 %tobool14, label %cond.end17, label %cond.false16, !dbg !1068

cond.false16:                                     ; preds = %cond.end12
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i64 0, i64 0), i32 26, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__PRETTY_FUNCTION__.test_add_root_preserves_validity, i64 0, i64 0)) #6, !dbg !1068
  unreachable, !dbg !1068

cond.end17:                                       ; preds = %cond.end12
  %6 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1069
  call void @treetable_destroy(%struct.treetable_s* %6), !dbg !1070
  ret void, !dbg !1071
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @symbolic_int(i8* %name, i32 %concrete_fallback) #0 !dbg !1072 {
entry:
  %name.addr = alloca i8*, align 8
  %concrete_fallback.addr = alloca i32, align 4
  %value = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %name.addr, metadata !1078, metadata !DIExpression()), !dbg !1079
  store i32 %concrete_fallback, i32* %concrete_fallback.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %concrete_fallback.addr, metadata !1080, metadata !DIExpression()), !dbg !1081
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1082, metadata !DIExpression()), !dbg !1083
  %0 = load i32, i32* %concrete_fallback.addr, align 4, !dbg !1084
  store i32 %0, i32* %value, align 4, !dbg !1083
  %1 = bitcast i32* %value to i8*, !dbg !1085
  %2 = load i8*, i8** %name.addr, align 8, !dbg !1086
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %2), !dbg !1087
  %3 = load i32, i32* %value, align 4, !dbg !1088
  ret i32 %3, !dbg !1089
}

; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1090 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1093, metadata !DIExpression()), !dbg !1094
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1095, metadata !DIExpression()), !dbg !1096
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1096
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1097
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1098
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1099
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1100
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1101
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1102
  %cmp = icmp eq i32 %call, 0, !dbg !1102
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1102

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1102
  unreachable, !dbg !1102

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1103
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1103
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1103

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.9, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1103
  unreachable, !dbg !1103

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1104
  ret %struct.treetable_s* %1, !dbg !1105
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1106 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_add_root_preserves_validity(), !dbg !1109
  ret i32 0, !dbg !1110
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1111 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1112, metadata !DIExpression()), !dbg !1113
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1114, metadata !DIExpression()), !dbg !1115
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1116, metadata !DIExpression()), !dbg !1117
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1118
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1119
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1119
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1117
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1120
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1121
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1121
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1122
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1123
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1124
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1125
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1127
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1127
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1128
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1129
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1129
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1130
  br i1 %cmp, label %if.then, label %if.end, !dbg !1131

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1132
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1133
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1134
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1134
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1135
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1136
  br label %if.end, !dbg !1133

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1137
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1138
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1138
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1139
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1140
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1141
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1142
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1144
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1144
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1145
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1146
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1146
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1147
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1148

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1149
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1150
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1151
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1152
  br label %if.end20, !dbg !1150

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1153
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1155
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1156
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1156
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1157
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1157
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1158
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1159

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1160
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1161
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1162
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1162
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1163
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1164
  br label %if.end20, !dbg !1161

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1165
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1166
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1167
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1167
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1168
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1169
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1170
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1171
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1172
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1173
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1174
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1175
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1176
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1177
  ret void, !dbg !1178
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1179 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1180, metadata !DIExpression()), !dbg !1181
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1182, metadata !DIExpression()), !dbg !1183
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1184, metadata !DIExpression()), !dbg !1185
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1186
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1187
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1187
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1185
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1188
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1189
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1189
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1190
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1191
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1192
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1193
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1195
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1195
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1196
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1197
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1197
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1198
  br i1 %cmp, label %if.then, label %if.end, !dbg !1199

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1200
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1201
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1202
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1202
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1203
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1204
  br label %if.end, !dbg !1201

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1205
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1206
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1206
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1207
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1208
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1209
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1210
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1212
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1212
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1213
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1214
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1214
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1215
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1216

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1217
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1218
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1219
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1220
  br label %if.end20, !dbg !1218

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1221
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1223
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1224
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1224
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1225
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1225
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1226
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1227

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1228
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1229
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1230
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1230
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1231
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1232
  br label %if.end20, !dbg !1229

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1233
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1234
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1235
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1235
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1236
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1237
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1238
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1239
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1240
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1241
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1242
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1243
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1244
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1245
  ret void, !dbg !1246
}
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1247 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1248, metadata !DIExpression()), !dbg !1249
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1250, metadata !DIExpression()), !dbg !1251
  %0 = load i64, i64* %size.addr, align 8, !dbg !1252
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1253
  store i8* %call, i8** %ptr, align 8, !dbg !1251
  %1 = load i8*, i8** %ptr, align 8, !dbg !1254
  %cmp = icmp ne i8* %1, null, !dbg !1255
  %conv = zext i1 %cmp to i32, !dbg !1255
  %conv1 = sext i32 %conv to i64, !dbg !1254
  call void @klee_assume(i64 %conv1), !dbg !1256
  %2 = load i8*, i8** %ptr, align 8, !dbg !1257
  ret i8* %2, !dbg !1258
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1259 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1260, metadata !DIExpression()), !dbg !1261
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1262, metadata !DIExpression()), !dbg !1263
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1264, metadata !DIExpression()), !dbg !1265
  %0 = load i64, i64* %count.addr, align 8, !dbg !1266
  %1 = load i64, i64* %size.addr, align 8, !dbg !1267
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1268
  store i8* %call, i8** %ptr, align 8, !dbg !1265
  %2 = load i8*, i8** %ptr, align 8, !dbg !1269
  %cmp = icmp ne i8* %2, null, !dbg !1270
  %conv = zext i1 %cmp to i32, !dbg !1270
  %conv1 = sext i32 %conv to i64, !dbg !1269
  call void @klee_assume(i64 %conv1), !dbg !1271
  %3 = load i8*, i8** %ptr, align 8, !dbg !1272
  ret i8* %3, !dbg !1273
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1274 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1280, metadata !DIExpression()), !dbg !1281
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1282, metadata !DIExpression()), !dbg !1283
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1284, metadata !DIExpression()), !dbg !1285
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1286, metadata !DIExpression()), !dbg !1288
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1289
  store i8* %0, i8** %dest, align 8, !dbg !1288
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1290, metadata !DIExpression()), !dbg !1291
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1292
  store i8* %1, i8** %src, align 8, !dbg !1291
  br label %while.cond, !dbg !1293

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1294
  %dec = add i64 %2, -1, !dbg !1294
  store i64 %dec, i64* %len.addr, align 8, !dbg !1294
  %cmp = icmp ugt i64 %2, 0, !dbg !1295
  br i1 %cmp, label %while.body, label %while.end, !dbg !1293

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1296
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1296
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1296
  %4 = load i8, i8* %3, align 1, !dbg !1297
  %5 = load i8*, i8** %dest, align 8, !dbg !1298
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1298
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1298
  store i8 %4, i8* %5, align 1, !dbg !1299
  br label %while.cond, !dbg !1293, !llvm.loop !1300

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1301
  ret i8* %6, !dbg !1302
}
...
!1 = !DIFile(filename: "test_add_root_preserves_validity.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_add_root_preserves_validity", scope: !1, file: !1, line: 16, type: !1054, scopeLine: 17, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "key", scope: !1053, file: !1, line: 18, type: !18)
!1057 = !DILocation(line: 18, column: 9, scope: !1053)
!1058 = !DILocation(line: 18, column: 17, scope: !1053)
!1059 = !DILocalVariable(name: "value", scope: !1053, file: !1, line: 19, type: !18)
!1060 = !DILocation(line: 19, column: 9, scope: !1053)
!1061 = !DILocation(line: 19, column: 17, scope: !1053)
!1062 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 21, type: !107)
!1063 = !DILocation(line: 21, column: 16, scope: !1053)
!1064 = !DILocation(line: 21, column: 24, scope: !1053)
!1065 = !DILocation(line: 23, column: 5, scope: !1053)
!1066 = !DILocation(line: 24, column: 5, scope: !1053)
!1067 = !DILocation(line: 25, column: 5, scope: !1053)
!1068 = !DILocation(line: 26, column: 5, scope: !1053)
!1069 = !DILocation(line: 28, column: 23, scope: !1053)
!1070 = !DILocation(line: 28, column: 5, scope: !1053)
!1071 = !DILocation(line: 29, column: 1, scope: !1053)
!1072 = distinct !DISubprogram(name: "symbolic_int", scope: !1073, file: !1073, line: 32, type: !1074, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1073 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1074 = !DISubroutineType(types: !1075)
!1075 = !{!18, !1076, !18}
!1076 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1077, size: 64)
!1077 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1078 = !DILocalVariable(name: "name", arg: 1, scope: !1072, file: !1073, line: 32, type: !1076)
!1079 = !DILocation(line: 32, column: 37, scope: !1072)
!1080 = !DILocalVariable(name: "concrete_fallback", arg: 2, scope: !1072, file: !1073, line: 32, type: !18)
!1081 = !DILocation(line: 32, column: 47, scope: !1072)
!1082 = !DILocalVariable(name: "value", scope: !1072, file: !1073, line: 34, type: !18)
!1083 = !DILocation(line: 34, column: 9, scope: !1072)
!1084 = !DILocation(line: 34, column: 17, scope: !1072)
!1085 = !DILocation(line: 35, column: 24, scope: !1072)
!1086 = !DILocation(line: 35, column: 47, scope: !1072)
!1087 = !DILocation(line: 35, column: 5, scope: !1072)
!1088 = !DILocation(line: 36, column: 12, scope: !1072)
!1089 = !DILocation(line: 36, column: 5, scope: !1072)
!1090 = distinct !DISubprogram(name: "make_table", scope: !1073, file: !1073, line: 53, type: !1091, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1091 = !DISubroutineType(types: !1092)
!1092 = !{!107}
!1093 = !DILocalVariable(name: "conf", scope: !1090, file: !1073, line: 55, type: !67)
!1094 = !DILocation(line: 55, column: 19, scope: !1090)
!1095 = !DILocalVariable(name: "table", scope: !1090, file: !1073, line: 56, type: !107)
!1096 = !DILocation(line: 56, column: 16, scope: !1090)
!1097 = !DILocation(line: 57, column: 5, scope: !1090)
!1098 = !DILocation(line: 58, column: 10, scope: !1090)
!1099 = !DILocation(line: 58, column: 22, scope: !1090)
!1100 = !DILocation(line: 59, column: 10, scope: !1090)
!1101 = !DILocation(line: 59, column: 22, scope: !1090)
!1102 = !DILocation(line: 60, column: 5, scope: !1090)
!1103 = !DILocation(line: 61, column: 5, scope: !1090)
!1104 = !DILocation(line: 62, column: 12, scope: !1090)
!1105 = !DILocation(line: 62, column: 5, scope: !1090)
!1106 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 31, type: !1107, scopeLine: 32, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!
!1206 = !DILocation(line: 527, column: 20, scope: !1179)
!1207 = !DILocation(line: 527, column: 5, scope: !1179)
!1208 = !DILocation(line: 527, column: 8, scope: !1179)
!1209 = !DILocation(line: 527, column: 15, scope: !1179)
!1210 = !DILocation(line: 529, column: 9, scope: !1211)
!1211 = distinct !DILexicalBlock(scope: !1179, file: !30, line: 529, column: 9)
!1212 = !DILocation(line: 529, column: 12, scope: !1211)
!1213 = !DILocation(line: 529, column: 22, scope: !1211)
!1214 = !DILocation(line: 529, column: 29, scope: !1211)
!1215 = !DILocation(line: 529, column: 19, scope: !1211)
!1216 = !DILocation(line: 529, column: 9, scope: !1179)
!1217 = !DILocation(line: 530, column: 23, scope: !1211)
!1218 = !DILocation(line: 530, column: 9, scope: !1211)
!1219 = !DILocation(line: 530, column: 16, scope: !1211)
!1220 = !DILocation(line: 530, column: 21, scope: !1211)
!1221 = !DILocation(line: 531, column: 14, scope: !1222)
!1222 = distinct !DILexicalBlock(scope: !1211, file: !30, line: 531, column: 14)
!1223 = !DILocation(line: 531, column: 19, scope: !1222)
!1224 = !DILocation(line: 531, column: 22, scope: !1222)
!1225 = !DILocation(line: 531, column: 30, scope: !1222)
!1226 = !DILocation(line: 531, column: 16, scope: !1222)
!1227 = !DILocation(line: 531, column: 14, scope: !1211)
!1228 = !DILocation(line: 532, column: 28, scope: !1222)
!1229 = !DILocation(line: 532, column: 9, scope: !1222)
!1230 = !DILocation(line: 532, column: 12, scope: !1222)
!1231 = !DILocation(line: 532, column: 20, scope: !1222)
!1232 = !DILocation(line: 532, column: 26, scope: !1222)
!1233 = !DILocation(line: 534, column: 27, scope: !1222)
!1234 = !DILocation(line: 534, column: 9, scope: !1222)
!1235 = !DILocation(line: 534, column: 12, scope: !1222)
!1236 = !DILocation(line: 534, column: 20, scope: !1222)
!1237 = !DILocation(line: 534, column: 25, scope: !1222)
!1238 = !DILocation(line: 536, column: 17, scope: !1179)
!1239 = !DILocation(line: 536, column: 5, scope: !1179)
!1240 = !DILocation(line: 536, column: 8, scope: !1179)
!1241 = !DILocation(line: 536, column: 15, scope: !1179)
!1242 = !DILocation(line: 537, column: 17, scope: !1179)
!1243 = !DILocation(line: 537, column: 5, scope: !1179)
!1244 = !DILocation(line: 537, column: 8, scope: !1179)
!1245 = !DILocation(line: 537, column: 15, scope: !1179)
!1246 = !DILocation(line: 538, column: 1, scope: !1179)
!1247 = distinct !DISubprogram(name: "safe_malloc", scope: !1073, file: !1073, line: 39, type: !75, scopeLine: 40, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1248 = !DILocalVariable(name: "size", arg: 1, scope: !1247, file: !1073, line: 39, type: !77)
!1249 = !DILocation(line: 39, column: 33, scope: !1247)
!1250 = !DILocalVariable(name: "ptr", scope: !1247, file: !1073, line: 41, type: !19)
!1251 = !DILocation(line: 41, column: 11, scope: !1247)
!1252 = !DILocation(line: 41, column: 24, scope: !1247)
!1253 = !DILocation(line: 41, column: 17, scope: !1247)
!1254 = !DILocation(line: 42, column: 17, scope: !1247)
!1255 = !DILocation(line: 42, column: 21, scope: !1247)
!1256 = !DILocation(line: 42, column: 5, scope: !1247)
!1257 = !DILocation(line: 43, column: 12, scope: !1247)
!1258 = !DILocation(line: 43, column: 5, scope: !1247)
!1259 = distinct !DISubprogram(name: "safe_calloc", scope: !1073, file: !1073, line: 46, type: !82, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1260 = !DILocalVariable(name: "count", arg: 1, scope: !1259, file: !1073, line: 46, type: !77)
!1261 = !DILocation(line: 46, column: 33, scope: !1259)
!1262 = !DILocalVariable(name: "size", arg: 2, scope: !1259, file: !1073, line: 46, type: !77)
!1263 = !DILocation(line: 46, column: 47, scope: !1259)
!1264 = !DILocalVariable(name: "ptr", scope: !1259, file: !1073, line: 48, type: !19)
!1265 = !DILocation(line: 48, column: 11, scope: !1259)
!1266 = !DILocation(line: 48, column: 24, scope: !1259)
!1267 = !DILocation(line: 48, column: 31, scope: !1259)
!1268 = !DILocation(line: 48, column: 17, scope: !1259)
!1269 = !DILocation(line: 49, column: 17, scope: !1259)
!1270 = !DILocation(line: 49, column: 21, scope: !1259)
!1271 = !DILocation(line: 49, column: 5, scope: !1259)
!1272 = !DILocation(line: 50, column: 12, scope: !1259)
!1273 = !DILocation(line: 50, column: 5, scope: !1259)
!1274 = distinct !DISubprogram(name: "memcpy", scope: !1275, file: !1275, line: 12, type: !1276, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1275 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1276 = !DISubroutineType(types: !1277)
!1277 = !{!19, !19, !33, !1278}
!1278 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1279, line: 46, baseType: !79)
!1279 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1280 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1274, file: !1275, line: 12, type: !19)
!1281 = !DILocation(line: 12, column: 20, scope: !1274)
!1282 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1274, file: !1275, line: 12, type: !33)
!1283 = !DILocation(line: 12, column: 42, scope: !1274)
!1284 = !DILocalVariable(name: "len", arg: 3, scope: !1274, file: !1275, line: 12, type: !1278)
!1285 = !DILocation(line: 12, column: 58, scope: !1274)
!1286 = !DILocalVariable(name: "dest", scope: !1274, file: !1275, line: 13, type: !1287)
!1287 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1288 = !DILocation(line: 13, column: 9, scope: !1274)
!1289 = !DILocation(line: 13, column: 16, scope: !1274)
!1290 = !DILocalVariable(name: "src", scope: !1274, file: !1275, line: 14, type: !1076)
!1291 = !DILocation(line: 14, column: 15, scope: !1274)
!1292 = !DILocation(line: 14, column: 21, scope: !1274)
!1293 = !DILocation(line: 16, column: 3, scope: !1274)
!1294 = !DILocation(line: 16, column: 13, scope: !1274)
!1295 = !DILocation(line: 16, column: 16, scope: !1274)
!1296 = !DILocation(line: 17, column: 19, scope: !1274)
!1297 = !DILocation(line: 17, column: 15, scope: !1274)
!1298 = !DILocation(line: 17, column: 10, scope: !1274)
!1299 = !DILocation(line: 17, column: 13, scope: !1274)
!1300 = distinct !{!1300, !1293, !1296, !332}
!1301 = !DILocation(line: 18, column: 10, scope: !1274)
!1302 = !DILocation(line: 18, column: 3, scope: !1274)
