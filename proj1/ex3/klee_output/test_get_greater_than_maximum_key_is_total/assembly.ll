; ModuleID = 'test_get_greater_than_maximum_key_is_total.bc'
source_filename = "test_get_greater_than_maximum_key_is_total.c"
...
@.str = private unnamed_addr constant [18 x i8] c"greater_max_value\00", align 1
@.str.1 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k1, &value) == CC_OK\00", align 1
@.str.2 = private unnamed_addr constant [45 x i8] c"test_get_greater_than_maximum_key_is_total.c\00", align 1
@__PRETTY_FUNCTION__.test_get_greater_than_maximum_key_is_total = private unnamed_addr constant [54 x i8] c"void test_get_greater_than_maximum_key_is_total(void)\00", align 1
@.str.3 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k2, &value) == CC_OK\00", align 1
@.str.4 = private unnamed_addr constant [50 x i8] c"status == CC_OK || status == CC_ERR_KEY_NOT_FOUND\00", align 1
@.str.5 = private unnamed_addr constant [16 x i8] c"balanced(table)\00", align 1
@.str.6 = private unnamed_addr constant [14 x i8] c"sorted(table)\00", align 1
@.str.7 = private unnamed_addr constant [43 x i8] c"treetable_new_conf(&conf, &table) == CC_OK\00", align 1
@.str.8 = private unnamed_addr constant [17 x i8] c"./klee_helpers.h\00", align 1
@__PRETTY_FUNCTION__.make_table = private unnamed_addr constant [28 x i8] c"TreeTable *make_table(void)\00", align 1
@.str.9 = private unnamed_addr constant [14 x i8] c"table != NULL\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_get_greater_than_maximum_key_is_total() #0 !dbg !1053 {
entry:
  ...
  store i32 10, i32* %k1, align 4, !dbg !1057
  call void @llvm.dbg.declare(metadata i32* %k2, metadata !1058, metadata !DIExpression()), !dbg !1059
  store i32 20, i32* %k2, align 4, !dbg !1059
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1060, metadata !DIExpression()), !dbg !1061
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32 1), !dbg !1062
  store i32 %call, i32* %value, align 4, !dbg !1061
  call void @llvm.dbg.declare(metadata i8** %out, metadata !1063, metadata !DIExpression()), !dbg !1064
  store i8* null, i8** %out, align 8, !dbg !1064
  ...
  %call1 = call %struct.treetable_s* @make_table(), !dbg !1069
  store %struct.treetable_s* %call1, %struct.treetable_s** %table, align 8, !dbg !1068
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1070
  %1 = bitcast i32* %k1 to i8*, !dbg !1070
  %2 = bitcast i32* %value to i8*, !dbg !1070
  %call2 = call i32 @treetable_add(%struct.treetable_s* %0, i8* %1, i8* %2), !dbg !1070
  %cmp = icmp eq i32 %call2, 0, !dbg !1070
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1070

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.2, i64 0, i64 0), i32 29, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_maximum_key_is_total, i64 0, i64 0)) #6, !dbg !1070
  unreachable, !dbg !1070

cond.end:                                         ; preds = %entry
  %3 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1071
  %4 = bitcast i32* %k2 to i8*, !dbg !1071
  %5 = bitcast i32* %value to i8*, !dbg !1071
  %call3 = call i32 @treetable_add(%struct.treetable_s* %3, i8* %4, i8* %5), !dbg !1071
  %cmp4 = icmp eq i32 %call3, 0, !dbg !1071
  br i1 %cmp4, label %cond.end7, label %cond.false6, !dbg !1071

cond.false6:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.2, i64 0, i64 0), i32 30, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_maximum_key_is_total, i64 0, i64 0)) #6, !dbg !1071
  unreachable, !dbg !1071

cond.end7:                                        ; preds = %cond.end
  %6 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1072
  %7 = bitcast i32* %k2 to i8*, !dbg !1073
  %call8 = call i32 @treetable_get_greater_than(%struct.treetable_s* %6, i8* %7, i8** %out), !dbg !1074
  store i32 %call8, i32* %status, align 4, !dbg !1075
  %8 = load i32, i32* %status, align 4, !dbg !1076
  %cmp9 = icmp eq i32 %8, 0, !dbg !1076
  %9 = load i32, i32* %status, align 4, !dbg !1076
  %cmp10 = icmp eq i32 %9, 6, !dbg !1076
  %or.cond = select i1 %cmp9, i1 true, i1 %cmp10, !dbg !1076
  br i1 %or.cond, label %cond.end13, label %cond.false12, !dbg !1076

cond.false12:                                     ; preds = %cond.end7
  call void @__assert_fail(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.2, i64 0, i64 0), i32 36, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_maximum_key_is_total, i64 0, i64 0)) #6, !dbg !1076
  unreachable, !dbg !1076

cond.end13:                                       ; preds = %cond.end7
  %10 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1077
  %call14 = call i32 @balanced(%struct.treetable_s* %10), !dbg !1077
  %tobool = icmp ne i32 %call14, 0, !dbg !1077
  br i1 %tobool, label %cond.end17, label %cond.false16, !dbg !1077

cond.false16:                                     ; preds = %cond.end13
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.2, i64 0, i64 0), i32 37, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_maximum_key_is_total, i64 0, i64 0)) #6, !dbg !1077
  unreachable, !dbg !1077

cond.end17:                                       ; preds = %cond.end13
  %11 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1078
  %call18 = call i32 @sorted(%struct.treetable_s* %11), !dbg !1078
  %tobool19 = icmp ne i32 %call18, 0, !dbg !1078
  br i1 %tobool19, label %cond.end22, label %cond.false21, !dbg !1078

cond.false21:                                     ; preds = %cond.end17
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.2, i64 0, i64 0), i32 38, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_maximum_key_is_total, i64 0, i64 0)) #6, !dbg !1078
  unreachable, !dbg !1078

cond.end22:                                       ; preds = %cond.end17
  %12 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1079
  call void @treetable_destroy(%struct.treetable_s* %12), !dbg !1080
  ret void, !dbg !1081
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @symbolic_int(i8* %name, i32 %concrete_fallback) #0 !dbg !1082 {
entry:
  %name.addr = alloca i8*, align 8
  %concrete_fallback.addr = alloca i32, align 4
  %value = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %name.addr, metadata !1088, metadata !DIExpression()), !dbg !1089
  store i32 %concrete_fallback, i32* %concrete_fallback.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %concrete_fallback.addr, metadata !1090, metadata !DIExpression()), !dbg !1091
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1092, metadata !DIExpression()), !dbg !1093
  %0 = load i32, i32* %concrete_fallback.addr, align 4, !dbg !1094
  store i32 %0, i32* %value, align 4, !dbg !1093
  %1 = bitcast i32* %value to i8*, !dbg !1095
  %2 = load i8*, i8** %name.addr, align 8, !dbg !1096
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %2), !dbg !1097
  %3 = load i32, i32* %value, align 4, !dbg !1098
  ret i32 %3, !dbg !1099
}

; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1100 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1103, metadata !DIExpression()), !dbg !1104
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1105, metadata !DIExpression()), !dbg !1106
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1106
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1107
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1108
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1109
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1110
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1111
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1112
  %cmp = icmp eq i32 %call, 0, !dbg !1112
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1112

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1112
  unreachable, !dbg !1112

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1113
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1113
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1113

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.9, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1113
  unreachable, !dbg !1113

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1114
  ret %struct.treetable_s* %1, !dbg !1115
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1116 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_get_greater_than_maximum_key_is_total(), !dbg !1119
  ret i32 0, !dbg !1120
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1121 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1122, metadata !DIExpression()), !dbg !1123
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1124, metadata !DIExpression()), !dbg !1125
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1126, metadata !DIExpression()), !dbg !1127
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1128
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1129
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1129
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1127
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1130
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1131
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1131
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1132
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1133
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1134
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1135
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1137
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1137
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1138
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1139
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1139
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1140
  br i1 %cmp, label %if.then, label %if.end, !dbg !1141

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1142
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1143
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1144
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1144
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1145
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1146
  br label %if.end, !dbg !1143

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1147
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1148
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1148
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1149
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1150
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1151
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1152
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1154
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1154
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1155
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1156
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1156
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1157
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1158

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1159
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1160
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1161
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1162
  br label %if.end20, !dbg !1160

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1163
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1165
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1166
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1166
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1167
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1167
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1168
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1169

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1170
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1171
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1172
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1172
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1173
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1174
  br label %if.end20, !dbg !1171

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1175
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1176
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1177
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1177
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1178
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1179
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1180
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1181
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1182
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1183
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1184
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1185
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1186
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1187
  ret void, !dbg !1188
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1189 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1190, metadata !DIExpression()), !dbg !1191
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1192, metadata !DIExpression()), !dbg !1193
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1194, metadata !DIExpression()), !dbg !1195
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1196
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1197
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1197
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1195
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1198
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1199
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1199
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1200
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1201
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1202
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1203
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1205
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1205
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1206
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1207
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1207
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1208
  br i1 %cmp, label %if.then, label %if.end, !dbg !1209

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1210
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1211
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1212
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1212
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1213
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1214
  br label %if.end, !dbg !1211

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1215
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1216
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1216
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1217
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1218
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1219
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1220
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1222
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1222
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1223
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1224
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1224
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1225
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1226

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1227
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1228
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1229
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1230
  br label %if.end20, !dbg !1228

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1231
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1233
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1234
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1234
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1235
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1235
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1236
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1237

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1238
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1239
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1240
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1240
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1241
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1242
  br label %if.end20, !dbg !1239

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1243
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1244
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1245
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1245
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1246
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1247
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1248
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1249
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1250
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1251
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1252
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1253
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1254
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1255
  ret void, !dbg !1256
}
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1257 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1258, metadata !DIExpression()), !dbg !1259
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1260, metadata !DIExpression()), !dbg !1261
  %0 = load i64, i64* %size.addr, align 8, !dbg !1262
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1263
  store i8* %call, i8** %ptr, align 8, !dbg !1261
  %1 = load i8*, i8** %ptr, align 8, !dbg !1264
  %cmp = icmp ne i8* %1, null, !dbg !1265
  %conv = zext i1 %cmp to i32, !dbg !1265
  %conv1 = sext i32 %conv to i64, !dbg !1264
  call void @klee_assume(i64 %conv1), !dbg !1266
  %2 = load i8*, i8** %ptr, align 8, !dbg !1267
  ret i8* %2, !dbg !1268
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1269 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1270, metadata !DIExpression()), !dbg !1271
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1272, metadata !DIExpression()), !dbg !1273
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1274, metadata !DIExpression()), !dbg !1275
  %0 = load i64, i64* %count.addr, align 8, !dbg !1276
  %1 = load i64, i64* %size.addr, align 8, !dbg !1277
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1278
  store i8* %call, i8** %ptr, align 8, !dbg !1275
  %2 = load i8*, i8** %ptr, align 8, !dbg !1279
  %cmp = icmp ne i8* %2, null, !dbg !1280
  %conv = zext i1 %cmp to i32, !dbg !1280
  %conv1 = sext i32 %conv to i64, !dbg !1279
  call void @klee_assume(i64 %conv1), !dbg !1281
  %3 = load i8*, i8** %ptr, align 8, !dbg !1282
  ret i8* %3, !dbg !1283
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1284 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1290, metadata !DIExpression()), !dbg !1291
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1292, metadata !DIExpression()), !dbg !1293
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1294, metadata !DIExpression()), !dbg !1295
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1296, metadata !DIExpression()), !dbg !1298
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1299
  store i8* %0, i8** %dest, align 8, !dbg !1298
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1300, metadata !DIExpression()), !dbg !1301
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1302
  store i8* %1, i8** %src, align 8, !dbg !1301
  br label %while.cond, !dbg !1303

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1304
  %dec = add i64 %2, -1, !dbg !1304
  store i64 %dec, i64* %len.addr, align 8, !dbg !1304
  %cmp = icmp ugt i64 %2, 0, !dbg !1305
  br i1 %cmp, label %while.body, label %while.end, !dbg !1303

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1306
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1306
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1306
  %4 = load i8, i8* %3, align 1, !dbg !1307
  %5 = load i8*, i8** %dest, align 8, !dbg !1308
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1308
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1308
  store i8 %4, i8* %5, align 1, !dbg !1309
  br label %while.cond, !dbg !1303, !llvm.loop !1310

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1311
  ret i8* %6, !dbg !1312
}
...
!1 = !DIFile(filename: "test_get_greater_than_maximum_key_is_total.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_get_greater_than_maximum_key_is_total", scope: !1, file: !1, line: 19, type: !1054, scopeLine: 20, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "k1", scope: !1053, file: !1, line: 21, type: !18)
!1057 = !DILocation(line: 21, column: 9, scope: !1053)
!1058 = !DILocalVariable(name: "k2", scope: !1053, file: !1, line: 22, type: !18)
!1059 = !DILocation(line: 22, column: 9, scope: !1053)
!1060 = !DILocalVariable(name: "value", scope: !1053, file: !1, line: 23, type: !18)
!1061 = !DILocation(line: 23, column: 9, scope: !1053)
!1062 = !DILocation(line: 23, column: 17, scope: !1053)
!1063 = !DILocalVariable(name: "out", scope: !1053, file: !1, line: 24, type: !19)
!1064 = !DILocation(line: 24, column: 11, scope: !1053)
!1065 = !DILocalVariable(name: "status", scope: !1053, file: !1, line: 25, type: !3)
!1066 = !DILocation(line: 25, column: 18, scope: !1053)
!1067 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 27, type: !107)
!1068 = !DILocation(line: 27, column: 16, scope: !1053)
!1069 = !DILocation(line: 27, column: 24, scope: !1053)
!1070 = !DILocation(line: 29, column: 5, scope: !1053)
!1071 = !DILocation(line: 30, column: 5, scope: !1053)
!1072 = !DILocation(line: 33, column: 41, scope: !1053)
!1073 = !DILocation(line: 33, column: 48, scope: !1053)
!1074 = !DILocation(line: 33, column: 14, scope: !1053)
!1075 = !DILocation(line: 33, column: 12, scope: !1053)
!1076 = !DILocation(line: 36, column: 5, scope: !1053)
!1077 = !DILocation(line: 37, column: 5, scope: !1053)
!1078 = !DILocation(line: 38, column: 5, scope: !1053)
!1079 = !DILocation(line: 40, column: 23, scope: !1053)
!1080 = !DILocation(line: 40, column: 5, scope: !1053)
!1081 = !DILocation(line: 41, column: 1, scope: !1053)
!1082 = distinct !DISubprogram(name: "symbolic_int", scope: !1083, file: !1083, line: 32, type: !1084, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1083 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1084 = !DISubroutineType(types: !1085)
!1085 = !{!18, !1086, !18}
!1086 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1087, size: 64)
!1087 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1088 = !DILocalVariable(name: "name", arg: 1, scope: !1082, file: !1083, line: 32, type: !1086)
!1089 = !DILocation(line: 32, column: 37, scope: !1082)
!1090 = !DILocalVariable(name: "concrete_fallback", arg: 2, scope: !1082, file: !1083, line: 32, type: !18)
!1091 = !DILocation(line: 32, column: 47, scope: !1082)
!1092 = !DILocalVariable(name: "value", scope: !1082, file: !1083, line: 34, type: !18)
!1093 = !DILocation(line: 34, column: 9, scope: !1082)
!1094 = !DILocation(line: 34, column: 17, scope: !1082)
!1095 = !DILocation(line: 35, column: 24, scope: !1082)
!1096 = !DILocation(line: 35, column: 47, scope: !1082)
!1097 = !DILocation(line: 35, column: 5, scope: !1082)
!1098 = !DILocation(line: 36, column: 12, scope: !1082)
!1099 = !DILocation(line: 36, column: 5, scope: !1082)
!1100 = distinct !DISubprogram(name: "make_table", scope: !1083, file: !1083, line: 53, type: !1101, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1101 = !DISubroutineType(types: !1102)
!1102 = !{!107}
!1103 = !DILocalVariable(name: "conf", scope: !1100, file: !1083, line: 55, type: !67)
!1104 = !DILocation(line: 55, column: 19, scope: !1100)
!1105 = !DILocalVariable(name: "table", scope: !1100, file: !1083, line: 56, type: !107)
!1106 = !DILocation(line: 56, column: 16, scope: !1100)
!1107 = !DILocation(line: 57, column: 5, scope: !1100)
!1108 = !DILocation(line: 58, column: 10, scope: !1100)
!1109 = !DILocation(line: 58, column: 22, scope: !1100)
!1110 = !DILocation(line: 59, column: 10, scope: !1100)
!1111 = !DILocation(line: 59, column: 22, scope: !1100)
!1112 = !DILocation(line: 60, column: 5, scope: !1100)
!1113 = !DILocation(line: 61, column: 5, scope: !1100)
!1114 = !DILocation(line: 62, column: 12, scope: !1100)
!1115 = !DILocation(line: 62, column: 5, scope: !1100)
!1116 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 43, type: !1117, scopeLine: 44, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1117 = !DISubroutineType(types: !1118)
!1118 = !{!18}
!1119 = !DILocation(line: 45, column: 5, scope: !1116)
!1120 = !DILocation(line: 46, column: 5, scope: !1116)
!1121 = distinct !DISubprogram(name: "rotate_left", scope: !30, file: !30, line: 547, type: !225, scopeLine: 548, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!
scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1270 = !DILocalVariable(name: "count", arg: 1, scope: !1269, file: !1083, line: 46, type: !77)
!1271 = !DILocation(line: 46, column: 33, scope: !1269)
!1272 = !DILocalVariable(name: "size", arg: 2, scope: !1269, file: !1083, line: 46, type: !77)
!1273 = !DILocation(line: 46, column: 47, scope: !1269)
!1274 = !DILocalVariable(name: "ptr", scope: !1269, file: !1083, line: 48, type: !19)
!1275 = !DILocation(line: 48, column: 11, scope: !1269)
!1276 = !DILocation(line: 48, column: 24, scope: !1269)
!1277 = !DILocation(line: 48, column: 31, scope: !1269)
!1278 = !DILocation(line: 48, column: 17, scope: !1269)
!1279 = !DILocation(line: 49, column: 17, scope: !1269)
!1280 = !DILocation(line: 49, column: 21, scope: !1269)
!1281 = !DILocation(line: 49, column: 5, scope: !1269)
!1282 = !DILocation(line: 50, column: 12, scope: !1269)
!1283 = !DILocation(line: 50, column: 5, scope: !1269)
!1284 = distinct !DISubprogram(name: "memcpy", scope: !1285, file: !1285, line: 12, type: !1286, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1285 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1286 = !DISubroutineType(types: !1287)
!1287 = !{!19, !19, !33, !1288}
!1288 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1289, line: 46, baseType: !79)
!1289 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1290 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1284, file: !1285, line: 12, type: !19)
!1291 = !DILocation(line: 12, column: 20, scope: !1284)
!1292 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1284, file: !1285, line: 12, type: !33)
!1293 = !DILocation(line: 12, column: 42, scope: !1284)
!1294 = !DILocalVariable(name: "len", arg: 3, scope: !1284, file: !1285, line: 12, type: !1288)
!1295 = !DILocation(line: 12, column: 58, scope: !1284)
!1296 = !DILocalVariable(name: "dest", scope: !1284, file: !1285, line: 13, type: !1297)
!1297 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1298 = !DILocation(line: 13, column: 9, scope: !1284)
!1299 = !DILocation(line: 13, column: 16, scope: !1284)
!1300 = !DILocalVariable(name: "src", scope: !1284, file: !1285, line: 14, type: !1086)
!1301 = !DILocation(line: 14, column: 15, scope: !1284)
!1302 = !DILocation(line: 14, column: 21, scope: !1284)
!1303 = !DILocation(line: 16, column: 3, scope: !1284)
!1304 = !DILocation(line: 16, column: 13, scope: !1284)
!1305 = !DILocation(line: 16, column: 16, scope: !1284)
!1306 = !DILocation(line: 17, column: 19, scope: !1284)
!1307 = !DILocation(line: 17, column: 15, scope: !1284)
!1308 = !DILocation(line: 17, column: 10, scope: !1284)
!1309 = !DILocation(line: 17, column: 13, scope: !1284)
!1310 = distinct !{!1310, !1303, !1306, !332}
!1311 = !DILocation(line: 18, column: 10, scope: !1284)
!1312 = !DILocation(line: 18, column: 3, scope: !1284)
