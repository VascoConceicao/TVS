; ModuleID = 'test_get_first_key_empty_returns_not_found.bc'
source_filename = "test_get_first_key_empty_returns_not_found.c"
...
@.str = private unnamed_addr constant [61 x i8] c"treetable_get_first_key(table, &out) == CC_ERR_KEY_NOT_FOUND\00", align 1
@.str.1 = private unnamed_addr constant [45 x i8] c"test_get_first_key_empty_returns_not_found.c\00", align 1
@__PRETTY_FUNCTION__.test_get_first_key_empty_returns_not_found = private unnamed_addr constant [54 x i8] c"void test_get_first_key_empty_returns_not_found(void)\00", align 1
@.str.2 = private unnamed_addr constant [43 x i8] c"treetable_new_conf(&conf, &table) == CC_OK\00", align 1
@.str.3 = private unnamed_addr constant [17 x i8] c"./klee_helpers.h\00", align 1
@__PRETTY_FUNCTION__.make_table = private unnamed_addr constant [28 x i8] c"TreeTable *make_table(void)\00", align 1
@.str.4 = private unnamed_addr constant [14 x i8] c"table != NULL\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_get_first_key_empty_returns_not_found() #0 !dbg !1053 {
entry:
  %table = alloca %struct.treetable_s*, align 8
  %out = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1056, metadata !DIExpression()), !dbg !1057
  %call = call %struct.treetable_s* @make_empty_table_with_safe_sentinel(), !dbg !1058
  store %struct.treetable_s* %call, %struct.treetable_s** %table, align 8, !dbg !1057
  call void @llvm.dbg.declare(metadata i8** %out, metadata !1059, metadata !DIExpression()), !dbg !1060
  store i8* null, i8** %out, align 8, !dbg !1060
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1061
  %call1 = call i32 @treetable_get_first_key(%struct.treetable_s* %0, i8** %out), !dbg !1061
  %cmp = icmp eq i32 %call1, 6, !dbg !1061
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1061

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 32, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_empty_returns_not_found, i64 0, i64 0)) #6, !dbg !1061
  unreachable, !dbg !1061

cond.end:                                         ; preds = %entry
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1062
  call void @treetable_destroy(%struct.treetable_s* %1), !dbg !1063
  ret void, !dbg !1064
}

; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_empty_table_with_safe_sentinel() #0 !dbg !1065 {
entry:
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1069, metadata !DIExpression()), !dbg !1070
  %call = call %struct.treetable_s* @make_table(), !dbg !1071
  store %struct.treetable_s* %call, %struct.treetable_s** %table, align 8, !dbg !1070
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1072
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %0, i32 0, i32 1, !dbg !1073
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1073
  %2 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1074
  %sentinel1 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %2, i32 0, i32 1, !dbg !1075
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel1, align 8, !dbg !1075
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %3, i32 0, i32 4, !dbg !1076
  store %struct.rbnode_s* %1, %struct.rbnode_s** %left, align 8, !dbg !1077
  %4 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1078
  %sentinel2 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %4, i32 0, i32 1, !dbg !1079
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel2, align 8, !dbg !1079
  %6 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1080
  %sentinel3 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %6, i32 0, i32 1, !dbg !1081
  %7 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel3, align 8, !dbg !1081
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %7, i32 0, i32 5, !dbg !1082
  store %struct.rbnode_s* %5, %struct.rbnode_s** %right, align 8, !dbg !1083
  %8 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1084
  %sentinel4 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %8, i32 0, i32 1, !dbg !1085
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel4, align 8, !dbg !1085
  %10 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1086
  %sentinel5 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %10, i32 0, i32 1, !dbg !1087
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel5, align 8, !dbg !1087
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1088
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1089
  %12 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1090
  ret %struct.treetable_s* %12, !dbg !1091
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1092 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_get_first_key_empty_returns_not_found(), !dbg !1095
  ret i32 0, !dbg !1096
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1097 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1098, metadata !DIExpression()), !dbg !1099
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1100, metadata !DIExpression()), !dbg !1101
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1102, metadata !DIExpression()), !dbg !1103
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1104
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1105
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1105
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1103
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1106
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1107
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1107
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1108
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1109
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1110
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1111
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1113
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1113
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1114
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1115
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1115
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1116
  br i1 %cmp, label %if.then, label %if.end, !dbg !1117

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1118
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1119
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1120
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1120
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1121
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1122
  br label %if.end, !dbg !1119

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1123
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1124
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1124
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1125
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1126
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1127
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1128
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1130
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1130
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1131
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1132
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1132
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1133
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1134

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1135
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1136
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1137
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1138
  br label %if.end20, !dbg !1136

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1139
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1141
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1142
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1142
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1143
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1143
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1144
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1145

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1146
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1147
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1148
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1148
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1149
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1150
  br label %if.end20, !dbg !1147

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1151
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1152
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1153
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1153
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1154
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1155
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1156
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1157
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1158
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1159
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1160
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1161
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1162
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1163
  ret void, !dbg !1164
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1165 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1166, metadata !DIExpression()), !dbg !1167
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1168, metadata !DIExpression()), !dbg !1169
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1170, metadata !DIExpression()), !dbg !1171
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1172
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1173
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1173
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1171
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1174
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1175
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1175
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1176
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1177
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1178
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1179
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1181
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1181
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1182
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1183
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1183
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1184
  br i1 %cmp, label %if.then, label %if.end, !dbg !1185

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1186
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1187
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1188
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1188
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1189
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1190
  br label %if.end, !dbg !1187

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1191
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1192
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1192
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1193
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1194
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1195
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1196
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1198
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1198
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1199
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1200
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1200
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1201
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1202

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1203
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1204
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1205
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1206
  br label %if.end20, !dbg !1204

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1207
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1209
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1210
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1210
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1211
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1211
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1212
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1213

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1214
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1215
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1216
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1216
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1217
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1218
  br label %if.end20, !dbg !1215

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1219
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1220
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1221
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1221
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1222
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1223
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1224
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1225
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1226
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1227
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1228
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1229
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1230
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1231
  ret void, !dbg !1232
}

; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1233 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1234, metadata !DIExpression()), !dbg !1235
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1236, metadata !DIExpression()), !dbg !1237
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1237
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1238
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1239
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1240
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1241
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1242
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1243
  %cmp = icmp eq i32 %call, 0, !dbg !1243
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1243

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1243
  unreachable, !dbg !1243

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1244
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1244
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1244

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1244
  unreachable, !dbg !1244

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1245
  ret %struct.treetable_s* %1, !dbg !1246
}
...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1290, metadata !DIExpression()), !dbg !1293
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1294
  store i8* %1, i8** %src, align 8, !dbg !1293
  br label %while.cond, !dbg !1295

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1296
  %dec = add i64 %2, -1, !dbg !1296
  store i64 %dec, i64* %len.addr, align 8, !dbg !1296
  %cmp = icmp ugt i64 %2, 0, !dbg !1297
  br i1 %cmp, label %while.body, label %while.end, !dbg !1295

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1298
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1298
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1298
  %4 = load i8, i8* %3, align 1, !dbg !1299
  %5 = load i8*, i8** %dest, align 8, !dbg !1300
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1300
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1300
  store i8 %4, i8* %5, align 1, !dbg !1301
  br label %while.cond, !dbg !1295, !llvm.loop !1302

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1303
  ret i8* %6, !dbg !1304
}
...
!1 = !DIFile(filename: "test_get_first_key_empty_returns_not_found.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_get_first_key_empty_returns_not_found", scope: !1, file: !1, line: 27, type: !1054, scopeLine: 28, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 29, type: !107)
!1057 = !DILocation(line: 29, column: 16, scope: !1053)
!1058 = !DILocation(line: 29, column: 24, scope: !1053)
!1059 = !DILocalVariable(name: "out", scope: !1053, file: !1, line: 30, type: !19)
!1060 = !DILocation(line: 30, column: 11, scope: !1053)
!1061 = !DILocation(line: 32, column: 5, scope: !1053)
!1062 = !DILocation(line: 34, column: 23, scope: !1053)
!1063 = !DILocation(line: 34, column: 5, scope: !1053)
!1064 = !DILocation(line: 35, column: 1, scope: !1053)
!1065 = distinct !DISubprogram(name: "make_empty_table_with_safe_sentinel", scope: !1066, file: !1066, line: 73, type: !1067, scopeLine: 74, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1066 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1067 = !DISubroutineType(types: !1068)
!1068 = !{!107}
!1069 = !DILocalVariable(name: "table", scope: !1065, file: !1066, line: 75, type: !107)
!1070 = !DILocation(line: 75, column: 16, scope: !1065)
!1071 = !DILocation(line: 75, column: 24, scope: !1065)
!1072 = !DILocation(line: 76, column: 31, scope: !1065)
!1073 = !DILocation(line: 76, column: 38, scope: !1065)
!1074 = !DILocation(line: 76, column: 5, scope: !1065)
!1075 = !DILocation(line: 76, column: 12, scope: !1065)
!1076 = !DILocation(line: 76, column: 22, scope: !1065)
!1077 = !DILocation(line: 76, column: 29, scope: !1065)
!1078 = !DILocation(line: 77, column: 31, scope: !1065)
!1079 = !DILocation(line: 77, column: 38, scope: !1065)
!1080 = !DILocation(line: 77, column: 5, scope: !1065)
!1081 = !DILocation(line: 77, column: 12, scope: !1065)
!1082 = !DILocation(line: 77, column: 22, scope: !1065)
!1083 = !DILocation(line: 77, column: 29, scope: !1065)
!1084 = !DILocation(line: 78, column: 31, scope: !1065)
!1085 = !DILocation(line: 78, column: 38, scope: !1065)
!1086 = !DILocation(line: 78, column: 5, scope: !1065)
!1087 = !DILocation(line: 78, column: 12, scope: !1065)
!1088 = !DILocation(line: 78, column: 22, scope: !1065)
!1089 = !DILocation(line: 78, column: 29, scope: !1065)
!1090 = !DILocation(line: 79, column: 12, scope: !1065)
!1091 = !DILocation(line: 79, column: 5, scope: !1065)
!1092 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 37, type: !1093, scopeLine: 38, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1093 = !DISubroutineType(types: !1094)
!1094 = !{!18}
!1095 = !DILocation(line: 39, column: 5, scope: !1092)
!1096 = !DILocation(line: 40, column: 5, scope: !1092)
!1097 = distinct !DISubprogram(name: "rotate_left", scope: !30, file: !30, line: 547, type: !225, scopeLine: 548, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1098 = !DILocalVariable(name: "table", arg: 1, scope: !1097, file: !30, line: 547, type: !107)
!1099 = !DILocation(line: 547, column: 36, scope: !1097)
!1100 = !DILocalVariable(name: "x", arg: 2, scope: !1097, file: !30, line: 547, type: !112)
!1101 = !DILocation(line: 547, column: 51, scope: !1097)
!1102 = !DILocalVariable(name: "y", scope: !1097, file: !30, line: 549, type: !112)
!1103 = !DILocation(line: 549, column: 13, scope: !1097)
!1104 = !DILocation(line: 549, column: 17, scope: !1097)
!1105 = !DILocation(line: 549, column: 20, scope: !1097)
!1106 = !DILocation(line: 551, column: 16, scope: !1097)
!1107 = !DILocation(line: 551, column: 19, scope: !1097)
!1108 = !DILocation(line: 551, column: 5, scope: !1097)
!1109 = !DILocation(line: 551, column: 8, scope: !1097)
!1110 = !DILocation(line: 551, column: 14, scope: !1097)
!1111 = !DILocation(line: 553, column: 9, scope: !1112)
!1112 = distinct !DILexicalBlock(scope: !1097, file: !30, line: 553, column: 9)
!1113 = !DILocation(line: 553, column: 12, scope: !1112)
!1114 = !DILocation(line: 553, column: 20, scope: !1112)
!1115 = !DILocation(line: 553, column: 27, scope: !1112)
!1116 = !DILocation(line: 553, column: 17, scope: !1112)
!1117 = !DILocation(line: 553, column: 9, scope: !1097)
!1223 = !DILocation(line: 534, column: 25, scope: !1208)
!1224 = !DILocation(line: 536, column: 17, scope: !1165)
!1225 = !DILocation(line: 536, column: 5, scope: !1165)
!1226 = !DILocation(line: 536, column: 8, scope: !1165)
!1227 = !DILocation(line: 536, column: 15, scope: !1165)
!1228 = !DILocation(line: 537, column: 17, scope: !1165)
!1229 = !DILocation(line: 537, column: 5, scope: !1165)
!1230 = !DILocation(line: 537, column: 8, scope: !1165)
!1231 = !DILocation(line: 537, column: 15, scope: !1165)
!1232 = !DILocation(line: 538, column: 1, scope: !1165)
!1233 = distinct !DISubprogram(name: "make_table", scope: !1066, file: !1066, line: 53, type: !1067, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1234 = !DILocalVariable(name: "conf", scope: !1233, file: !1066, line: 55, type: !67)
!1235 = !DILocation(line: 55, column: 19, scope: !1233)
!1236 = !DILocalVariable(name: "table", scope: !1233, file: !1066, line: 56, type: !107)
!1237 = !DILocation(line: 56, column: 16, scope: !1233)
!1238 = !DILocation(line: 57, column: 5, scope: !1233)
!1239 = !DILocation(line: 58, column: 10, scope: !1233)
!1240 = !DILocation(line: 58, column: 22, scope: !1233)
!1241 = !DILocation(line: 59, column: 10, scope: !1233)
!1242 = !DILocation(line: 59, column: 22, scope: !1233)
!1243 = !DILocation(line: 60, column: 5, scope: !1233)
!1244 = !DILocation(line: 61, column: 5, scope: !1233)
!1245 = !DILocation(line: 62, column: 12, scope: !1233)
!1246 = !DILocation(line: 62, column: 5, scope: !1233)
!1247 = distinct !DISubprogram(name: "safe_malloc", scope: !1066, file: !1066, line: 39, type: !75, scopeLine: 40, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1248 = !DILocalVariable(name: "size", arg: 1, scope: !1247, file: !1066, line: 39, type: !77)
!1249 = !DILocation(line: 39, column: 33, scope: !1247)
!1250 = !DILocalVariable(name: "ptr", scope: !1247, file: !1066, line: 41, type: !19)
...
!1259 = distinct !DISubprogram(name: "safe_calloc", scope: !1066, file: !1066, line: 46, type: !82, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1260 = !DILocalVariable(name: "count", arg: 1, scope: !1259, file: !1066, line: 46, type: !77)
!1261 = !DILocation(line: 46, column: 33, scope: !1259)
!1262 = !DILocalVariable(name: "size", arg: 2, scope: !1259, file: !1066, line: 46, type: !77)
!1263 = !DILocation(line: 46, column: 47, scope: !1259)
!1264 = !DILocalVariable(name: "ptr", scope: !1259, file: !1066, line: 48, type: !19)
...
!1290 = !DILocalVariable(name: "src", scope: !1274, file: !1275, line: 14, type: !1291)
!1291 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1292, size: 64)
!1292 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1293 = !DILocation(line: 14, column: 15, scope: !1274)
!1294 = !DILocation(line: 14, column: 21, scope: !1274)
!1295 = !DILocation(line: 16, column: 3, scope: !1274)
!1296 = !DILocation(line: 16, column: 13, scope: !1274)
!1297 = !DILocation(line: 16, column: 16, scope: !1274)
!1298 = !DILocation(line: 17, column: 19, scope: !1274)
!1299 = !DILocation(line: 17, column: 15, scope: !1274)
!1300 = !DILocation(line: 17, column: 10, scope: !1274)
!1301 = !DILocation(line: 17, column: 13, scope: !1274)
!1302 = distinct !{!1302, !1295, !1298, !332}
!1303 = !DILocation(line: 18, column: 10, scope: !1274)
!1304 = !DILocation(line: 18, column: 3, scope: !1274)
