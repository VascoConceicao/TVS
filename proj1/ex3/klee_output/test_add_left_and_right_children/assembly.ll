; ModuleID = 'test_add_left_and_right_children.bc'
source_filename = "test_add_left_and_right_children.c"
...
@.str = private unnamed_addr constant [7 x i8] c"two_k1\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"two_k2\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"two_v1\00", align 1
@.str.3 = private unnamed_addr constant [7 x i8] c"two_v2\00", align 1
@.str.4 = private unnamed_addr constant [40 x i8] c"treetable_add(table, &k1, &v1) == CC_OK\00", align 1
@.str.5 = private unnamed_addr constant [35 x i8] c"test_add_left_and_right_children.c\00", align 1
@__PRETTY_FUNCTION__.test_add_left_and_right_children = private unnamed_addr constant [44 x i8] c"void test_add_left_and_right_children(void)\00", align 1
@.str.6 = private unnamed_addr constant [40 x i8] c"treetable_add(table, &k2, &v2) == CC_OK\00", align 1
@.str.7 = private unnamed_addr constant [27 x i8] c"treetable_size(table) == 2\00", align 1
@.str.8 = private unnamed_addr constant [16 x i8] c"balanced(table)\00", align 1
@.str.9 = private unnamed_addr constant [14 x i8] c"sorted(table)\00", align 1
@.str.10 = private unnamed_addr constant [43 x i8] c"treetable_new_conf(&conf, &table) == CC_OK\00", align 1
@.str.11 = private unnamed_addr constant [17 x i8] c"./klee_helpers.h\00", align 1
@__PRETTY_FUNCTION__.make_table = private unnamed_addr constant [28 x i8] c"TreeTable *make_table(void)\00", align 1
@.str.12 = private unnamed_addr constant [14 x i8] c"table != NULL\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_add_left_and_right_children() #0 !dbg !1053 {
entry:
  ...
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 20), !dbg !1058
  ...
  %call1 = call i32 @symbolic_int(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 10), !dbg !1061
  store i32 %call1, i32* %k2, align 4, !dbg !1060
  call void @llvm.dbg.declare(metadata i32* %v1, metadata !1062, metadata !DIExpression()), !dbg !1063
  %call2 = call i32 @symbolic_int(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 1), !dbg !1064
  store i32 %call2, i32* %v1, align 4, !dbg !1063
  call void @llvm.dbg.declare(metadata i32* %v2, metadata !1065, metadata !DIExpression()), !dbg !1066
  %call3 = call i32 @symbolic_int(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i32 2), !dbg !1067
  store i32 %call3, i32* %v2, align 4, !dbg !1066
  %0 = load i32, i32* %k1, align 4, !dbg !1068
  %1 = load i32, i32* %k2, align 4, !dbg !1069
  %cmp = icmp ne i32 %0, %1, !dbg !1070
  %conv = zext i1 %cmp to i32, !dbg !1070
  %conv4 = sext i32 %conv to i64, !dbg !1068
  call void @klee_assume(i64 %conv4), !dbg !1071
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1072, metadata !DIExpression()), !dbg !1073
  %call5 = call %struct.treetable_s* @make_table(), !dbg !1074
  store %struct.treetable_s* %call5, %struct.treetable_s** %table, align 8, !dbg !1073
  %2 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1075
  %3 = bitcast i32* %k1 to i8*, !dbg !1075
  %4 = bitcast i32* %v1 to i8*, !dbg !1075
  %call6 = call i32 @treetable_add(%struct.treetable_s* %2, i8* %3, i8* %4), !dbg !1075
  %cmp7 = icmp eq i32 %call6, 0, !dbg !1075
  br i1 %cmp7, label %cond.end, label %cond.false, !dbg !1075

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.5, i64 0, i64 0), i32 34, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__PRETTY_FUNCTION__.test_add_left_and_right_children, i64 0, i64 0)) #6, !dbg !1075
  unreachable, !dbg !1075

cond.end:                                         ; preds = %entry
  %5 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1076
  %6 = bitcast i32* %k2 to i8*, !dbg !1076
  %7 = bitcast i32* %v2 to i8*, !dbg !1076
  %call9 = call i32 @treetable_add(%struct.treetable_s* %5, i8* %6, i8* %7), !dbg !1076
  %cmp10 = icmp eq i32 %call9, 0, !dbg !1076
  br i1 %cmp10, label %cond.end14, label %cond.false13, !dbg !1076

cond.false13:                                     ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.5, i64 0, i64 0), i32 35, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__PRETTY_FUNCTION__.test_add_left_and_right_children, i64 0, i64 0)) #6, !dbg !1076
  unreachable, !dbg !1076

cond.end14:                                       ; preds = %cond.end
  %8 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1077
  %call15 = call i64 @treetable_size(%struct.treetable_s* %8), !dbg !1077
  %cmp16 = icmp eq i64 %call15, 2, !dbg !1077
  br i1 %cmp16, label %cond.end20, label %cond.false19, !dbg !1077

cond.false19:                                     ; preds = %cond.end14
  call void @__assert_fail(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.5, i64 0, i64 0), i32 37, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__PRETTY_FUNCTION__.test_add_left_and_right_children, i64 0, i64 0)) #6, !dbg !1077
  unreachable, !dbg !1077

cond.end20:                                       ; preds = %cond.end14
  %9 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1078
  %call21 = call i32 @balanced(%struct.treetable_s* %9), !dbg !1078
  %tobool = icmp ne i32 %call21, 0, !dbg !1078
  br i1 %tobool, label %cond.end24, label %cond.false23, !dbg !1078

cond.false23:                                     ; preds = %cond.end20
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.5, i64 0, i64 0), i32 38, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__PRETTY_FUNCTION__.test_add_left_and_right_children, i64 0, i64 0)) #6, !dbg !1078
  unreachable, !dbg !1078

cond.end24:                                       ; preds = %cond.end20
  %10 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1079
  %call25 = call i32 @sorted(%struct.treetable_s* %10), !dbg !1079
  %tobool26 = icmp ne i32 %call25, 0, !dbg !1079
  br i1 %tobool26, label %cond.end29, label %cond.false28, !dbg !1079

cond.false28:                                     ; preds = %cond.end24
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.9, i64 0, i64 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.5, i64 0, i64 0), i32 39, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__PRETTY_FUNCTION__.test_add_left_and_right_children, i64 0, i64 0)) #6, !dbg !1079
  unreachable, !dbg !1079

cond.end29:                                       ; preds = %cond.end24
  %11 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1080
  call void @treetable_destroy(%struct.treetable_s* %11), !dbg !1081
  ret void, !dbg !1082
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @symbolic_int(i8* %name, i32 %concrete_fallback) #0 !dbg !1083 {
entry:
  %name.addr = alloca i8*, align 8
  %concrete_fallback.addr = alloca i32, align 4
  %value = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %name.addr, metadata !1089, metadata !DIExpression()), !dbg !1090
  store i32 %concrete_fallback, i32* %concrete_fallback.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %concrete_fallback.addr, metadata !1091, metadata !DIExpression()), !dbg !1092
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1093, metadata !DIExpression()), !dbg !1094
  %0 = load i32, i32* %concrete_fallback.addr, align 4, !dbg !1095
  store i32 %0, i32* %value, align 4, !dbg !1094
  %1 = bitcast i32* %value to i8*, !dbg !1096
  %2 = load i8*, i8** %name.addr, align 8, !dbg !1097
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %2), !dbg !1098
  %3 = load i32, i32* %value, align 4, !dbg !1099
  ret i32 %3, !dbg !1100
}
...
; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1101 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1104, metadata !DIExpression()), !dbg !1105
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1106, metadata !DIExpression()), !dbg !1107
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1107
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1108
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1109
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1110
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1111
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1112
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1113
  %cmp = icmp eq i32 %call, 0, !dbg !1113
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1113

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.11, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1113
  unreachable, !dbg !1113

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1114
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1114
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1114

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.12, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.11, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1114
  unreachable, !dbg !1114

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1115
  ret %struct.treetable_s* %1, !dbg !1116
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1117 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_add_left_and_right_children(), !dbg !1120
  ret i32 0, !dbg !1121
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1122 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1123, metadata !DIExpression()), !dbg !1124
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1125, metadata !DIExpression()), !dbg !1126
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1127, metadata !DIExpression()), !dbg !1128
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1129
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1130
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1130
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1128
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1131
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1132
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1132
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1133
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1134
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1135
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1136
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1138
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1138
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1139
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1140
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1140
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1141
  br i1 %cmp, label %if.then, label %if.end, !dbg !1142

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1143
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1144
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1145
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1145
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1146
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1147
  br label %if.end, !dbg !1144

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1148
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1149
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1149
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1150
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1151
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1152
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1153
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1155
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1155
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1156
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1157
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1157
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1158
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1159

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1160
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1161
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1162
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1163
  br label %if.end20, !dbg !1161

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1164
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1166
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1167
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1167
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1168
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1168
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1169
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1170

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1171
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1172
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1173
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1173
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1174
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1175
  br label %if.end20, !dbg !1172

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1176
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1177
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1178
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1178
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1179
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1180
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1181
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1182
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1183
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1184
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1185
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1186
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1187
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1188
  ret void, !dbg !1189
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1190 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1191, metadata !DIExpression()), !dbg !1192
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1193, metadata !DIExpression()), !dbg !1194
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1195, metadata !DIExpression()), !dbg !1196
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1197
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1198
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1198
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1196
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1199
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1200
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1200
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1201
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1202
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1203
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1204
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1206
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1206
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1207
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1208
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1208
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1209
  br i1 %cmp, label %if.then, label %if.end, !dbg !1210

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1211
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1212
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1213
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1213
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1214
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1215
  br label %if.end, !dbg !1212

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1216
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1217
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1217
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1218
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1219
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1220
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1221
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1223
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1223
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1224
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1225
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1225
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1226
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1227

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1228
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1229
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1230
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1231
  br label %if.end20, !dbg !1229

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1232
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1234
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1235
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1235
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1236
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1236
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1237
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1238

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1239
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1240
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1241
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1241
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1242
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1243
  br label %if.end20, !dbg !1240

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1244
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1245
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1246
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1246
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1247
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1248
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1249
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1250
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1251
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1252
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1253
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1254
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1255
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1256
  ret void, !dbg !1257
}
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1258 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1259, metadata !DIExpression()), !dbg !1260
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1261, metadata !DIExpression()), !dbg !1262
  %0 = load i64, i64* %size.addr, align 8, !dbg !1263
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1264
  store i8* %call, i8** %ptr, align 8, !dbg !1262
  %1 = load i8*, i8** %ptr, align 8, !dbg !1265
  %cmp = icmp ne i8* %1, null, !dbg !1266
  %conv = zext i1 %cmp to i32, !dbg !1266
  %conv1 = sext i32 %conv to i64, !dbg !1265
  call void @klee_assume(i64 %conv1), !dbg !1267
  %2 = load i8*, i8** %ptr, align 8, !dbg !1268
  ret i8* %2, !dbg !1269
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1270 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1271, metadata !DIExpression()), !dbg !1272
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1273, metadata !DIExpression()), !dbg !1274
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1275, metadata !DIExpression()), !dbg !1276
  %0 = load i64, i64* %count.addr, align 8, !dbg !1277
  %1 = load i64, i64* %size.addr, align 8, !dbg !1278
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1279
  store i8* %call, i8** %ptr, align 8, !dbg !1276
  %2 = load i8*, i8** %ptr, align 8, !dbg !1280
  %cmp = icmp ne i8* %2, null, !dbg !1281
  %conv = zext i1 %cmp to i32, !dbg !1281
  %conv1 = sext i32 %conv to i64, !dbg !1280
  call void @klee_assume(i64 %conv1), !dbg !1282
  %3 = load i8*, i8** %ptr, align 8, !dbg !1283
  ret i8* %3, !dbg !1284
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1285 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1291, metadata !DIExpression()), !dbg !1292
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1293, metadata !DIExpression()), !dbg !1294
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1295, metadata !DIExpression()), !dbg !1296
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1297, metadata !DIExpression()), !dbg !1299
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1300
  store i8* %0, i8** %dest, align 8, !dbg !1299
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1301, metadata !DIExpression()), !dbg !1302
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1303
  store i8* %1, i8** %src, align 8, !dbg !1302
  br label %while.cond, !dbg !1304

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1305
  %dec = add i64 %2, -1, !dbg !1305
  store i64 %dec, i64* %len.addr, align 8, !dbg !1305
  %cmp = icmp ugt i64 %2, 0, !dbg !1306
  br i1 %cmp, label %while.body, label %while.end, !dbg !1304

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1307
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1307
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1307
  %4 = load i8, i8* %3, align 1, !dbg !1308
  %5 = load i8*, i8** %dest, align 8, !dbg !1309
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1309
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1309
  store i8 %4, i8* %5, align 1, !dbg !1310
  br label %while.cond, !dbg !1304, !llvm.loop !1311

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1312
  ret i8* %6, !dbg !1313
}
...
!1 = !DIFile(filename: "test_add_left_and_right_children.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_add_left_and_right_children", scope: !1, file: !1, line: 22, type: !1054, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
...
!1062 = !DILocalVariable(name: "v1", scope: !1053, file: !1, line: 26, type: !18)
!1063 = !DILocation(line: 26, column: 9, scope: !1053)
!1064 = !DILocation(line: 26, column: 14, scope: !1053)
!1065 = !DILocalVariable(name: "v2", scope: !1053, file: !1, line: 27, type: !18)
!1066 = !DILocation(line: 27, column: 9, scope: !1053)
!1067 = !DILocation(line: 27, column: 14, scope: !1053)
!1068 = !DILocation(line: 30, column: 17, scope: !1053)
!1069 = !DILocation(line: 30, column: 23, scope: !1053)
!1070 = !DILocation(line: 30, column: 20, scope: !1053)
!1071 = !DILocation(line: 30, column: 5, scope: !1053)
!1072 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 32, type: !107)
!1073 = !DILocation(line: 32, column: 16, scope: !1053)
!1074 = !DILocation(line: 32, column: 24, scope: !1053)
!1075 = !DILocation(line: 34, column: 5, scope: !1053)
!1076 = !DILocation(line: 35, column: 5, scope: !1053)
!1077 = !DILocation(line: 37, column: 5, scope: !1053)
!1078 = !DILocation(line: 38, column: 5, scope: !1053)
!1079 = !DILocation(line: 39, column: 5, scope: !1053)
!1080 = !DILocation(line: 41, column: 23, scope: !1053)
!1081 = !DILocation(line: 41, column: 5, scope: !1053)
!1082 = !DILocation(line: 42, column: 1, scope: !1053)
!1083 = distinct !DISubprogram(name: "symbolic_int", scope: !1084, file: !1084, line: 32, type: !1085, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1084 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1085 = !DISubroutineType(types: !1086)
!1086 = !{!18, !1087, !18}
!1087 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1088, size: 64)
!1088 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1089 = !DILocalVariable(name: "name", arg: 1, scope: !1083, file: !1084, line: 32, type: !1087)
!1090 = !DILocation(line: 32, column: 37, scope: !1083)
!1091 = !DILocalVariable(name: "concrete_fallback", arg: 2, scope: !1083, file: !1084, line: 32, type: !18)
!1092 = !DILocation(line: 32, column: 47, scope: !1083)
!1093 = !DILocalVariable(name: "value", scope: !1083, file: !1084, line: 34, type: !18)
!1094 = !DILocation(line: 34, column: 9, scope: !1083)
!1095 = !DILocation(line: 34, column: 17, scope: !1083)
!1096 = !DILocation(line: 35, column: 24, scope: !1083)
!1097 = !DILocation(line: 35, column: 47, scope: !1083)
!1098 = !DILocation(line: 35, column: 5, scope: !1083)
!1099 = !DILocation(line: 36, column: 12, scope: !1083)
!1100 = !DILocation(line: 36, column: 5, scope: !1083)
!1101 = distinct !DISubprogram(name: "make_table", scope: !1084, file: !1084, line: 53, type: !1102, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1102 = !DISubroutineType(types: !1103)
!1103 = !{!107}
!1104 = !DILocalVariable(name: "conf", scope: !1101, file: !1084, line: 55, type: !67)
!1105 = !DILocation(line: 55, column: 19, scope: !1101)
!1106 = !DILocalVariable(name: "table", scope: !1101, file: !1084, line: 56, type: !107)
!1107 = !DILocation(line: 56, column: 16, scope: !1101)
!1108 = !DILocation(line: 57, column: 5, scope: !1101)
!1109 = !DILocation(line: 58, column: 10, scope: !1101)
!1110 = !DILocation(line: 58, column: 22, scope: !1101)
!1111 = !DILocation(line: 59, column: 10, scope: !1101)
!1112 = !DILocation(line: 59, column: 22, scope: !1101)
!1113 = !DILocation(line: 60, column: 5, scope: !1101)
!1114 = !DILocation(line: 61, column: 5, scope: !1101)
!1115 = !DILocation(line: 62, column: 12, scope: !1101)
!1116 = !DILocation(line: 62, column: 5, scope: !1101)
!1117 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 44, type: !1118, scopeLine: 45, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1118 = !DISubroutineType(types: !1119)
!1119 = !{!18}
!1120 = !DILocation(line: 46, column: 5, scope: !1117)
!1121 = !DILocation(line: 47, column: 5, scope: !1117)
!1122 = distinct !DISubprogram(name: "rotate_left", scope: !30, file: !30, line: 547, type: !225, scopeLine: 548, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!
scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1271 = !DILocalVariable(name: "count", arg: 1, scope: !1270, file: !1084, line: 46, type: !77)
!1272 = !DILocation(line: 46, column: 33, scope: !1270)
!1273 = !DILocalVariable(name: "size", arg: 2, scope: !1270, file: !1084, line: 46, type: !77)
!1274 = !DILocation(line: 46, column: 47, scope: !1270)
!1275 = !DILocalVariable(name: "ptr", scope: !1270, file: !1084, line: 48, type: !19)
!1276 = !DILocation(line: 48, column: 11, scope: !1270)
!1277 = !DILocation(line: 48, column: 24, scope: !1270)
!1278 = !DILocation(line: 48, column: 31, scope: !1270)
!1279 = !DILocation(line: 48, column: 17, scope: !1270)
!1280 = !DILocation(line: 49, column: 17, scope: !1270)
!1281 = !DILocation(line: 49, column: 21, scope: !1270)
!1282 = !DILocation(line: 49, column: 5, scope: !1270)
!1283 = !DILocation(line: 50, column: 12, scope: !1270)
!1284 = !DILocation(line: 50, column: 5, scope: !1270)
!1285 = distinct !DISubprogram(name: "memcpy", scope: !1286, file: !1286, line: 12, type: !1287, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1286 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1287 = !DISubroutineType(types: !1288)
!1288 = !{!19, !19, !33, !1289}
!1289 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1290, line: 46, baseType: !79)
!1290 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1291 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1285, file: !1286, line: 12, type: !19)
!1292 = !DILocation(line: 12, column: 20, scope: !1285)
!1293 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1285, file: !1286, line: 12, type: !33)
!1294 = !DILocation(line: 12, column: 42, scope: !1285)
!1295 = !DILocalVariable(name: "len", arg: 3, scope: !1285, file: !1286, line: 12, type: !1289)
!1296 = !DILocation(line: 12, column: 58, scope: !1285)
!1297 = !DILocalVariable(name: "dest", scope: !1285, file: !1286, line: 13, type: !1298)
!1298 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1299 = !DILocation(line: 13, column: 9, scope: !1285)
!1300 = !DILocation(line: 13, column: 16, scope: !1285)
!1301 = !DILocalVariable(name: "src", scope: !1285, file: !1286, line: 14, type: !1087)
!1302 = !DILocation(line: 14, column: 15, scope: !1285)
!1303 = !DILocation(line: 14, column: 21, scope: !1285)
!1304 = !DILocation(line: 16, column: 3, scope: !1285)
!1305 = !DILocation(line: 16, column: 13, scope: !1285)
!1306 = !DILocation(line: 16, column: 16, scope: !1285)
!1307 = !DILocation(line: 17, column: 19, scope: !1285)
!1308 = !DILocation(line: 17, column: 15, scope: !1285)
!1309 = !DILocation(line: 17, column: 10, scope: !1285)
!1310 = !DILocation(line: 17, column: 13, scope: !1285)
!1311 = distinct !{!1311, !1304, !1307, !332}
!1312 = !DILocation(line: 18, column: 10, scope: !1285)
!1313 = !DILocation(line: 18, column: 3, scope: !1285)
