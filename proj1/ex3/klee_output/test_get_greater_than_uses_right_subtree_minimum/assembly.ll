; ModuleID = 'test_get_greater_than_uses_right_subtree_minimum.bc'
source_filename = "test_get_greater_than_uses_right_subtree_minimum.c"
...
@.str = private unnamed_addr constant [20 x i8] c"greater_right_value\00", align 1
@.str.1 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k2, &value) == CC_OK\00", align 1
@.str.2 = private unnamed_addr constant [51 x i8] c"test_get_greater_than_uses_right_subtree_minimum.c\00", align 1
@__PRETTY_FUNCTION__.test_get_greater_than_uses_right_subtree_minimum = private unnamed_addr constant [60 x i8] c"void test_get_greater_than_uses_right_subtree_minimum(void)\00", align 1
@.str.3 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k1, &value) == CC_OK\00", align 1
@.str.4 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k3, &value) == CC_OK\00", align 1
@.str.5 = private unnamed_addr constant [54 x i8] c"treetable_get_greater_than(table, &k2, &out) == CC_OK\00", align 1
@.str.6 = private unnamed_addr constant [18 x i8] c"*(int *)out == k3\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_get_greater_than_uses_right_subtree_minimum() #0 !dbg !1053 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %k3, metadata !1060, metadata !DIExpression()), !dbg !1061
  store i32 30, i32* %k3, align 4, !dbg !1061
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1062, metadata !DIExpression()), !dbg !1063
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i32 1), !dbg !1064
  store i32 %call, i32* %value, align 4, !dbg !1063
  ...
  %1 = bitcast i32* %k2 to i8*, !dbg !1070
...
cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.2, i64 0, i64 0), i32 35, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_uses_right_subtree_minimum, i64 0, i64 0)) #6, !dbg !1070
  unreachable, !dbg !1070

cond.end:                                         ; preds = %entry
  %3 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1071
  %4 = bitcast i32* %k1 to i8*, !dbg !1071
...
cond.false6:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.2, i64 0, i64 0), i32 36, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_uses_right_subtree_minimum, i64 0, i64 0)) #6, !dbg !1071
  unreachable, !dbg !1071

cond.end7:                                        ; preds = %cond.end
  %6 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1072
  %7 = bitcast i32* %k3 to i8*, !dbg !1072
  %8 = bitcast i32* %value to i8*, !dbg !1072
  %call8 = call i32 @treetable_add(%struct.treetable_s* %6, i8* %7, i8* %8), !dbg !1072
  %cmp9 = icmp eq i32 %call8, 0, !dbg !1072
  br i1 %cmp9, label %cond.end12, label %cond.false11, !dbg !1072

cond.false11:                                     ; preds = %cond.end7
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.2, i64 0, i64 0), i32 37, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_uses_right_subtree_minimum, i64 0, i64 0)) #6, !dbg !1072
  unreachable, !dbg !1072

cond.end12:                                       ; preds = %cond.end7
  %9 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1073
  %10 = bitcast i32* %k2 to i8*, !dbg !1073
  %call13 = call i32 @treetable_get_greater_than(%struct.treetable_s* %9, i8* %10, i8** %out), !dbg !1073
  %cmp14 = icmp eq i32 %call13, 0, !dbg !1073
  br i1 %cmp14, label %cond.end17, label %cond.false16, !dbg !1073

cond.false16:                                     ; preds = %cond.end12
  call void @__assert_fail(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.2, i64 0, i64 0), i32 39, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_uses_right_subtree_minimum, i64 0, i64 0)) #6, !dbg !1073
  unreachable, !dbg !1073

cond.end17:                                       ; preds = %cond.end12
  %11 = load i8*, i8** %out, align 8, !dbg !1074
  %12 = bitcast i8* %11 to i32*, !dbg !1074
  %13 = load i32, i32* %12, align 4, !dbg !1074
  %14 = load i32, i32* %k3, align 4, !dbg !1074
  %cmp18 = icmp eq i32 %13, %14, !dbg !1074
  br i1 %cmp18, label %cond.end21, label %cond.false20, !dbg !1074

cond.false20:                                     ; preds = %cond.end17
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.2, i64 0, i64 0), i32 40, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_uses_right_subtree_minimum, i64 0, i64 0)) #6, !dbg !1074
  unreachable, !dbg !1074

cond.end21:                                       ; preds = %cond.end17
  %15 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1075
  call void @treetable_destroy(%struct.treetable_s* %15), !dbg !1076
  ret void, !dbg !1077
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @symbolic_int(i8* %name, i32 %concrete_fallback) #0 !dbg !1078 {
entry:
  %name.addr = alloca i8*, align 8
  %concrete_fallback.addr = alloca i32, align 4
  %value = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %name.addr, metadata !1084, metadata !DIExpression()), !dbg !1085
  store i32 %concrete_fallback, i32* %concrete_fallback.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %concrete_fallback.addr, metadata !1086, metadata !DIExpression()), !dbg !1087
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1088, metadata !DIExpression()), !dbg !1089
  %0 = load i32, i32* %concrete_fallback.addr, align 4, !dbg !1090
  store i32 %0, i32* %value, align 4, !dbg !1089
  %1 = bitcast i32* %value to i8*, !dbg !1091
  %2 = load i8*, i8** %name.addr, align 8, !dbg !1092
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %2), !dbg !1093
  %3 = load i32, i32* %value, align 4, !dbg !1094
  ret i32 %3, !dbg !1095
}

; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1096 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1099, metadata !DIExpression()), !dbg !1100
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1101, metadata !DIExpression()), !dbg !1102
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1102
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1103
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1104
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1105
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1106
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1107
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1108
  %cmp = icmp eq i32 %call, 0, !dbg !1108
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1108

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1108
  unreachable, !dbg !1108

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1109
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1109
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1109

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.9, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1109
  unreachable, !dbg !1109

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1110
  ret %struct.treetable_s* %1, !dbg !1111
}
...
entry:
  ...
  call void @test_get_greater_than_uses_right_subtree_minimum(), !dbg !1115
  ret i32 0, !dbg !1116
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1117 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  ...
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1120, metadata !DIExpression()), !dbg !1121
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1122, metadata !DIExpression()), !dbg !1123
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1124
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1125
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1125
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1123
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1126
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1127
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1127
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1128
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1129
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1130
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1131
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1133
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1133
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1134
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1135
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1135
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1136
  br i1 %cmp, label %if.then, label %if.end, !dbg !1137

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1138
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1139
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1140
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1140
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1141
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1142
  br label %if.end, !dbg !1139

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1143
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1144
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1144
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1145
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1146
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1147
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1148
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1150
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1150
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1151
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1152
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1152
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1153
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1154

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1155
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1156
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1157
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1158
  br label %if.end20, !dbg !1156

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1159
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1161
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1162
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1162
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1163
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1163
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1164
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1165

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1166
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1167
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1168
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1168
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1169
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1170
  br label %if.end20, !dbg !1167

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1171
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1172
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1173
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1173
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1174
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1175
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1176
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1177
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1178
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1179
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1180
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1181
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1182
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1183
  ret void, !dbg !1184
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1185 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1186, metadata !DIExpression()), !dbg !1187
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1188, metadata !DIExpression()), !dbg !1189
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1190, metadata !DIExpression()), !dbg !1191
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1192
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1193
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1193
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1191
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1194
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1195
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1195
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1196
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1197
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1198
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1199
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1201
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1201
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1202
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1203
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1203
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1204
  br i1 %cmp, label %if.then, label %if.end, !dbg !1205

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1206
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1207
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1208
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1208
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1209
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1210
  br label %if.end, !dbg !1207

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1211
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1212
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1212
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1213
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1214
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1215
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1216
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1218
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1218
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1219
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1220
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1220
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1221
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1222

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1223
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1224
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1225
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1226
  br label %if.end20, !dbg !1224

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1227
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1229
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1230
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1230
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1231
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1231
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1232
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1233

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1234
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1235
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1236
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1236
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1237
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1238
  br label %if.end20, !dbg !1235

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1239
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1240
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1241
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1241
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1242
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1243
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1244
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1245
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1246
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1247
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1248
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1249
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1250
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1251
  ret void, !dbg !1252
}
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1253 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1254, metadata !DIExpression()), !dbg !1255
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1256, metadata !DIExpression()), !dbg !1257
  %0 = load i64, i64* %size.addr, align 8, !dbg !1258
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1259
  store i8* %call, i8** %ptr, align 8, !dbg !1257
  %1 = load i8*, i8** %ptr, align 8, !dbg !1260
  %cmp = icmp ne i8* %1, null, !dbg !1261
  %conv = zext i1 %cmp to i32, !dbg !1261
  %conv1 = sext i32 %conv to i64, !dbg !1260
  call void @klee_assume(i64 %conv1), !dbg !1262
  %2 = load i8*, i8** %ptr, align 8, !dbg !1263
  ret i8* %2, !dbg !1264
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1265 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1266, metadata !DIExpression()), !dbg !1267
  store i64 %size, i64* %size.addr, align 8
  ...
  %0 = load i64, i64* %count.addr, align 8, !dbg !1272
  %1 = load i64, i64* %size.addr, align 8, !dbg !1273
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1274
  store i8* %call, i8** %ptr, align 8, !dbg !1271
  %2 = load i8*, i8** %ptr, align 8, !dbg !1275
  %cmp = icmp ne i8* %2, null, !dbg !1276
  %conv = zext i1 %cmp to i32, !dbg !1276
  %conv1 = sext i32 %conv to i64, !dbg !1275
  call void @klee_assume(i64 %conv1), !dbg !1277
  %3 = load i8*, i8** %ptr, align 8, !dbg !1278
  ret i8* %3, !dbg !1279
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1280 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1286, metadata !DIExpression()), !dbg !1287
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1288, metadata !DIExpression()), !dbg !1289
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1290, metadata !DIExpression()), !dbg !1291
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1292, metadata !DIExpression()), !dbg !1294
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1295
  store i8* %0, i8** %dest, align 8, !dbg !1294
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1296, metadata !DIExpression()), !dbg !1297
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1298
  store i8* %1, i8** %src, align 8, !dbg !1297
  br label %while.cond, !dbg !1299

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1300
  %dec = add i64 %2, -1, !dbg !1300
  store i64 %dec, i64* %len.addr, align 8, !dbg !1300
  %cmp = icmp ugt i64 %2, 0, !dbg !1301
  br i1 %cmp, label %while.body, label %while.end, !dbg !1299

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1302
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1302
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1302
  %4 = load i8, i8* %3, align 1, !dbg !1303
  %5 = load i8*, i8** %dest, align 8, !dbg !1304
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1304
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1304
  store i8 %4, i8* %5, align 1, !dbg !1305
  br label %while.cond, !dbg !1299, !llvm.loop !1306

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1307
  ret i8* %6, !dbg !1308
}
...
!1 = !DIFile(filename: "test_get_greater_than_uses_right_subtree_minimum.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_get_greater_than_uses_right_subtree_minimum", scope: !1, file: !1, line: 25, type: !1054, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "k1", scope: !1053, file: !1, line: 27, type: !18)
!1057 = !DILocation(line: 27, column: 9, scope: !1053)
!1058 = !DILocalVariable(name: "k2", scope: !1053, file: !1, line: 28, type: !18)
!1059 = !DILocation(line: 28, column: 9, scope: !1053)
!1060 = !DILocalVariable(name: "k3", scope: !1053, file: !1, line: 29, type: !18)
!1061 = !DILocation(line: 29, column: 9, scope: !1053)
!1062 = !DILocalVariable(name: "value", scope: !1053, file: !1, line: 30, type: !18)
!1063 = !DILocation(line: 30, column: 9, scope: !1053)
!1064 = !DILocation(line: 30, column: 17, scope: !1053)
!1065 = !DILocalVariable(name: "out", scope: !1053, file: !1, line: 31, type: !19)
!1066 = !DILocation(line: 31, column: 11, scope: !1053)
!1067 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 33, type: !107)
!1068 = !DILocation(line: 33, column: 16, scope: !1053)
!1069 = !DILocation(line: 33, column: 24, scope: !1053)
!1070 = !DILocation(line: 35, column: 5, scope: !1053)
!1071 = !DILocation(line: 36, column: 5, scope: !1053)
!1072 = !DILocation(line: 37, column: 5, scope: !1053)
!1073 = !DILocation(line: 39, column: 5, scope: !1053)
!1074 = !DILocation(line: 40, column: 5, scope: !1053)
!1075 = !DILocation(line: 42, column: 23, scope: !1053)
!1076 = !DILocation(line: 42, column: 5, scope: !1053)
!1077 = !DILocation(line: 43, column: 1, scope: !1053)
!1078 = distinct !DISubprogram(name: "symbolic_int", scope: !1079, file: !1079, line: 32, type: !1080, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1079 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1080 = !DISubroutineType(types: !1081)
!1081 = !{!18, !1082, !18}
!1082 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1083, size: 64)
!1083 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1084 = !DILocalVariable(name: "name", arg: 1, scope: !1078, file: !1079, line: 32, type: !1082)
!1085 = !DILocation(line: 32, column: 37, scope: !1078)
!1086 = !DILocalVariable(name: "concrete_fallback", arg: 2, scope: !1078, file: !1079, line: 32, type: !18)
!1087 = !DILocation(line: 32, column: 47, scope: !1078)
!1088 = !DILocalVariable(name: "value", scope: !1078, file: !1079, line: 34, type: !18)
!1089 = !DILocation(line: 34, column: 9, scope: !1078)
!1090 = !DILocation(line: 34, column: 17, scope: !1078)
!1091 = !DILocation(line: 35, column: 24, scope: !1078)
!1092 = !DILocation(line: 35, column: 47, scope: !1078)
!1093 = !DILocation(line: 35, column: 5, scope: !1078)
!1094 = !DILocation(line: 36, column: 12, scope: !1078)
!1095 = !DILocation(line: 36, column: 5, scope: !1078)
!1096 = distinct !DISubprogram(name: "make_table", scope: !1079, file: !1079, line: 53, type: !1097, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1097 = !DISubroutineType(types: !1098)
!1098 = !{!107}
!1099 = !DILocalVariable(name: "conf", scope: !1096, file: !1079, line: 55, type: !67)
!1100 = !DILocation(line: 55, column: 19, scope: !1096)
!1101 = !DILocalVariable(name: "table", scope: !1096, file: !1079, line: 56, type: !107)
!1102 = !DILocation(line: 56, column: 16, scope: !1096)
!1103 = !DILocation(line: 57, column: 5, scope: !1096)
!1104 = !DILocation(line: 58, column: 10, scope: !1096)
!1105 = !DILocation(line: 58, column: 22, scope: !1096)
!1106 = !DILocation(line: 59, column: 10, scope: !1096)
!1107 = !DILocation(line: 59, column: 22, scope: !1096)
!1108 = !DILocation(line: 60, column: 5, scope: !1096)
!1109 = !DILocation(line: 61, column: 5, scope: !1096)
!1110 = !DILocation(line: 62, column: 12, scope: !1096)
!1111 = !DILocation(line: 62, column: 5, scope: !1096)
!1112 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line:
scopeLine: 40, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1254 = !DILocalVariable(name: "size", arg: 1, scope: !1253, file: !1079, line: 39, type: !77)
!1255 = !DILocation(line: 39, column: 33, scope: !1253)
!1256 = !DILocalVariable(name: "ptr", scope: !1253, file: !1079, line: 41, type: !19)
!1257 = !DILocation(line: 41, column: 11, scope: !1253)
!1258 = !DILocation(line: 41, column: 24, scope: !1253)
!1259 = !DILocation(line: 41, column: 17, scope: !1253)
!1260 = !DILocation(line: 42, column: 17, scope: !1253)
!1261 = !DILocation(line: 42, column: 21, scope: !1253)
!1262 = !DILocation(line: 42, column: 5, scope: !1253)
!1263 = !DILocation(line: 43, column: 12, scope: !1253)
!1264 = !DILocation(line: 43, column: 5, scope: !1253)
!1265 = distinct !DISubprogram(name: "safe_calloc", scope: !1079, file: !1079, line: 46, type: !82, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1266 = !DILocalVariable(name: "count", arg: 1, scope: !1265, file: !1079, line: 46, type: !77)
!1267 = !DILocation(line: 46, column: 33, scope: !1265)
!1268 = !DILocalVariable(name: "size", arg: 2, scope: !1265, file: !1079, line: 46, type: !77)
!1269 = !DILocation(line: 46, column: 47, scope: !1265)
!1270 = !DILocalVariable(name: "ptr", scope: !1265, file: !1079, line: 48, type: !19)
!1271 = !DILocation(line: 48, column: 11, scope: !1265)
!1272 = !DILocation(line: 48, column: 24, scope: !1265)
!1273 = !DILocation(line: 48, column: 31, scope: !1265)
!1274 = !DILocation(line: 48, column: 17, scope: !1265)
!1275 = !DILocation(line: 49, column: 17, scope: !1265)
!1276 = !DILocation(line: 49, column: 21, scope: !1265)
!1277 = !DILocation(line: 49, column: 5, scope: !1265)
!1278 = !DILocation(line: 50, column: 12, scope: !1265)
!1279 = !DILocation(line: 50, column: 5, scope: !1265)
!1280 = distinct !DISubprogram(name: "memcpy", scope: !1281, file: !1281, line: 12, type: !1282, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1281 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1282 = !DISubroutineType(types: !1283)
!1283 = !{!19, !19, !33, !1284}
!1284 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1285, line: 46, baseType: !79)
!1285 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1286 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1280, file: !1281, line: 12, type: !19)
!1287 = !DILocation(line: 12, column: 20, scope: !1280)
!1288 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1280, file: !1281, line: 12, type: !33)
!1289 = !DILocation(line: 12, column: 42, scope: !1280)
!1290 = !DILocalVariable(name: "len", arg: 3, scope: !1280, file: !1281, line: 12, type: !1284)
!1291 = !DILocation(line: 12, column: 58, scope: !1280)
!1292 = !DILocalVariable(name: "dest", scope: !1280, file: !1281, line: 13, type: !1293)
!1293 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1294 = !DILocation(line: 13, column: 9, scope: !1280)
!1295 = !DILocation(line: 13, column: 16, scope: !1280)
!1296 = !DILocalVariable(name: "src", scope: !1280, file: !1281, line: 14, type: !1082)
!1297 = !DILocation(line: 14, column: 15, scope: !1280)
!1298 = !DILocation(line: 14, column: 21, scope: !1280)
!1299 = !DILocation(line: 16, column: 3, scope: !1280)
!1300 = !DILocation(line: 16, column: 13, scope: !1280)
!1301 = !DILocation(line: 16, column: 16, scope: !1280)
!1302 = !DILocation(line: 17, column: 19, scope: !1280)
!1303 = !DILocation(line: 17, column: 15, scope: !1280)
!1304 = !DILocation(line: 17, column: 10, scope: !1280)
!1305 = !DILocation(line: 17, column: 13, scope: !1280)
!1306 = distinct !{!1306, !1299, !1302, !332}
!1307 = !DILocation(line: 18, column: 10, scope: !1280)
!1308 = !DILocation(line: 18, column: 3, scope: !1280)
