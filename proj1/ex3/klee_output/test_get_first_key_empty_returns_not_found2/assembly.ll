; ModuleID = 'test_get_first_key_empty_returns_not_found2.bc'
source_filename = "test_get_first_key_empty_returns_not_found2.c"
...
@.str = private unnamed_addr constant [43 x i8] c"treetable_new_conf(&conf, &table) == CC_OK\00", align 1
@.str.1 = private unnamed_addr constant [46 x i8] c"test_get_first_key_empty_returns_not_found2.c\00", align 1
...
@.str.2 = private unnamed_addr constant [61 x i8] c"treetable_get_first_key(table, &out) == CC_ERR_KEY_NOT_FOUND\00", align 1
...
entry:
  ...
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1057
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1058, metadata !DIExpression()), !dbg !1059
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1060
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1061
  %cmp = icmp eq i32 %call, 0, !dbg !1061
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1061

cond.false:                                       ; preds = %entry
  %call1 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.1, i64 0, i64 0), i32 38, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_empty_returns_not_found, i64 0, i64 0)), !dbg !1061
  br label %cond.end, !dbg !1061

cond.end:                                         ; preds = %entry, %cond.false
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1062
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %0, i32 0, i32 1, !dbg !1063
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1063
  %2 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1064
  %sentinel2 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %2, i32 0, i32 1, !dbg !1065
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel2, align 8, !dbg !1065
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %3, i32 0, i32 4, !dbg !1066
  store %struct.rbnode_s* %1, %struct.rbnode_s** %left, align 8, !dbg !1067
  %4 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1068
  %sentinel3 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %4, i32 0, i32 1, !dbg !1069
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel3, align 8, !dbg !1069
  %6 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1070
  %sentinel4 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %6, i32 0, i32 1, !dbg !1071
  %7 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel4, align 8, !dbg !1071
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %7, i32 0, i32 5, !dbg !1072
  store %struct.rbnode_s* %5, %struct.rbnode_s** %right, align 8, !dbg !1073
  %8 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1074
  %sentinel5 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %8, i32 0, i32 1, !dbg !1075
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel5, align 8, !dbg !1075
  %10 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1076
  %sentinel6 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %10, i32 0, i32 1, !dbg !1077
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel6, align 8, !dbg !1077
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1078
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1079
  call void @llvm.dbg.declare(metadata i8** %out, metadata !1080, metadata !DIExpression()), !dbg !1081
  store i8* null, i8** %out, align 8, !dbg !1081
  %12 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1082
  %call7 = call i32 @treetable_get_first_key(%struct.treetable_s* %12, i8** %out), !dbg !1082
  %cmp8 = icmp eq i32 %call7, 6, !dbg !1082
  br i1 %cmp8, label %cond.end12, label %cond.false10, !dbg !1082

cond.false10:                                     ; preds = %cond.end
  %call11 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.1, i64 0, i64 0), i32 47, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_empty_returns_not_found, i64 0, i64 0)), !dbg !1082
  br label %cond.end12, !dbg !1082

cond.end12:                                       ; preds = %cond.end, %cond.false10
  %13 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1083
  call void @treetable_destroy(%struct.treetable_s* %13), !dbg !1084
  ret void, !dbg !1085
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1086 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_get_first_key_empty_returns_not_found(), !dbg !1089
  ret i32 0, !dbg !1090
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1091 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1092, metadata !DIExpression()), !dbg !1093
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1094, metadata !DIExpression()), !dbg !1095
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1096, metadata !DIExpression()), !dbg !1097
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1098
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1099
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1099
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1097
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1100
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1101
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1101
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1102
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1103
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1104
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1105
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1107
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1107
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1108
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1109
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1109
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1110
  br i1 %cmp, label %if.then, label %if.end, !dbg !1111

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1112
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1113
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1114
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1114
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1115
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1116
  br label %if.end, !dbg !1113

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1117
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1118
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1118
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1119
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1120
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1121
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1122
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1124
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1124
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1125
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1126
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1126
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1127
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1128

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1129
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1130
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1131
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1132
  br label %if.end20, !dbg !1130

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1133
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1135
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1136
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1136
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1137
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1137
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1138
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1139

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1140
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1141
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1142
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1142
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1143
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1144
  br label %if.end20, !dbg !1141

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1145
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1146
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1147
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1147
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1148
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1149
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1150
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1151
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1152
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1153
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1154
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1155
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1156
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1157
  ret void, !dbg !1158
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1159 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1160, metadata !DIExpression()), !dbg !1161
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1162, metadata !DIExpression()), !dbg !1163
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1164, metadata !DIExpression()), !dbg !1165
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1166
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1167
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1167
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1165
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1168
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1169
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1169
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1170
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1171
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1172
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1173
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1175
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1175
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1176
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1177
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1177
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1178
  br i1 %cmp, label %if.then, label %if.end, !dbg !1179

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1180
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1181
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1182
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1182
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1183
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1184
  br label %if.end, !dbg !1181

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1185
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1186
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1186
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1187
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1188
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1189
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1190
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1192
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1192
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1193
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1194
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1194
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1195
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1196

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1197
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1198
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1199
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1200
  br label %if.end20, !dbg !1198

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1201
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1203
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1204
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1204
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1205
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1205
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1206
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1207

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1208
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1209
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1210
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1210
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1211
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1212
  br label %if.end20, !dbg !1209

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1213
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1214
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1215
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1215
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1216
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1217
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1218
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1219
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1220
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1221
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1222
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1223
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1224
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1225
  ret void, !dbg !1226
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1227 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1233, metadata !DIExpression()), !dbg !1234
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1235, metadata !DIExpression()), !dbg !1236
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1237, metadata !DIExpression()), !dbg !1238
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1239, metadata !DIExpression()), !dbg !1241
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1242
  store i8* %0, i8** %dest, align 8, !dbg !1241
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1243, metadata !DIExpression()), !dbg !1246
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1247
  store i8* %1, i8** %src, align 8, !dbg !1246
  br label %while.cond, !dbg !1248

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1249
  %dec = add i64 %2, -1, !dbg !1249
  store i64 %dec, i64* %len.addr, align 8, !dbg !1249
  %cmp = icmp ugt i64 %2, 0, !dbg !1250
  br i1 %cmp, label %while.body, label %while.end, !dbg !1248

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1251
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1251
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1251
  %4 = load i8, i8* %3, align 1, !dbg !1252
  %5 = load i8*, i8** %dest, align 8, !dbg !1253
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1253
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1253
  store i8 %4, i8* %5, align 1, !dbg !1254
  br label %while.cond, !dbg !1248, !llvm.loop !1255

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1256
  ret i8* %6, !dbg !1257
}
...
!1 = !DIFile(filename: "test_get_first_key_empty_returns_not_found2.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_get_first_key_empty_returns_not_found", scope: !1, file: !1, line: 33, type: !1054, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 35, type: !107)
!1057 = !DILocation(line: 35, column: 16, scope: !1053)
!1058 = !DILocalVariable(name: "conf", scope: !1053, file: !1, line: 36, type: !67)
!1059 = !DILocation(line: 36, column: 19, scope: !1053)
!1060 = !DILocation(line: 37, column: 5, scope: !1053)
!1061 = !DILocation(line: 38, column: 5, scope: !1053)
!1062 = !DILocation(line: 42, column: 31, scope: !1053)
!1063 = !DILocation(line: 42, column: 38, scope: !1053)
!1064 = !DILocation(line: 42, column: 5, scope: !1053)
!1065 = !DILocation(line: 42, column: 12, scope: !1053)
!1066 = !DILocation(line: 42, column: 22, scope: !1053)
!1067 = !DILocation(line: 42, column: 29, scope: !1053)
!1068 = !DILocation(line: 43, column: 31, scope: !1053)
!1069 = !DILocation(line: 43, column: 38, scope: !1053)
!1070 = !DILocation(line: 43, column: 5, scope: !1053)
!1071 = !DILocation(line: 43, column: 12, scope: !1053)
!1072 = !DILocation(line: 43, column: 22, scope: !1053)
!1073 = !DILocation(line: 43, column: 29, scope: !1053)
!1074 = !DILocation(line: 44, column: 31, scope: !1053)
!1075 = !DILocation(line: 44, column: 38, scope: !1053)
!1076 = !DILocation(line: 44, column: 5, scope: !1053)
!1077 = !DILocation(line: 44, column: 12, scope: !1053)
!1078 = !DILocation(line: 44, column: 22, scope: !1053)
!1079 = !DILocation(line: 44, column: 29, scope: !1053)
!1080 = !DILocalVariable(name: "out", scope: !1053, file: !1, line: 46, type: !19)
!1081 = !DILocation(line: 46, column: 11, scope: !1053)
!1082 = !DILocation(line: 47, column: 5, scope: !1053)
!1083 = !DILocation(line: 49, column: 23, scope: !1053)
!1084 = !DILocation(line: 49, column: 5, scope: !1053)
!1085 = !DILocation(line: 50, column: 1, scope: !1053)
!1086 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 52, type: !1087, scopeLine: 53, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1087 = !DISubroutineType(types: !1088)
!1088 = !{!18}
!1089 = !DILocation(line: 54, column: 5, scope: !1086)
!1090 = !DILocation(line: 55, column: 5, scope: !1086)
!1091 = distinct !DISubprogram(name: "rotate_left", scope: !30, file: !30, line: 547, type: !225, scopeLine: 548, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1092 = !DILocalVariable(name: "table", arg: 1, scope: !1091, file: !30, line: 547, type: !107)
!1093 = !DILocation(line: 547, column: 36, scope: !1091)
!1094 = !DILocalVariable(name: "x", arg: 2, scope: !1091, file: !30, line: 547, type: !112)
!1095 = !DILocation(line: 547, column: 51, scope: !1091)
!1096 = !DILocalVariable(name: "y", scope: !1091, file: !30, line: 549, type: !112)
!1097 = !DILocation(line: 549, column: 13, scope: !1091)
!1098 = !DILocation(line: 549, column: 17, scope: !1091)
!1099 = !DILocation(line: 549, column: 20, scope: !1091)
!1100 = !DILocation(line: 551, column: 16, scope: !1091)
!1101 = !DILocation(line: 551, column: 19, scope: !1091)
!1102 = !DILocation(line: 551, column: 5, scope: !1091)
!1103 = !DILocation(line: 551, column: 8, scope: !1091)
!1104 = !DILocation(line: 551, column: 14, scope: !1091)
!1105 = !DILocation(line: 553, column: 9, scope: !1106)
!1106 = distinct !DILexicalBlock(scope: !1091, file: !30, line: 553, column: 9)
!1107 = !DILocation(line: 553, column: 12, scope: !1106)
!1108 = !DILocation(line: 553, column: 20, scope: !1106)
!1109 = !DILocation(line: 553, column: 27, scope: !1106)
!1110 = !DILocation(line: 553, column: 17, scope: !1106)
!1111 = !DILocation(line: 553, column: 9, scope: !1091)
!1112 = !DILocation(line: 554, column: 27, scope: !1106)
!1113 = !DILocation(line: 554, column: 9, scope: !1106)
!1114 = !DILocation(line: 554, column: 12, scope: !1106)
!1209 = !DILocation(line: 532, column: 9, scope: !1202)
!1210 = !DILocation(line: 532, column: 12, scope: !1202)
!1211 = !DILocation(line: 532, column: 20, scope: !1202)
!1212 = !DILocation(line: 532, column: 26, scope: !1202)
!1213 = !DILocation(line: 534, column: 27, scope: !1202)
!1214 = !DILocation(line: 534, column: 9, scope: !1202)
!1215 = !DILocation(line: 534, column: 12, scope: !1202)
!1216 = !DILocation(line: 534, column: 20, scope: !1202)
!1217 = !DILocation(line: 534, column: 25, scope: !1202)
!1218 = !DILocation(line: 536, column: 17, scope: !1159)
!1219 = !DILocation(line: 536, column: 5, scope: !1159)
!1220 = !DILocation(line: 536, column: 8, scope: !1159)
!1221 = !DILocation(line: 536, column: 15, scope: !1159)
!1222 = !DILocation(line: 537, column: 17, scope: !1159)
!1223 = !DILocation(line: 537, column: 5, scope: !1159)
!1224 = !DILocation(line: 537, column: 8, scope: !1159)
!1225 = !DILocation(line: 537, column: 15, scope: !1159)
!1226 = !DILocation(line: 538, column: 1, scope: !1159)
!1227 = distinct !DISubprogram(name: "memcpy", scope: !1228, file: !1228, line: 12, type: !1229, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1228 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1229 = !DISubroutineType(types: !1230)
!1230 = !{!19, !19, !33, !1231}
!1231 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1232, line: 46, baseType: !79)
!1232 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1233 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1227, file: !1228, line: 12, type: !19)
!1234 = !DILocation(line: 12, column: 20, scope: !1227)
!1235 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1227, file: !1228, line: 12, type: !33)
!1236 = !DILocation(line: 12, column: 42, scope: !1227)
!1237 = !DILocalVariable(name: "len", arg: 3, scope: !1227, file: !1228, line: 12, type: !1231)
!1238 = !DILocation(line: 12, column: 58, scope: !1227)
!1239 = !DILocalVariable(name: "dest", scope: !1227, file: !1228, line: 13, type: !1240)
!1240 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1241 = !DILocation(line: 13, column: 9, scope: !1227)
!1242 = !DILocation(line: 13, column: 16, scope: !1227)
!1243 = !DILocalVariable(name: "src", scope: !1227, file: !1228, line: 14, type: !1244)
!1244 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1245, size: 64)
!1245 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1246 = !DILocation(line: 14, column: 15, scope: !1227)
!1247 = !DILocation(line: 14, column: 21, scope: !1227)
!1248 = !DILocation(line: 16, column: 3, scope: !1227)
!1249 = !DILocation(line: 16, column: 13, scope: !1227)
!1250 = !DILocation(line: 16, column: 16, scope: !1227)
!1251 = !DILocation(line: 17, column: 19, scope: !1227)
!1252 = !DILocation(line: 17, column: 15, scope: !1227)
!1253 = !DILocation(line: 17, column: 10, scope: !1227)
!1254 = !DILocation(line: 17, column: 13, scope: !1227)
!1255 = distinct !{!1255, !1248, !1251, !332}
!1256 = !DILocation(line: 18, column: 10, scope: !1227)
!1257 = !DILocation(line: 18, column: 3, scope: !1227)
