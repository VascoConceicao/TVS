; ModuleID = 'test_add_duplicate_updates_value_only.bc'
source_filename = "test_add_duplicate_updates_value_only.c"
...
@.str = private unnamed_addr constant [8 x i8] c"dup_key\00", align 1
@.str.1 = private unnamed_addr constant [10 x i8] c"old_value\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c"new_value\00", align 1
@.str.3 = private unnamed_addr constant [48 x i8] c"treetable_add(table, &key, &old_value) == CC_OK\00", align 1
@.str.4 = private unnamed_addr constant [40 x i8] c"test_add_duplicate_updates_value_only.c\00", align 1
@__PRETTY_FUNCTION__.test_add_duplicate_updates_value_only = private unnamed_addr constant [49 x i8] c"void test_add_duplicate_updates_value_only(void)\00", align 1
@.str.5 = private unnamed_addr constant [48 x i8] c"treetable_add(table, &key, &new_value) == CC_OK\00", align 1
@.str.6 = private unnamed_addr constant [27 x i8] c"treetable_size(table) == 1\00", align 1
@.str.7 = private unnamed_addr constant [42 x i8] c"treetable_get(table, &key, &out) == CC_OK\00", align 1
@.str.8 = private unnamed_addr constant [18 x i8] c"out == &new_value\00", align 1
@.str.9 = private unnamed_addr constant [16 x i8] c"balanced(table)\00", align 1
@.str.10 = private unnamed_addr constant [14 x i8] c"sorted(table)\00", align 1
@.str.11 = private unnamed_addr constant [43 x i8] c"treetable_new_conf(&conf, &table) == CC_OK\00", align 1
@.str.12 = private unnamed_addr constant [17 x i8] c"./klee_helpers.h\00", align 1
@__PRETTY_FUNCTION__.make_table = private unnamed_addr constant [28 x i8] c"TreeTable *make_table(void)\00", align 1
@.str.13 = private unnamed_addr constant [14 x i8] c"table != NULL\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_add_duplicate_updates_value_only() #0 !dbg !1053 {
entry:
  ...
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata i32* %key, metadata !1056, metadata !DIExpression()), !dbg !1057
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32 11), !dbg !1058
  store i32 %call, i32* %key, align 4, !dbg !1057
  call void @llvm.dbg.declare(metadata i32* %old_value, metadata !1059, metadata !DIExpression()), !dbg !1060
  %call1 = call i32 @symbolic_int(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 1), !dbg !1061
  store i32 %call1, i32* %old_value, align 4, !dbg !1060
  call void @llvm.dbg.declare(metadata i32* %new_value, metadata !1062, metadata !DIExpression()), !dbg !1063
  %call2 = call i32 @symbolic_int(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 2), !dbg !1064
  store i32 %call2, i32* %new_value, align 4, !dbg !1063
  ...
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1067, metadata !DIExpression()), !dbg !1068
  %call3 = call %struct.treetable_s* @make_table(), !dbg !1069
  store %struct.treetable_s* %call3, %struct.treetable_s** %table, align 8, !dbg !1068
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1070
  %1 = bitcast i32* %key to i8*, !dbg !1070
  %2 = bitcast i32* %old_value to i8*, !dbg !1070
  %call4 = call i32 @treetable_add(%struct.treetable_s* %0, i8* %1, i8* %2), !dbg !1070
  %cmp = icmp eq i32 %call4, 0, !dbg !1070
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1070

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0), i32 27, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__PRETTY_FUNCTION__.test_add_duplicate_updates_value_only, i64 0, i64 0)) #6, !dbg !1070
  unreachable, !dbg !1070

cond.end:                                         ; preds = %entry
  %3 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1071
  %4 = bitcast i32* %key to i8*, !dbg !1071
  %5 = bitcast i32* %new_value to i8*, !dbg !1071
  %call5 = call i32 @treetable_add(%struct.treetable_s* %3, i8* %4, i8* %5), !dbg !1071
  %cmp6 = icmp eq i32 %call5, 0, !dbg !1071
  br i1 %cmp6, label %cond.end9, label %cond.false8, !dbg !1071

cond.false8:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0), i32 28, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__PRETTY_FUNCTION__.test_add_duplicate_updates_value_only, i64 0, i64 0)) #6, !dbg !1071
  unreachable, !dbg !1071

cond.end9:                                        ; preds = %cond.end
  %6 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1072
  %call10 = call i64 @treetable_size(%struct.treetable_s* %6), !dbg !1072
  %cmp11 = icmp eq i64 %call10, 1, !dbg !1072
  br i1 %cmp11, label %cond.end14, label %cond.false13, !dbg !1072

cond.false13:                                     ; preds = %cond.end9
  call void @__assert_fail(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0), i32 31, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__PRETTY_FUNCTION__.test_add_duplicate_updates_value_only, i64 0, i64 0)) #6, !dbg !1072
  unreachable, !dbg !1072

cond.end14:                                       ; preds = %cond.end9
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1073
  %8 = bitcast i32* %key to i8*, !dbg !1073
  %call15 = call i32 @treetable_get(%struct.treetable_s* %7, i8* %8, i8** %out), !dbg !1073
  %cmp16 = icmp eq i32 %call15, 0, !dbg !1073
  br i1 %cmp16, label %cond.end19, label %cond.false18, !dbg !1073

cond.false18:                                     ; preds = %cond.end14
  call void @__assert_fail(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0), i32 34, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__PRETTY_FUNCTION__.test_add_duplicate_updates_value_only, i64 0, i64 0)) #6, !dbg !1073
  unreachable, !dbg !1073

cond.end19:                                       ; preds = %cond.end14
  %9 = load i8*, i8** %out, align 8, !dbg !1074
  %10 = bitcast i32* %new_value to i8*, !dbg !1074
  %cmp20 = icmp eq i8* %9, %10, !dbg !1074
  br i1 %cmp20, label %cond.end23, label %cond.false22, !dbg !1074

cond.false22:                                     ; preds = %cond.end19
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0), i32 35, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__PRETTY_FUNCTION__.test_add_duplicate_updates_value_only, i64 0, i64 0)) #6, !dbg !1074
  unreachable, !dbg !1074

cond.end23:                                       ; preds = %cond.end19
  %11 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1075
  %call24 = call i32 @balanced(%struct.treetable_s* %11), !dbg !1075
  %tobool = icmp ne i32 %call24, 0, !dbg !1075
  br i1 %tobool, label %cond.end27, label %cond.false26, !dbg !1075

cond.false26:                                     ; preds = %cond.end23
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.9, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0), i32 37, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__PRETTY_FUNCTION__.test_add_duplicate_updates_value_only, i64 0, i64 0)) #6, !dbg !1075
  unreachable, !dbg !1075

cond.end27:                                       ; preds = %cond.end23
  %12 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1076
  %call28 = call i32 @sorted(%struct.treetable_s* %12), !dbg !1076
  %tobool29 = icmp ne i32 %call28, 0, !dbg !1076
  br i1 %tobool29, label %cond.end32, label %cond.false31, !dbg !1076

cond.false31:                                     ; preds = %cond.end27
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0), i32 38, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__PRETTY_FUNCTION__.test_add_duplicate_updates_value_only, i64 0, i64 0)) #6, !dbg !1076
  unreachable, !dbg !1076

cond.end32:                                       ; preds = %cond.end27
  %13 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1077
  call void @treetable_destroy(%struct.treetable_s* %13), !dbg !1078
  ret void, !dbg !1079
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @symbolic_int(i8* %name, i32 %concrete_fallback) #0 !dbg !1080 {
entry:
  %name.addr = alloca i8*, align 8
  %concrete_fallback.addr = alloca i32, align 4
  %value = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %name.addr, metadata !1086, metadata !DIExpression()), !dbg !1087
  store i32 %concrete_fallback, i32* %concrete_fallback.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %concrete_fallback.addr, metadata !1088, metadata !DIExpression()), !dbg !1089
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1090, metadata !DIExpression()), !dbg !1091
  %0 = load i32, i32* %concrete_fallback.addr, align 4, !dbg !1092
  store i32 %0, i32* %value, align 4, !dbg !1091
  %1 = bitcast i32* %value to i8*, !dbg !1093
  %2 = load i8*, i8** %name.addr, align 8, !dbg !1094
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %2), !dbg !1095
  %3 = load i32, i32* %value, align 4, !dbg !1096
  ret i32 %3, !dbg !1097
}

; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1098 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1101, metadata !DIExpression()), !dbg !1102
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1103, metadata !DIExpression()), !dbg !1104
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1104
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1105
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1106
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1107
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1108
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1109
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1110
  %cmp = icmp eq i32 %call, 0, !dbg !1110
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1110

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.11, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.12, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1110
  unreachable, !dbg !1110

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1111
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1111
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1111

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.13, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.12, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1111
  unreachable, !dbg !1111

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1112
  ret %struct.treetable_s* %1, !dbg !1113
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1114 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_add_duplicate_updates_value_only(), !dbg !1117
  ret i32 0, !dbg !1118
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1119 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1120, metadata !DIExpression()), !dbg !1121
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1122, metadata !DIExpression()), !dbg !1123
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1124, metadata !DIExpression()), !dbg !1125
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1126
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1127
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1127
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1125
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1128
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1129
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1129
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1130
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1131
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1132
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1133
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1135
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1135
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1136
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1137
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1137
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1138
  br i1 %cmp, label %if.then, label %if.end, !dbg !1139

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1140
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1141
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1142
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1142
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1143
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1144
  br label %if.end, !dbg !1141

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1145
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1146
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1146
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1147
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1148
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1149
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1150
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1152
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1152
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1153
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1154
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1154
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1155
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1156

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1157
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1158
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1159
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1160
  br label %if.end20, !dbg !1158

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1161
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1163
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1164
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1164
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1165
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1165
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1166
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1167

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1168
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1169
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1170
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1170
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1171
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1172
  br label %if.end20, !dbg !1169

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1173
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1174
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1175
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1175
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1176
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1177
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1178
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1179
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1180
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1181
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1182
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1183
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1184
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1185
  ret void, !dbg !1186
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1187 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1188, metadata !DIExpression()), !dbg !1189
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1190, metadata !DIExpression()), !dbg !1191
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1192, metadata !DIExpression()), !dbg !1193
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1194
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1195
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1195
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1193
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1196
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1197
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1197
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1198
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1199
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1200
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1201
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1203
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1203
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1204
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1205
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1205
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1206
  br i1 %cmp, label %if.then, label %if.end, !dbg !1207

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1208
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1209
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1210
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1210
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1211
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1212
  br label %if.end, !dbg !1209

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1213
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1214
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1214
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1215
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1216
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1217
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1218
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1220
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1220
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1221
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1222
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1222
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1223
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1224

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1225
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1226
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1227
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1228
  br label %if.end20, !dbg !1226

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1229
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1231
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1232
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1232
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1233
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1233
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1234
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1235

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1236
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1237
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1238
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1238
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1239
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1240
  br label %if.end20, !dbg !1237

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1241
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1242
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1243
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1243
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1244
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1245
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1246
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1247
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1248
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1249
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1250
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1251
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1252
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1253
  ret void, !dbg !1254
}
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1255 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1256, metadata !DIExpression()), !dbg !1257
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1258, metadata !DIExpression()), !dbg !1259
  %0 = load i64, i64* %size.addr, align 8, !dbg !1260
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1261
  store i8* %call, i8** %ptr, align 8, !dbg !1259
  %1 = load i8*, i8** %ptr, align 8, !dbg !1262
  %cmp = icmp ne i8* %1, null, !dbg !1263
  %conv = zext i1 %cmp to i32, !dbg !1263
  %conv1 = sext i32 %conv to i64, !dbg !1262
  call void @klee_assume(i64 %conv1), !dbg !1264
  %2 = load i8*, i8** %ptr, align 8, !dbg !1265
  ret i8* %2, !dbg !1266
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1267 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1268, metadata !DIExpression()), !dbg !1269
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1270, metadata !DIExpression()), !dbg !1271
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1272, metadata !DIExpression()), !dbg !1273
  %0 = load i64, i64* %count.addr, align 8, !dbg !1274
  %1 = load i64, i64* %size.addr, align 8, !dbg !1275
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1276
  store i8* %call, i8** %ptr, align 8, !dbg !1273
  %2 = load i8*, i8** %ptr, align 8, !dbg !1277
  %cmp = icmp ne i8* %2, null, !dbg !1278
  %conv = zext i1 %cmp to i32, !dbg !1278
  %conv1 = sext i32 %conv to i64, !dbg !1277
  call void @klee_assume(i64 %conv1), !dbg !1279
  %3 = load i8*, i8** %ptr, align 8, !dbg !1280
  ret i8* %3, !dbg !1281
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1282 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1288, metadata !DIExpression()), !dbg !1289
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1290, metadata !DIExpression()), !dbg !1291
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1292, metadata !DIExpression()), !dbg !1293
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1294, metadata !DIExpression()), !dbg !1296
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1297
  store i8* %0, i8** %dest, align 8, !dbg !1296
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1298, metadata !DIExpression()), !dbg !1299
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1300
  store i8* %1, i8** %src, align 8, !dbg !1299
  br label %while.cond, !dbg !1301

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1302
  %dec = add i64 %2, -1, !dbg !1302
  store i64 %dec, i64* %len.addr, align 8, !dbg !1302
  %cmp = icmp ugt i64 %2, 0, !dbg !1303
  br i1 %cmp, label %while.body, label %while.end, !dbg !1301

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1304
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1304
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1304
  %4 = load i8, i8* %3, align 1, !dbg !1305
  %5 = load i8*, i8** %dest, align 8, !dbg !1306
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1306
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1306
  store i8 %4, i8* %5, align 1, !dbg !1307
  br label %while.cond, !dbg !1301, !llvm.loop !1308

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1309
  ret i8* %6, !dbg !1310
}
...
!1 = !DIFile(filename: "test_add_duplicate_updates_value_only.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_add_duplicate_updates_value_only", scope: !1, file: !1, line: 18, type: !1054, scopeLine: 19, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "key", scope: !1053, file: !1, line: 20, type: !18)
!1057 = !DILocation(line: 20, column: 9, scope: !1053)
!1058 = !DILocation(line: 20, column: 21, scope: !1053)
!1059 = !DILocalVariable(name: "old_value", scope: !1053, file: !1, line: 21, type: !18)
!1060 = !DILocation(line: 21, column: 9, scope: !1053)
!1061 = !DILocation(line: 21, column: 21, scope: !1053)
!1062 = !DILocalVariable(name: "new_value", scope: !1053, file: !1, line: 22, type: !18)
!1063 = !DILocation(line: 22, column: 9, scope: !1053)
!1064 = !DILocation(line: 22, column: 21, scope: !1053)
!1065 = !DILocalVariable(name: "out", scope: !1053, file: !1, line: 23, type: !19)
!1066 = !DILocation(line: 23, column: 11, scope: !1053)
!1067 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 25, type: !107)
!1068 = !DILocation(line: 25, column: 16, scope: !1053)
!1069 = !DILocation(line: 25, column: 24, scope: !1053)
!1070 = !DILocation(line: 27, column: 5, scope: !1053)
!1071 = !DILocation(line: 28, column: 5, scope: !1053)
!1072 = !DILocation(line: 31, column: 5, scope: !1053)
!1073 = !DILocation(line: 34, column: 5, scope: !1053)
!1074 = !DILocation(line: 35, column: 5, scope: !1053)
!1075 = !DILocation(line: 37, column: 5, scope: !1053)
!1076 = !DILocation(line: 38, column: 5, scope: !1053)
!1077 = !DILocation(line: 40, column: 23, scope: !1053)
!1078 = !DILocation(line: 40, column: 5, scope: !1053)
!1079 = !DILocation(line: 41, column: 1, scope: !1053)
!1080 = distinct !DISubprogram(name: "symbolic_int", scope: !1081, file: !1081, line: 32, type: !1082, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1081 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1082 = !DISubroutineType(types: !1083)
!1083 = !{!18, !1084, !18}
!1084 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1085, size: 64)
!1085 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1086 = !DILocalVariable(name: "name", arg: 1, scope: !1080, file: !1081, line: 32, type: !1084)
!1087 = !DILocation(line: 32, column: 37, scope: !1080)
!1088 = !DILocalVariable(name: "concrete_fallback", arg: 2, scope: !1080, file: !1081, line: 32, type: !18)
!1089 = !DILocation(line: 32, column: 47, scope: !1080)
!1090 = !DILocalVariable(name: "value", scope: !1080, file: !1081, line: 34, type: !18)
!1091 = !DILocation(line: 34, column: 9, scope: !1080)
!1092 = !DILocation(line: 34, column: 17, scope: !1080)
!1093 = !DILocation(line: 35, column: 24, scope: !1080)
!1094 = !DILocation(line: 35, column: 47, scope: !1080)
!1095 = !DILocation(line: 35, column: 5, scope: !1080)
!1096 = !DILocation(line: 36, column: 12, scope: !1080)
!1097 = !DILocation(line: 36, column: 5, scope: !1080)
!1098 = distinct !DISubprogram(name: "make_table", scope: !1081, file: !1081, line: 53, type: !1099, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1099 = !DISubroutineType(types: !1100)
!1100 = !{!107}
!1101 = !DILocalVariable(name: "conf", scope: !1098, file: !1081, line: 55, type: !67)
!1102 = !DILocation(line: 55, column: 19, scope: !1098)
!1103 = !DILocalVariable(name: "table", scope: !1098, file: !1081, line: 56, type: !107)
!1104 = !DILocation(line: 56, column: 16, scope: !1098)
!1105 = !DILocation(line: 57, column: 5, scope: !1098)
!1106 = !DILocation(line: 58, column: 10, scope: !1098)
!1107 = !DILocation(line: 58, column: 22, scope: !1098)
!1108 = !DILocation(line: 59, column: 10, scope: !1098)
!1109 = !DILocation(line: 59, column: 22, scope: !1098)
!1110 = !DILocation(line: 60, column: 5, scope: !1098)
!1111 = !DILocation(line: 61, column: 5, scope: !1098)
!1112 = !DILocation(line: 62, column: 12, scope: !1098)
!1113 = !DILocation(line: 62, column: 5, scope: !1098)
!1114 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line:
!1262 = !DILocation(line: 42, column: 17, scope: !1255)
!1263 = !DILocation(line: 42, column: 21, scope: !1255)
!1264 = !DILocation(line: 42, column: 5, scope: !1255)
!1265 = !DILocation(line: 43, column: 12, scope: !1255)
!1266 = !DILocation(line: 43, column: 5, scope: !1255)
!1267 = distinct !DISubprogram(name: "safe_calloc", scope: !1081, file: !1081, line: 46, type: !82, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1268 = !DILocalVariable(name: "count", arg: 1, scope: !1267, file: !1081, line: 46, type: !77)
!1269 = !DILocation(line: 46, column: 33, scope: !1267)
!1270 = !DILocalVariable(name: "size", arg: 2, scope: !1267, file: !1081, line: 46, type: !77)
!1271 = !DILocation(line: 46, column: 47, scope: !1267)
!1272 = !DILocalVariable(name: "ptr", scope: !1267, file: !1081, line: 48, type: !19)
!1273 = !DILocation(line: 48, column: 11, scope: !1267)
!1274 = !DILocation(line: 48, column: 24, scope: !1267)
!1275 = !DILocation(line: 48, column: 31, scope: !1267)
!1276 = !DILocation(line: 48, column: 17, scope: !1267)
!1277 = !DILocation(line: 49, column: 17, scope: !1267)
!1278 = !DILocation(line: 49, column: 21, scope: !1267)
!1279 = !DILocation(line: 49, column: 5, scope: !1267)
!1280 = !DILocation(line: 50, column: 12, scope: !1267)
!1281 = !DILocation(line: 50, column: 5, scope: !1267)
!1282 = distinct !DISubprogram(name: "memcpy", scope: !1283, file: !1283, line: 12, type: !1284, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1283 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1284 = !DISubroutineType(types: !1285)
!1285 = !{!19, !19, !33, !1286}
!1286 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1287, line: 46, baseType: !79)
!1287 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1288 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1282, file: !1283, line: 12, type: !19)
!1289 = !DILocation(line: 12, column: 20, scope: !1282)
!1290 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1282, file: !1283, line: 12, type: !33)
!1291 = !DILocation(line: 12, column: 42, scope: !1282)
!1292 = !DILocalVariable(name: "len", arg: 3, scope: !1282, file: !1283, line: 12, type: !1286)
!1293 = !DILocation(line: 12, column: 58, scope: !1282)
!1294 = !DILocalVariable(name: "dest", scope: !1282, file: !1283, line: 13, type: !1295)
!1295 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1296 = !DILocation(line: 13, column: 9, scope: !1282)
!1297 = !DILocation(line: 13, column: 16, scope: !1282)
!1298 = !DILocalVariable(name: "src", scope: !1282, file: !1283, line: 14, type: !1084)
!1299 = !DILocation(line: 14, column: 15, scope: !1282)
!1300 = !DILocation(line: 14, column: 21, scope: !1282)
!1301 = !DILocation(line: 16, column: 3, scope: !1282)
!1302 = !DILocation(line: 16, column: 13, scope: !1282)
!1303 = !DILocation(line: 16, column: 16, scope: !1282)
!1304 = !DILocation(line: 17, column: 19, scope: !1282)
!1305 = !DILocation(line: 17, column: 15, scope: !1282)
!1306 = !DILocation(line: 17, column: 10, scope: !1282)
!1307 = !DILocation(line: 17, column: 13, scope: !1282)
!1308 = distinct !{!1308, !1301, !1304, !332}
!1309 = !DILocation(line: 18, column: 10, scope: !1282)
!1310 = !DILocation(line: 18, column: 3, scope: !1282)
