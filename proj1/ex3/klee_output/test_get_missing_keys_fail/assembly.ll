; ModuleID = 'test_get_missing_keys_fail.bc'
source_filename = "test_get_missing_keys_fail.c"
...
@.str = private unnamed_addr constant [17 x i8] c"get_absent_empty\00", align 1
@.str.1 = private unnamed_addr constant [12 x i8] c"get_present\00", align 1
@.str.2 = private unnamed_addr constant [20 x i8] c"get_absent_nonempty\00", align 1
@.str.3 = private unnamed_addr constant [10 x i8] c"get_value\00", align 1
@.str.4 = private unnamed_addr constant [60 x i8] c"treetable_get(table, &absent, &out) == CC_ERR_KEY_NOT_FOUND\00", align 1
@.str.5 = private unnamed_addr constant [29 x i8] c"test_get_missing_keys_fail.c\00", align 1
@__PRETTY_FUNCTION__.test_get_missing_keys_fail = private unnamed_addr constant [38 x i8] c"void test_get_missing_keys_fail(void)\00", align 1
@.str.6 = private unnamed_addr constant [48 x i8] c"treetable_add(table, &present, &value) == CC_OK\00", align 1
@.str.7 = private unnamed_addr constant [59 x i8] c"treetable_get(table, &other, &out) == CC_ERR_KEY_NOT_FOUND\00", align 1
@.str.8 = private unnamed_addr constant [43 x i8] c"treetable_new_conf(&conf, &table) == CC_OK\00", align 1
@.str.9 = private unnamed_addr constant [17 x i8] c"./klee_helpers.h\00", align 1
@__PRETTY_FUNCTION__.make_table = private unnamed_addr constant [28 x i8] c"TreeTable *make_table(void)\00", align 1
@.str.10 = private unnamed_addr constant [14 x i8] c"table != NULL\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_get_missing_keys_fail() #0 !dbg !1053 {
entry:
  ...
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata i32* %absent, metadata !1056, metadata !DIExpression()), !dbg !1057
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i64 0, i64 0), i32 99), !dbg !1058
  store i32 %call, i32* %absent, align 4, !dbg !1057
  call void @llvm.dbg.declare(metadata i32* %present, metadata !1059, metadata !DIExpression()), !dbg !1060
  %call1 = call i32 @symbolic_int(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i32 10), !dbg !1061
  store i32 %call1, i32* %present, align 4, !dbg !1060
  call void @llvm.dbg.declare(metadata i32* %other, metadata !1062, metadata !DIExpression()), !dbg !1063
  %call2 = call i32 @symbolic_int(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i64 0, i64 0), i32 20), !dbg !1064
  store i32 %call2, i32* %other, align 4, !dbg !1063
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1065, metadata !DIExpression()), !dbg !1066
  %call3 = call i32 @symbolic_int(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i32 42), !dbg !1067
  ...
  %0 = load i32, i32* %present, align 4, !dbg !1070
  %1 = load i32, i32* %other, align 4, !dbg !1071
  ...
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1074, metadata !DIExpression()), !dbg !1075
  %call5 = call %struct.treetable_s* @make_table(), !dbg !1076
  store %struct.treetable_s* %call5, %struct.treetable_s** %table, align 8, !dbg !1075
  %2 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1077
  %3 = bitcast i32* %absent to i8*, !dbg !1077
  %call6 = call i32 @treetable_get(%struct.treetable_s* %2, i8* %3, i8** %out), !dbg !1077
  %cmp7 = icmp eq i32 %call6, 6, !dbg !1077
  br i1 %cmp7, label %cond.end, label %cond.false, !dbg !1077

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.5, i64 0, i64 0), i32 33, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__PRETTY_FUNCTION__.test_get_missing_keys_fail, i64 0, i64 0)) #6, !dbg !1077
  unreachable, !dbg !1077

cond.end:                                         ; preds = %entry
  %4 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1078
  %5 = bitcast i32* %present to i8*, !dbg !1078
  %6 = bitcast i32* %value to i8*, !dbg !1078
  %call9 = call i32 @treetable_add(%struct.treetable_s* %4, i8* %5, i8* %6), !dbg !1078
  %cmp10 = icmp eq i32 %call9, 0, !dbg !1078
  br i1 %cmp10, label %cond.end14, label %cond.false13, !dbg !1078

cond.false13:                                     ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.5, i64 0, i64 0), i32 36, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__PRETTY_FUNCTION__.test_get_missing_keys_fail, i64 0, i64 0)) #6, !dbg !1078
  unreachable, !dbg !1078

cond.end14:                                       ; preds = %cond.end
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1079
  %8 = bitcast i32* %other to i8*, !dbg !1079
  %call15 = call i32 @treetable_get(%struct.treetable_s* %7, i8* %8, i8** %out), !dbg !1079
  %cmp16 = icmp eq i32 %call15, 6, !dbg !1079
  br i1 %cmp16, label %cond.end20, label %cond.false19, !dbg !1079

cond.false19:                                     ; preds = %cond.end14
  call void @__assert_fail(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.5, i64 0, i64 0), i32 39, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__PRETTY_FUNCTION__.test_get_missing_keys_fail, i64 0, i64 0)) #6, !dbg !1079
  unreachable, !dbg !1079

cond.end20:                                       ; preds = %cond.end14
  %9 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1080
  call void @treetable_destroy(%struct.treetable_s* %9), !dbg !1081
  ret void, !dbg !1082
}
...
cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.9, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1113
...
cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.9, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1114
...
entry:
  ...
  call void @test_get_missing_keys_fail(), !dbg !1120
  ret i32 0, !dbg !1121
}
...
!1 = !DIFile(filename: "test_get_missing_keys_fail.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_get_missing_keys_fail", scope: !1, file: !1, line: 20, type: !1054, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "absent", scope: !1053, file: !1, line: 22, type: !18)
!1057 = !DILocation(line: 22, column: 9, scope: !1053)
!1058 = !DILocation(line: 22, column: 19, scope: !1053)
!1059 = !DILocalVariable(name: "present", scope: !1053, file: !1, line: 23, type: !18)
!1060 = !DILocation(line: 23, column: 9, scope: !1053)
!1061 = !DILocation(line: 23, column: 19, scope: !1053)
!1062 = !DILocalVariable(name: "other", scope: !1053, file: !1, line: 24, type: !18)
!1063 = !DILocation(line: 24, column: 9, scope: !1053)
!1064 = !DILocation(line: 24, column: 19, scope: !1053)
!1065 = !DILocalVariable(name: "value", scope: !1053, file: !1, line: 25, type: !18)
!1066 = !DILocation(line: 25, column: 9, scope: !1053)
!1067 = !DILocation(line: 25, column: 19, scope: !1053)
...
!1071 = !DILocation(line: 28, column: 28, scope: !1053)
!1072 = !DILocation(line: 28, column: 25, scope: !1053)
!1073 = !DILocation(line: 28, column: 5, scope: !1053)
!1074 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 30, type: !107)
!1075 = !DILocation(line: 30, column: 16, scope: !1053)
!1076 = !DILocation(line: 30, column: 24, scope: !1053)
!1077 = !DILocation(line: 33, column: 5, scope: !1053)
!1078 = !DILocation(line: 36, column: 5, scope: !1053)
