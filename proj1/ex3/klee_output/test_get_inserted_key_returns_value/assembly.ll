; ModuleID = 'test_get_inserted_key_returns_value.bc'
source_filename = "test_get_inserted_key_returns_value.c"
...
@.str = private unnamed_addr constant [14 x i8] c"get_found_key\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"get_found_value\00", align 1
@.str.2 = private unnamed_addr constant [44 x i8] c"treetable_add(table, &key, &value) == CC_OK\00", align 1
@.str.3 = private unnamed_addr constant [38 x i8] c"test_get_inserted_key_returns_value.c\00", align 1
@__PRETTY_FUNCTION__.test_get_inserted_key_returns_value = private unnamed_addr constant [47 x i8] c"void test_get_inserted_key_returns_value(void)\00", align 1
@.str.4 = private unnamed_addr constant [42 x i8] c"treetable_get(table, &key, &out) == CC_OK\00", align 1
@.str.5 = private unnamed_addr constant [14 x i8] c"out == &value\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_get_inserted_key_returns_value() #0 !dbg !1053 {
entry:
  ...
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i32 7), !dbg !1058
  ...
  %call1 = call i32 @symbolic_int(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i32 70), !dbg !1061
  store i32 %call1, i32* %value, align 4, !dbg !1060
  call void @llvm.dbg.declare(metadata i8** %out, metadata !1062, metadata !DIExpression()), !dbg !1063
  store i8* null, i8** %out, align 8, !dbg !1063
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1064, metadata !DIExpression()), !dbg !1065
  %call2 = call %struct.treetable_s* @make_table(), !dbg !1066
  store %struct.treetable_s* %call2, %struct.treetable_s** %table, align 8, !dbg !1065
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1067
  %1 = bitcast i32* %key to i8*, !dbg !1067
  %2 = bitcast i32* %value to i8*, !dbg !1067
  %call3 = call i32 @treetable_add(%struct.treetable_s* %0, i8* %1, i8* %2), !dbg !1067
  %cmp = icmp eq i32 %call3, 0, !dbg !1067
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1067

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.3, i64 0, i64 0), i32 25, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__PRETTY_FUNCTION__.test_get_inserted_key_returns_value, i64 0, i64 0)) #6, !dbg !1067
  unreachable, !dbg !1067

cond.end:                                         ; preds = %entry
  %3 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1068
  %4 = bitcast i32* %key to i8*, !dbg !1068
  %call4 = call i32 @treetable_get(%struct.treetable_s* %3, i8* %4, i8** %out), !dbg !1068
  %cmp5 = icmp eq i32 %call4, 0, !dbg !1068
  br i1 %cmp5, label %cond.end8, label %cond.false7, !dbg !1068

cond.false7:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.3, i64 0, i64 0), i32 28, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__PRETTY_FUNCTION__.test_get_inserted_key_returns_value, i64 0, i64 0)) #6, !dbg !1068
  unreachable, !dbg !1068

cond.end8:                                        ; preds = %cond.end
  %5 = load i8*, i8** %out, align 8, !dbg !1069
  %6 = bitcast i32* %value to i8*, !dbg !1069
  %cmp9 = icmp eq i8* %5, %6, !dbg !1069
  br i1 %cmp9, label %cond.end12, label %cond.false11, !dbg !1069

cond.false11:                                     ; preds = %cond.end8
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.3, i64 0, i64 0), i32 29, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__PRETTY_FUNCTION__.test_get_inserted_key_returns_value, i64 0, i64 0)) #6, !dbg !1069
  unreachable, !dbg !1069

cond.end12:                                       ; preds = %cond.end8
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1070
  call void @treetable_destroy(%struct.treetable_s* %7), !dbg !1071
  ret void, !dbg !1072
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @symbolic_int(i8* %name, i32 %concrete_fallback) #0 !dbg !1073 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %concrete_fallback.addr, metadata !1081, metadata !DIExpression()), !dbg !1082
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1083, metadata !DIExpression()), !dbg !1084
  %0 = load i32, i32* %concrete_fallback.addr, align 4, !dbg !1085
  store i32 %0, i32* %value, align 4, !dbg !1084
  %1 = bitcast i32* %value to i8*, !dbg !1086
  %2 = load i8*, i8** %name.addr, align 8, !dbg !1087
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %2), !dbg !1088
  %3 = load i32, i32* %value, align 4, !dbg !1089
  ret i32 %3, !dbg !1090
}

; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1091 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1094, metadata !DIExpression()), !dbg !1095
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1096, metadata !DIExpression()), !dbg !1097
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1097
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1098
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1099
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1100
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1101
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1102
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1103
  %cmp = icmp eq i32 %call, 0, !dbg !1103
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1103

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.7, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1103
  unreachable, !dbg !1103

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1104
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1104
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1104

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.7, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1104
  unreachable, !dbg !1104

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1105
  ret %struct.treetable_s* %1, !dbg !1106
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1107 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_get_inserted_key_returns_value(), !dbg !1110
  ret i32 0, !dbg !1111
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1112 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1113, metadata !DIExpression()), !dbg !1114
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1115, metadata !DIExpression()), !dbg !1116
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1117, metadata !DIExpression()), !dbg !1118
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1119
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1120
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1120
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1118
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1121
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1122
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1122
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1123
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1124
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1125
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1126
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1128
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1128
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1129
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1130
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1130
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1131
  br i1 %cmp, label %if.then, label %if.end, !dbg !1132

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1133
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1134
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1135
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1135
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1136
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1137
  br label %if.end, !dbg !1134

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1138
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1139
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1139
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1140
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1141
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1142
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1143
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1145
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1145
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1146
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1147
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1147
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1148
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1149

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1150
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1151
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1152
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1153
  br label %if.end20, !dbg !1151

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1154
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1156
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1157
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1157
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1158
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1158
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1159
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1160

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1161
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1162
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1163
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1163
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1164
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1165
  br label %if.end20, !dbg !1162

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1166
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1167
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1168
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1168
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1169
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1170
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1171
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1172
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1173
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1174
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1175
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1176
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1177
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1178
  ret void, !dbg !1179
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1180 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1181, metadata !DIExpression()), !dbg !1182
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1183, metadata !DIExpression()), !dbg !1184
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1185, metadata !DIExpression()), !dbg !1186
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1187
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1188
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1188
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1186
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1189
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1190
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1190
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1191
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1192
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1193
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1194
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1196
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1196
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1197
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1198
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1198
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1199
  br i1 %cmp, label %if.then, label %if.end, !dbg !1200

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1201
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1202
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1203
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1203
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1204
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1205
  br label %if.end, !dbg !1202

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1206
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1207
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1207
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1208
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1209
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1210
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1211
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1213
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1213
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1214
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1215
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1215
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1216
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1217

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1218
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1219
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1220
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1221
  br label %if.end20, !dbg !1219

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1222
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1224
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1225
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1225
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1226
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1226
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1227
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1228

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1229
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1230
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1231
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1231
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1232
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1233
  br label %if.end20, !dbg !1230

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1234
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1235
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1236
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1236
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1237
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1238
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1239
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1240
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1241
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1242
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1243
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1244
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1245
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1246
  ret void, !dbg !1247
}
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1248 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1249, metadata !DIExpression()), !dbg !1250
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1251, metadata !DIExpression()), !dbg !1252
  %0 = load i64, i64* %size.addr, align 8, !dbg !1253
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1254
  store i8* %call, i8** %ptr, align 8, !dbg !1252
  %1 = load i8*, i8** %ptr, align 8, !dbg !1255
  %cmp = icmp ne i8* %1, null, !dbg !1256
  %conv = zext i1 %cmp to i32, !dbg !1256
  %conv1 = sext i32 %conv to i64, !dbg !1255
  call void @klee_assume(i64 %conv1), !dbg !1257
  %2 = load i8*, i8** %ptr, align 8, !dbg !1258
  ret i8* %2, !dbg !1259
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1260 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1261, metadata !DIExpression()), !dbg !1262
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1263, metadata !DIExpression()), !dbg !1264
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1265, metadata !DIExpression()), !dbg !1266
  %0 = load i64, i64* %count.addr, align 8, !dbg !1267
  %1 = load i64, i64* %size.addr, align 8, !dbg !1268
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1269
  store i8* %call, i8** %ptr, align 8, !dbg !1266
  %2 = load i8*, i8** %ptr, align 8, !dbg !1270
  %cmp = icmp ne i8* %2, null, !dbg !1271
  %conv = zext i1 %cmp to i32, !dbg !1271
  %conv1 = sext i32 %conv to i64, !dbg !1270
  call void @klee_assume(i64 %conv1), !dbg !1272
  %3 = load i8*, i8** %ptr, align 8, !dbg !1273
  ret i8* %3, !dbg !1274
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1275 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1281, metadata !DIExpression()), !dbg !1282
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1283, metadata !DIExpression()), !dbg !1284
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1285, metadata !DIExpression()), !dbg !1286
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1287, metadata !DIExpression()), !dbg !1289
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1290
  store i8* %0, i8** %dest, align 8, !dbg !1289
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1291, metadata !DIExpression()), !dbg !1292
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1293
  store i8* %1, i8** %src, align 8, !dbg !1292
  br label %while.cond, !dbg !1294

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1295
  %dec = add i64 %2, -1, !dbg !1295
  store i64 %dec, i64* %len.addr, align 8, !dbg !1295
  %cmp = icmp ugt i64 %2, 0, !dbg !1296
  br i1 %cmp, label %while.body, label %while.end, !dbg !1294

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1297
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1297
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1297
  %4 = load i8, i8* %3, align 1, !dbg !1298
  %5 = load i8*, i8** %dest, align 8, !dbg !1299
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1299
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1299
  store i8 %4, i8* %5, align 1, !dbg !1300
  br label %while.cond, !dbg !1294, !llvm.loop !1301

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1302
  ret i8* %6, !dbg !1303
}
...
!1 = !DIFile(filename: "test_get_inserted_key_returns_value.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_get_inserted_key_returns_value", scope: !1, file: !1, line: 17, type: !1054, scopeLine: 18, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "key", scope: !1053, file: !1, line: 19, type: !18)
!1057 = !DILocation(line: 19, column: 9, scope: !1053)
!1058 = !DILocation(line: 19, column: 17, scope: !1053)
!1059 = !DILocalVariable(name: "value", scope: !1053, file: !1, line: 20, type: !18)
!1060 = !DILocation(line: 20, column: 9, scope: !1053)
!1061 = !DILocation(line: 20, column: 17, scope: !1053)
!1062 = !DILocalVariable(name: "out", scope: !1053, file: !1, line: 21, type: !19)
!1063 = !DILocation(line: 21, column: 11, scope: !1053)
!1064 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 23, type: !107)
!1065 = !DILocation(line: 23, column: 16, scope: !1053)
!1066 = !DILocation(line: 23, column: 24, scope: !1053)
!1067 = !DILocation(line: 25, column: 5, scope: !1053)
!1068 = !DILocation(line: 28, column: 5, scope: !1053)
!1069 = !DILocation(line: 29, column: 5, scope: !1053)
!1070 = !DILocation(line: 31, column: 23, scope: !1053)
!1071 = !DILocation(line: 31, column: 5, scope: !1053)
!1072 = !DILocation(line: 32, column: 1, scope: !1053)
!1073 = distinct !DISubprogram(name: "symbolic_int", scope: !1074, file: !1074, line: 32, type: !1075, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1074 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1075 = !DISubroutineType(types: !1076)
!1076 = !{!18, !1077, !18}
!1077 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1078, size: 64)
!1078 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1079 = !DILocalVariable(name: "name", arg: 1, scope: !1073, file: !1074, line: 32, type: !1077)
!1080 = !DILocation(line: 32, column: 37, scope: !1073)
!1081 = !DILocalVariable(name: "concrete_fallback", arg: 2, scope: !1073, file: !1074, line: 32, type: !18)
!1082 = !DILocation(line: 32, column: 47, scope: !1073)
!1083 = !DILocalVariable(name: "value", scope: !1073, file: !1074, line: 34, type: !18)
!1084 = !DILocation(line: 34, column: 9, scope: !1073)
!1085 = !DILocation(line: 34, column: 17, scope: !1073)
!1086 = !DILocation(line: 35, column: 24, scope: !1073)
!1087 = !DILocation(line: 35, column: 47, scope: !1073)
!1088 = !DILocation(line: 35, column: 5, scope: !1073)
!1089 = !DILocation(line: 36, column: 12, scope: !1073)
!1090 = !DILocation(line: 36, column: 5, scope: !1073)
!1091 = distinct !DISubprogram(name: "make_table", scope: !1074, file: !1074, line: 53, type: !1092, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1092 = !DISubroutineType(types: !1093)
!1093 = !{!107}
!1094 = !DILocalVariable(name: "conf", scope: !1091, file: !1074, line: 55, type: !67)
!1095 = !DILocation(line: 55, column: 19, scope: !1091)
!1096 = !DILocalVariable(name: "table", scope: !1091, file: !1074, line: 56, type: !107)
!1097 = !DILocation(line: 56, column: 16, scope: !1091)
!1098 = !DILocation(line: 57, column: 5, scope: !1091)
!1099 = !DILocation(line: 58, column: 10, scope: !1091)
!1100 = !DILocation(line: 58, column: 22, scope: !1091)
!1101 = !DILocation(line: 59, column: 10, scope: !1091)
!1102 = !DILocation(line: 59, column: 22, scope: !1091)
!1103 = !DILocation(line: 60, column: 5, scope: !1091)
!1104 = !DILocation(line: 61, column: 5, scope: !1091)
!1105 = !DILocation(line: 62, column: 12, scope: !1091)
!1106 = !DILocation(line: 62, column: 5, scope: !1091)
!1107 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 34, type: !1108, scopeLine: 35, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1108 = !DISubroutineType(types: !1109)
!1109 = !{!18}
!1110 = !DILocation(line: 36, column: 5, scope: !1107)
!1111 = !DILocation(line: 37, column: 5, scope: !1107)
!1112 = distinct !DISubprogram(name: "rotate_left", scope: !30, file: !30, line: 547, type: !225, scopeLine: 548, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!
scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1261 = !DILocalVariable(name: "count", arg: 1, scope: !1260, file: !1074, line: 46, type: !77)
!1262 = !DILocation(line: 46, column: 33, scope: !1260)
!1263 = !DILocalVariable(name: "size", arg: 2, scope: !1260, file: !1074, line: 46, type: !77)
!1264 = !DILocation(line: 46, column: 47, scope: !1260)
!1265 = !DILocalVariable(name: "ptr", scope: !1260, file: !1074, line: 48, type: !19)
!1266 = !DILocation(line: 48, column: 11, scope: !1260)
!1267 = !DILocation(line: 48, column: 24, scope: !1260)
!1268 = !DILocation(line: 48, column: 31, scope: !1260)
!1269 = !DILocation(line: 48, column: 17, scope: !1260)
!1270 = !DILocation(line: 49, column: 17, scope: !1260)
!1271 = !DILocation(line: 49, column: 21, scope: !1260)
!1272 = !DILocation(line: 49, column: 5, scope: !1260)
!1273 = !DILocation(line: 50, column: 12, scope: !1260)
!1274 = !DILocation(line: 50, column: 5, scope: !1260)
!1275 = distinct !DISubprogram(name: "memcpy", scope: !1276, file: !1276, line: 12, type: !1277, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1276 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1277 = !DISubroutineType(types: !1278)
!1278 = !{!19, !19, !33, !1279}
!1279 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1280, line: 46, baseType: !79)
!1280 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1281 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1275, file: !1276, line: 12, type: !19)
!1282 = !DILocation(line: 12, column: 20, scope: !1275)
!1283 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1275, file: !1276, line: 12, type: !33)
!1284 = !DILocation(line: 12, column: 42, scope: !1275)
!1285 = !DILocalVariable(name: "len", arg: 3, scope: !1275, file: !1276, line: 12, type: !1279)
!1286 = !DILocation(line: 12, column: 58, scope: !1275)
!1287 = !DILocalVariable(name: "dest", scope: !1275, file: !1276, line: 13, type: !1288)
!1288 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1289 = !DILocation(line: 13, column: 9, scope: !1275)
!1290 = !DILocation(line: 13, column: 16, scope: !1275)
!1291 = !DILocalVariable(name: "src", scope: !1275, file: !1276, line: 14, type: !1077)
!1292 = !DILocation(line: 14, column: 15, scope: !1275)
!1293 = !DILocation(line: 14, column: 21, scope: !1275)
!1294 = !DILocation(line: 16, column: 3, scope: !1275)
!1295 = !DILocation(line: 16, column: 13, scope: !1275)
!1296 = !DILocation(line: 16, column: 16, scope: !1275)
!1297 = !DILocation(line: 17, column: 19, scope: !1275)
!1298 = !DILocation(line: 17, column: 15, scope: !1275)
!1299 = !DILocation(line: 17, column: 10, scope: !1275)
!1300 = !DILocation(line: 17, column: 13, scope: !1275)
!1301 = distinct !{!1301, !1294, !1297, !332}
!1302 = !DILocation(line: 18, column: 10, scope: !1275)
!1303 = !DILocation(line: 18, column: 3, scope: !1275)
