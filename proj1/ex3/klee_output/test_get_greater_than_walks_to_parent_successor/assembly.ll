; ModuleID = 'test_get_greater_than_walks_to_parent_successor.bc'
source_filename = "test_get_greater_than_walks_to_parent_successor.c"
...
@.str = private unnamed_addr constant [21 x i8] c"greater_parent_value\00", align 1
@.str.1 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k2, &value) == CC_OK\00", align 1
@.str.2 = private unnamed_addr constant [50 x i8] c"test_get_greater_than_walks_to_parent_successor.c\00", align 1
@__PRETTY_FUNCTION__.test_get_greater_than_walks_to_parent_successor = private unnamed_addr constant [59 x i8] c"void test_get_greater_than_walks_to_parent_successor(void)\00", align 1
@.str.3 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k1, &value) == CC_OK\00", align 1
@.str.4 = private unnamed_addr constant [54 x i8] c"treetable_get_greater_than(table, &k1, &out) == CC_OK\00", align 1
@.str.5 = private unnamed_addr constant [18 x i8] c"*(int *)out == k2\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_get_greater_than_walks_to_parent_successor() #0 !dbg !1053 {
entry:
  ...
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i32 1), !dbg !1062
  ...
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1065, metadata !DIExpression()), !dbg !1066
  %call1 = call %struct.treetable_s* @make_table(), !dbg !1067
  store %struct.treetable_s* %call1, %struct.treetable_s** %table, align 8, !dbg !1066
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1068
  %1 = bitcast i32* %k2 to i8*, !dbg !1068
  %2 = bitcast i32* %value to i8*, !dbg !1068
  %call2 = call i32 @treetable_add(%struct.treetable_s* %0, i8* %1, i8* %2), !dbg !1068
  %cmp = icmp eq i32 %call2, 0, !dbg !1068
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1068

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.2, i64 0, i64 0), i32 31, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_walks_to_parent_successor, i64 0, i64 0)) #6, !dbg !1068
  unreachable, !dbg !1068

cond.end:                                         ; preds = %entry
  %3 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1069
  %4 = bitcast i32* %k1 to i8*, !dbg !1069
  %5 = bitcast i32* %value to i8*, !dbg !1069
  %call3 = call i32 @treetable_add(%struct.treetable_s* %3, i8* %4, i8* %5), !dbg !1069
  %cmp4 = icmp eq i32 %call3, 0, !dbg !1069
  br i1 %cmp4, label %cond.end7, label %cond.false6, !dbg !1069

cond.false6:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.2, i64 0, i64 0), i32 32, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_walks_to_parent_successor, i64 0, i64 0)) #6, !dbg !1069
  unreachable, !dbg !1069

cond.end7:                                        ; preds = %cond.end
  %6 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1070
  %7 = bitcast i32* %k1 to i8*, !dbg !1070
  %call8 = call i32 @treetable_get_greater_than(%struct.treetable_s* %6, i8* %7, i8** %out), !dbg !1070
  %cmp9 = icmp eq i32 %call8, 0, !dbg !1070
  br i1 %cmp9, label %cond.end12, label %cond.false11, !dbg !1070

cond.false11:                                     ; preds = %cond.end7
  call void @__assert_fail(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.2, i64 0, i64 0), i32 34, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_walks_to_parent_successor, i64 0, i64 0)) #6, !dbg !1070
  unreachable, !dbg !1070

cond.end12:                                       ; preds = %cond.end7
  %8 = load i8*, i8** %out, align 8, !dbg !1071
  %9 = bitcast i8* %8 to i32*, !dbg !1071
  %10 = load i32, i32* %9, align 4, !dbg !1071
  %11 = load i32, i32* %k2, align 4, !dbg !1071
  %cmp13 = icmp eq i32 %10, %11, !dbg !1071
  br i1 %cmp13, label %cond.end16, label %cond.false15, !dbg !1071

cond.false15:                                     ; preds = %cond.end12
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.2, i64 0, i64 0), i32 35, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_walks_to_parent_successor, i64 0, i64 0)) #6, !dbg !1071
  unreachable, !dbg !1071

cond.end16:                                       ; preds = %cond.end12
  %12 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1072
  call void @treetable_destroy(%struct.treetable_s* %12), !dbg !1073
  ret void, !dbg !1074
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @symbolic_int(i8* %name, i32 %concrete_fallback) #0 !dbg !1075 {
entry:
  %name.addr = alloca i8*, align 8
  %concrete_fallback.addr = alloca i32, align 4
  %value = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %name.addr, metadata !1081, metadata !DIExpression()), !dbg !1082
  store i32 %concrete_fallback, i32* %concrete_fallback.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %concrete_fallback.addr, metadata !1083, metadata !DIExpression()), !dbg !1084
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1085, metadata !DIExpression()), !dbg !1086
  %0 = load i32, i32* %concrete_fallback.addr, align 4, !dbg !1087
  store i32 %0, i32* %value, align 4, !dbg !1086
  %1 = bitcast i32* %value to i8*, !dbg !1088
  %2 = load i8*, i8** %name.addr, align 8, !dbg !1089
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %2), !dbg !1090
  %3 = load i32, i32* %value, align 4, !dbg !1091
  ret i32 %3, !dbg !1092
}

; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1093 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1096, metadata !DIExpression()), !dbg !1097
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1098, metadata !DIExpression()), !dbg !1099
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1099
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1100
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1101
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1102
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1103
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1104
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1105
  %cmp = icmp eq i32 %call, 0, !dbg !1105
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1105

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.7, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1105
  unreachable, !dbg !1105

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1106
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1106
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1106

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.7, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1106
  unreachable, !dbg !1106

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1107
  ret %struct.treetable_s* %1, !dbg !1108
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1109 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_get_greater_than_walks_to_parent_successor(), !dbg !1112
  ret i32 0, !dbg !1113
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1114 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1115, metadata !DIExpression()), !dbg !1116
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1117, metadata !DIExpression()), !dbg !1118
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1119, metadata !DIExpression()), !dbg !1120
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1121
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1122
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1122
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1120
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1123
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1124
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1124
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1125
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1126
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1127
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1128
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1130
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1130
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1131
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1132
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1132
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1133
  br i1 %cmp, label %if.then, label %if.end, !dbg !1134

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1135
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1136
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1137
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1137
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1138
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1139
  br label %if.end, !dbg !1136

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1140
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1141
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1141
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1142
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1143
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1144
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1145
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1147
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1147
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1148
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1149
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1149
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1150
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1151

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1152
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1153
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1154
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1155
  br label %if.end20, !dbg !1153

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1156
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1158
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1159
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1159
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1160
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1160
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1161
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1162

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1163
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1164
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1165
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1165
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1166
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1167
  br label %if.end20, !dbg !1164

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1168
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1169
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1170
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1170
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1171
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1172
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1173
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1174
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1175
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1176
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1177
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1178
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1179
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1180
  ret void, !dbg !1181
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1182 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1183, metadata !DIExpression()), !dbg !1184
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1185, metadata !DIExpression()), !dbg !1186
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1187, metadata !DIExpression()), !dbg !1188
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1189
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1190
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1190
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1188
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1191
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1192
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1192
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1193
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1194
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1195
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1196
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1198
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1198
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1199
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1200
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1200
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1201
  br i1 %cmp, label %if.then, label %if.end, !dbg !1202

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1203
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1204
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1205
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1205
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1206
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1207
  br label %if.end, !dbg !1204

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1208
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1209
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1209
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1210
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1211
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1212
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1213
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1215
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1215
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1216
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1217
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1217
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1218
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1219

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1220
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1221
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1222
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1223
  br label %if.end20, !dbg !1221

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1224
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1226
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1227
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1227
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1228
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1228
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1229
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1230

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1231
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1232
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1233
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1233
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1234
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1235
  br label %if.end20, !dbg !1232

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1236
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1237
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1238
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1238
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1239
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1240
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1241
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1242
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1243
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1244
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1245
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1246
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1247
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1248
  ret void, !dbg !1249
}
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1250 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1251, metadata !DIExpression()), !dbg !1252
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1253, metadata !DIExpression()), !dbg !1254
  %0 = load i64, i64* %size.addr, align 8, !dbg !1255
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1256
  store i8* %call, i8** %ptr, align 8, !dbg !1254
  %1 = load i8*, i8** %ptr, align 8, !dbg !1257
  %cmp = icmp ne i8* %1, null, !dbg !1258
  %conv = zext i1 %cmp to i32, !dbg !1258
  %conv1 = sext i32 %conv to i64, !dbg !1257
  call void @klee_assume(i64 %conv1), !dbg !1259
  %2 = load i8*, i8** %ptr, align 8, !dbg !1260
  ret i8* %2, !dbg !1261
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1262 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1263, metadata !DIExpression()), !dbg !1264
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1265, metadata !DIExpression()), !dbg !1266
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1267, metadata !DIExpression()), !dbg !1268
  %0 = load i64, i64* %count.addr, align 8, !dbg !1269
  %1 = load i64, i64* %size.addr, align 8, !dbg !1270
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1271
  store i8* %call, i8** %ptr, align 8, !dbg !1268
  %2 = load i8*, i8** %ptr, align 8, !dbg !1272
  %cmp = icmp ne i8* %2, null, !dbg !1273
  %conv = zext i1 %cmp to i32, !dbg !1273
  %conv1 = sext i32 %conv to i64, !dbg !1272
  call void @klee_assume(i64 %conv1), !dbg !1274
  %3 = load i8*, i8** %ptr, align 8, !dbg !1275
  ret i8* %3, !dbg !1276
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1277 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1283, metadata !DIExpression()), !dbg !1284
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1285, metadata !DIExpression()), !dbg !1286
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1287, metadata !DIExpression()), !dbg !1288
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1289, metadata !DIExpression()), !dbg !1291
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1292
  store i8* %0, i8** %dest, align 8, !dbg !1291
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1293, metadata !DIExpression()), !dbg !1294
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1295
  store i8* %1, i8** %src, align 8, !dbg !1294
  br label %while.cond, !dbg !1296

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1297
  %dec = add i64 %2, -1, !dbg !1297
  store i64 %dec, i64* %len.addr, align 8, !dbg !1297
  %cmp = icmp ugt i64 %2, 0, !dbg !1298
  br i1 %cmp, label %while.body, label %while.end, !dbg !1296

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1299
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1299
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1299
  %4 = load i8, i8* %3, align 1, !dbg !1300
  %5 = load i8*, i8** %dest, align 8, !dbg !1301
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1301
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1301
  store i8 %4, i8* %5, align 1, !dbg !1302
  br label %while.cond, !dbg !1296, !llvm.loop !1303

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1304
  ret i8* %6, !dbg !1305
}
...
!1 = !DIFile(filename: "test_get_greater_than_walks_to_parent_successor.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_get_greater_than_walks_to_parent_successor", scope: !1, file: !1, line: 22, type: !1054, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "k1", scope: !1053, file: !1, line: 24, type: !18)
!1057 = !DILocation(line: 24, column: 9, scope: !1053)
!1058 = !DILocalVariable(name: "k2", scope: !1053, file: !1, line: 25, type: !18)
!1059 = !DILocation(line: 25, column: 9, scope: !1053)
!1060 = !DILocalVariable(name: "value", scope: !1053, file: !1, line: 26, type: !18)
!1061 = !DILocation(line: 26, column: 9, scope: !1053)
!1062 = !DILocation(line: 26, column: 17, scope: !1053)
!1063 = !DILocalVariable(name: "out", scope: !1053, file: !1, line: 27, type: !19)
!1064 = !DILocation(line: 27, column: 11, scope: !1053)
!1065 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 29, type: !107)
!1066 = !DILocation(line: 29, column: 16, scope: !1053)
!1067 = !DILocation(line: 29, column: 24, scope: !1053)
!1068 = !DILocation(line: 31, column: 5, scope: !1053)
!1069 = !DILocation(line: 32, column: 5, scope: !1053)
!1070 = !DILocation(line: 34, column: 5, scope: !1053)
!1071 = !DILocation(line: 35, column: 5, scope: !1053)
!1072 = !DILocation(line: 37, column: 23, scope: !1053)
!1073 = !DILocation(line: 37, column: 5, scope: !1053)
!1074 = !DILocation(line: 38, column: 1, scope: !1053)
!1075 = distinct !DISubprogram(name: "symbolic_int", scope: !1076, file: !1076, line: 32, type: !1077, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1076 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1077 = !DISubroutineType(types: !1078)
!1078 = !{!18, !1079, !18}
!1079 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1080, size: 64)
!1080 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1081 = !DILocalVariable(name: "name", arg: 1, scope: !1075, file: !1076, line: 32, type: !1079)
!1082 = !DILocation(line: 32, column: 37, scope: !1075)
!1083 = !DILocalVariable(name: "concrete_fallback", arg: 2, scope: !1075, file: !1076, line: 32, type: !18)
!1084 = !DILocation(line: 32, column: 47, scope: !1075)
!1085 = !DILocalVariable(name: "value", scope: !1075, file: !1076, line: 34, type: !18)
!1086 = !DILocation(line: 34, column: 9, scope: !1075)
!1087 = !DILocation(line: 34, column: 17, scope: !1075)
!1088 = !DILocation(line: 35, column: 24, scope: !1075)
!1089 = !DILocation(line: 35, column: 47, scope: !1075)
!1090 = !DILocation(line: 35, column: 5, scope: !1075)
!1091 = !DILocation(line: 36, column: 12, scope: !1075)
!1092 = !DILocation(line: 36, column: 5, scope: !1075)
!1093 = distinct !DISubprogram(name: "make_table", scope: !1076, file: !1076, line: 53, type: !1094, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1094 = !DISubroutineType(types: !1095)
!1095 = !{!107}
!1096 = !DILocalVariable(name: "conf", scope: !1093, file: !1076, line: 55, type: !67)
!1097 = !DILocation(line: 55, column: 19, scope: !1093)
!1098 = !DILocalVariable(name: "table", scope: !1093, file: !1076, line: 56, type: !107)
!1099 = !DILocation(line: 56, column: 16, scope: !1093)
!1100 = !DILocation(line: 57, column: 5, scope: !1093)
!1101 = !DILocation(line: 58, column: 10, scope: !1093)
!1102 = !DILocation(line: 58, column: 22, scope: !1093)
!1103 = !DILocation(line: 59, column: 10, scope: !1093)
!1104 = !DILocation(line: 59, column: 22, scope: !1093)
!1105 = !DILocation(line: 60, column: 5, scope: !1093)
!1106 = !DILocation(line: 61, column: 5, scope: !1093)
!1107 = !DILocation(line: 62, column: 12, scope: !1093)
!1108 = !DILocation(line: 62, column: 5, scope: !1093)
!1109 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line:
!1257 = !DILocation(line: 42, column: 17, scope: !1250)
!1258 = !DILocation(line: 42, column: 21, scope: !1250)
!1259 = !DILocation(line: 42, column: 5, scope: !1250)
!1260 = !DILocation(line: 43, column: 12, scope: !1250)
!1261 = !DILocation(line: 43, column: 5, scope: !1250)
!1262 = distinct !DISubprogram(name: "safe_calloc", scope: !1076, file: !1076, line: 46, type: !82, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1263 = !DILocalVariable(name: "count", arg: 1, scope: !1262, file: !1076, line: 46, type: !77)
!1264 = !DILocation(line: 46, column: 33, scope: !1262)
!1265 = !DILocalVariable(name: "size", arg: 2, scope: !1262, file: !1076, line: 46, type: !77)
!1266 = !DILocation(line: 46, column: 47, scope: !1262)
!1267 = !DILocalVariable(name: "ptr", scope: !1262, file: !1076, line: 48, type: !19)
!1268 = !DILocation(line: 48, column: 11, scope: !1262)
!1269 = !DILocation(line: 48, column: 24, scope: !1262)
!1270 = !DILocation(line: 48, column: 31, scope: !1262)
!1271 = !DILocation(line: 48, column: 17, scope: !1262)
!1272 = !DILocation(line: 49, column: 17, scope: !1262)
!1273 = !DILocation(line: 49, column: 21, scope: !1262)
!1274 = !DILocation(line: 49, column: 5, scope: !1262)
!1275 = !DILocation(line: 50, column: 12, scope: !1262)
!1276 = !DILocation(line: 50, column: 5, scope: !1262)
!1277 = distinct !DISubprogram(name: "memcpy", scope: !1278, file: !1278, line: 12, type: !1279, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1278 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1279 = !DISubroutineType(types: !1280)
!1280 = !{!19, !19, !33, !1281}
!1281 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1282, line: 46, baseType: !79)
!1282 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1283 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1277, file: !1278, line: 12, type: !19)
!1284 = !DILocation(line: 12, column: 20, scope: !1277)
!1285 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1277, file: !1278, line: 12, type: !33)
!1286 = !DILocation(line: 12, column: 42, scope: !1277)
!1287 = !DILocalVariable(name: "len", arg: 3, scope: !1277, file: !1278, line: 12, type: !1281)
!1288 = !DILocation(line: 12, column: 58, scope: !1277)
!1289 = !DILocalVariable(name: "dest", scope: !1277, file: !1278, line: 13, type: !1290)
!1290 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1291 = !DILocation(line: 13, column: 9, scope: !1277)
!1292 = !DILocation(line: 13, column: 16, scope: !1277)
!1293 = !DILocalVariable(name: "src", scope: !1277, file: !1278, line: 14, type: !1079)
!1294 = !DILocation(line: 14, column: 15, scope: !1277)
!1295 = !DILocation(line: 14, column: 21, scope: !1277)
!1296 = !DILocation(line: 16, column: 3, scope: !1277)
!1297 = !DILocation(line: 16, column: 13, scope: !1277)
!1298 = !DILocation(line: 16, column: 16, scope: !1277)
!1299 = !DILocation(line: 17, column: 19, scope: !1277)
!1300 = !DILocation(line: 17, column: 15, scope: !1277)
!1301 = !DILocation(line: 17, column: 10, scope: !1277)
!1302 = !DILocation(line: 17, column: 13, scope: !1277)
!1303 = distinct !{!1303, !1296, !1299, !332}
!1304 = !DILocation(line: 18, column: 10, scope: !1277)
!1305 = !DILocation(line: 18, column: 3, scope: !1277)
