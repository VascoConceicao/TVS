; ModuleID = 'test_add_three_symbolic_keys_preserves_validity.bc'
source_filename = "test_add_three_symbolic_keys_preserves_validity.c"
...
@.str = private unnamed_addr constant [9 x i8] c"three_k1\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"three_k2\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"three_k3\00", align 1
@.str.3 = private unnamed_addr constant [9 x i8] c"three_v1\00", align 1
@.str.4 = private unnamed_addr constant [9 x i8] c"three_v2\00", align 1
@.str.5 = private unnamed_addr constant [9 x i8] c"three_v3\00", align 1
@.str.6 = private unnamed_addr constant [40 x i8] c"treetable_add(table, &k1, &v1) == CC_OK\00", align 1
@.str.7 = private unnamed_addr constant [50 x i8] c"test_add_three_symbolic_keys_preserves_validity.c\00", align 1
@__PRETTY_FUNCTION__.test_add_three_symbolic_keys_preserves_validity = private unnamed_addr constant [59 x i8] c"void test_add_three_symbolic_keys_preserves_validity(void)\00", align 1
@.str.8 = private unnamed_addr constant [40 x i8] c"treetable_add(table, &k2, &v2) == CC_OK\00", align 1
@.str.9 = private unnamed_addr constant [40 x i8] c"treetable_add(table, &k3, &v3) == CC_OK\00", align 1
@.str.10 = private unnamed_addr constant [27 x i8] c"treetable_size(table) == 3\00", align 1
@.str.11 = private unnamed_addr constant [16 x i8] c"balanced(table)\00", align 1
@.str.12 = private unnamed_addr constant [14 x i8] c"sorted(table)\00", align 1
@.str.13 = private unnamed_addr constant [43 x i8] c"treetable_new_conf(&conf, &table) == CC_OK\00", align 1
@.str.14 = private unnamed_addr constant [17 x i8] c"./klee_helpers.h\00", align 1
@__PRETTY_FUNCTION__.make_table = private unnamed_addr constant [28 x i8] c"TreeTable *make_table(void)\00", align 1
@.str.15 = private unnamed_addr constant [14 x i8] c"table != NULL\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_add_three_symbolic_keys_preserves_validity() #0 !dbg !1053 {
entry:
  ...
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata i32* %k1, metadata !1056, metadata !DIExpression()), !dbg !1057
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32 30), !dbg !1058
  store i32 %call, i32* %k1, align 4, !dbg !1057
  call void @llvm.dbg.declare(metadata i32* %k2, metadata !1059, metadata !DIExpression()), !dbg !1060
  %call1 = call i32 @symbolic_int(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 10), !dbg !1061
  store i32 %call1, i32* %k2, align 4, !dbg !1060
  call void @llvm.dbg.declare(metadata i32* %k3, metadata !1062, metadata !DIExpression()), !dbg !1063
  %call2 = call i32 @symbolic_int(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i32 20), !dbg !1064
  store i32 %call2, i32* %k3, align 4, !dbg !1063
  call void @llvm.dbg.declare(metadata i32* %v1, metadata !1065, metadata !DIExpression()), !dbg !1066
  %call3 = call i32 @symbolic_int(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 1), !dbg !1067
  store i32 %call3, i32* %v1, align 4, !dbg !1066
  call void @llvm.dbg.declare(metadata i32* %v2, metadata !1068, metadata !DIExpression()), !dbg !1069
  %call4 = call i32 @symbolic_int(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.4, i64 0, i64 0), i32 2), !dbg !1070
  store i32 %call4, i32* %v2, align 4, !dbg !1069
  call void @llvm.dbg.declare(metadata i32* %v3, metadata !1071, metadata !DIExpression()), !dbg !1072
  %call5 = call i32 @symbolic_int(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.5, i64 0, i64 0), i32 3), !dbg !1073
  store i32 %call5, i32* %v3, align 4, !dbg !1072
  %0 = load i32, i32* %k1, align 4, !dbg !1074
  %1 = load i32, i32* %k2, align 4, !dbg !1075
  %cmp = icmp ne i32 %0, %1, !dbg !1076
  %conv = zext i1 %cmp to i32, !dbg !1076
  %conv6 = sext i32 %conv to i64, !dbg !1074
  call void @klee_assume(i64 %conv6), !dbg !1077
  %2 = load i32, i32* %k1, align 4, !dbg !1078
  %3 = load i32, i32* %k3, align 4, !dbg !1079
  %cmp7 = icmp ne i32 %2, %3, !dbg !1080
  %conv8 = zext i1 %cmp7 to i32, !dbg !1080
  %conv9 = sext i32 %conv8 to i64, !dbg !1078
  call void @klee_assume(i64 %conv9), !dbg !1081
  %4 = load i32, i32* %k2, align 4, !dbg !1082
  %5 = load i32, i32* %k3, align 4, !dbg !1083
  %cmp10 = icmp ne i32 %4, %5, !dbg !1084
  %conv11 = zext i1 %cmp10 to i32, !dbg !1084
  %conv12 = sext i32 %conv11 to i64, !dbg !1082
  call void @klee_assume(i64 %conv12), !dbg !1085
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1086, metadata !DIExpression()), !dbg !1087
  %call13 = call %struct.treetable_s* @make_table(), !dbg !1088
  store %struct.treetable_s* %call13, %struct.treetable_s** %table, align 8, !dbg !1087
  %6 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1089
  %7 = bitcast i32* %k1 to i8*, !dbg !1089
  %8 = bitcast i32* %v1 to i8*, !dbg !1089
  %call14 = call i32 @treetable_add(%struct.treetable_s* %6, i8* %7, i8* %8), !dbg !1089
  %cmp15 = icmp eq i32 %call14, 0, !dbg !1089
  br i1 %cmp15, label %cond.end, label %cond.false, !dbg !1089

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.7, i64 0, i64 0), i32 37, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_add_three_symbolic_keys_preserves_validity, i64 0, i64 0)) #6, !dbg !1089
  unreachable, !dbg !1089

cond.end:                                         ; preds = %entry
  %9 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1090
  %10 = bitcast i32* %k2 to i8*, !dbg !1090
  %11 = bitcast i32* %v2 to i8*, !dbg !1090
  %call17 = call i32 @treetable_add(%struct.treetable_s* %9, i8* %10, i8* %11), !dbg !1090
  %cmp18 = icmp eq i32 %call17, 0, !dbg !1090
  br i1 %cmp18, label %cond.end22, label %cond.false21, !dbg !1090

cond.false21:                                     ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.7, i64 0, i64 0), i32 38, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_add_three_symbolic_keys_preserves_validity, i64 0, i64 0)) #6, !dbg !1090
  unreachable, !dbg !1090

cond.end22:                                       ; preds = %cond.end
  %12 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1091
  %13 = bitcast i32* %k3 to i8*, !dbg !1091
  %14 = bitcast i32* %v3 to i8*, !dbg !1091
  %call23 = call i32 @treetable_add(%struct.treetable_s* %12, i8* %13, i8* %14), !dbg !1091
  %cmp24 = icmp eq i32 %call23, 0, !dbg !1091
  br i1 %cmp24, label %cond.end28, label %cond.false27, !dbg !1091

cond.false27:                                     ; preds = %cond.end22
  call void @__assert_fail(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.9, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.7, i64 0, i64 0), i32 39, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_add_three_symbolic_keys_preserves_validity, i64 0, i64 0)) #6, !dbg !1091
  unreachable, !dbg !1091

cond.end28:                                       ; preds = %cond.end22
  %15 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1092
  %call29 = call i64 @treetable_size(%struct.treetable_s* %15), !dbg !1092
  %cmp30 = icmp eq i64 %call29, 3, !dbg !1092
  br i1 %cmp30, label %cond.end34, label %cond.false33, !dbg !1092

cond.false33:                                     ; preds = %cond.end28
  call void @__assert_fail(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.7, i64 0, i64 0), i32 41, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_add_three_symbolic_keys_preserves_validity, i64 0, i64 0)) #6, !dbg !1092
  unreachable, !dbg !1092

cond.end34:                                       ; preds = %cond.end28
  %16 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1093
  %call35 = call i32 @balanced(%struct.treetable_s* %16), !dbg !1093
  %tobool = icmp ne i32 %call35, 0, !dbg !1093
  br i1 %tobool, label %cond.end38, label %cond.false37, !dbg !1093

cond.false37:                                     ; preds = %cond.end34
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.11, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.7, i64 0, i64 0), i32 42, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_add_three_symbolic_keys_preserves_validity, i64 0, i64 0)) #6, !dbg !1093
  unreachable, !dbg !1093

cond.end38:                                       ; preds = %cond.end34
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1094
  %call39 = call i32 @sorted(%struct.treetable_s* %17), !dbg !1094
  %tobool40 = icmp ne i32 %call39, 0, !dbg !1094
  br i1 %tobool40, label %cond.end43, label %cond.false42, !dbg !1094

cond.false42:                                     ; preds = %cond.end38
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.12, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.7, i64 0, i64 0), i32 43, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.test_add_three_symbolic_keys_preserves_validity, i64 0, i64 0)) #6, !dbg !1094
  unreachable, !dbg !1094

cond.end43:                                       ; preds = %cond.end38
  %18 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1095
  call void @treetable_destroy(%struct.treetable_s* %18), !dbg !1096
  ret void, !dbg !1097
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @symbolic_int(i8* %name, i32 %concrete_fallback) #0 !dbg !1098 {
entry:
  %name.addr = alloca i8*, align 8
  %concrete_fallback.addr = alloca i32, align 4
  %value = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %name.addr, metadata !1104, metadata !DIExpression()), !dbg !1105
  store i32 %concrete_fallback, i32* %concrete_fallback.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %concrete_fallback.addr, metadata !1106, metadata !DIExpression()), !dbg !1107
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1108, metadata !DIExpression()), !dbg !1109
  %0 = load i32, i32* %concrete_fallback.addr, align 4, !dbg !1110
  store i32 %0, i32* %value, align 4, !dbg !1109
  %1 = bitcast i32* %value to i8*, !dbg !1111
  %2 = load i8*, i8** %name.addr, align 8, !dbg !1112
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %2), !dbg !1113
  %3 = load i32, i32* %value, align 4, !dbg !1114
  ret i32 %3, !dbg !1115
}
...
; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1116 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1119, metadata !DIExpression()), !dbg !1120
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1121, metadata !DIExpression()), !dbg !1122
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1122
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1123
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1124
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1125
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1126
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1127
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1128
  %cmp = icmp eq i32 %call, 0, !dbg !1128
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1128

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.13, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.14, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1128
  unreachable, !dbg !1128

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1129
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1129
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1129

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.15, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.14, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1129
  unreachable, !dbg !1129

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1130
  ret %struct.treetable_s* %1, !dbg !1131
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1132 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_add_three_symbolic_keys_preserves_validity(), !dbg !1135
  ret i32 0, !dbg !1136
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1137 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1138, metadata !DIExpression()), !dbg !1139
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1140, metadata !DIExpression()), !dbg !1141
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1142, metadata !DIExpression()), !dbg !1143
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1144
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1145
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1145
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1143
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1146
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1147
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1147
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1148
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1149
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1150
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1151
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1153
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1153
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1154
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1155
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1155
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1156
  br i1 %cmp, label %if.then, label %if.end, !dbg !1157

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1158
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1159
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1160
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1160
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1161
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1162
  br label %if.end, !dbg !1159

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1163
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1164
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1164
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1165
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1166
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1167
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1168
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1170
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1170
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1171
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1172
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1172
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1173
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1174

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1175
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1176
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1177
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1178
  br label %if.end20, !dbg !1176

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1179
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1181
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1182
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1182
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1183
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1183
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1184
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1185

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1186
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1187
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1188
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1188
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1189
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1190
  br label %if.end20, !dbg !1187

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1191
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1192
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1193
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1193
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1194
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1195
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1196
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1197
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1198
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1199
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1200
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1201
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1202
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1203
  ret void, !dbg !1204
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1205 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1206, metadata !DIExpression()), !dbg !1207
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1208, metadata !DIExpression()), !dbg !1209
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1210, metadata !DIExpression()), !dbg !1211
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1212
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1213
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1213
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1211
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1214
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1215
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1215
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1216
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1217
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1218
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1219
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1221
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1221
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1222
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1223
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1223
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1224
  br i1 %cmp, label %if.then, label %if.end, !dbg !1225

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1226
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1227
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1228
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1228
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1229
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1230
  br label %if.end, !dbg !1227

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1231
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1232
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1232
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1233
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1234
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1235
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1236
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1238
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1238
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1239
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1240
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1240
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1241
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1242

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1243
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1244
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1245
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1246
  br label %if.end20, !dbg !1244

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1247
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1249
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1250
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1250
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1251
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1251
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1252
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1253

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1254
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1255
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1256
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1256
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1257
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1258
  br label %if.end20, !dbg !1255

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1259
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1260
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1261
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1261
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1262
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1263
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1264
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1265
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1266
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1267
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1268
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1269
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1270
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1271
  ret void, !dbg !1272
}
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1273 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1274, metadata !DIExpression()), !dbg !1275
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1276, metadata !DIExpression()), !dbg !1277
  %0 = load i64, i64* %size.addr, align 8, !dbg !1278
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1279
  store i8* %call, i8** %ptr, align 8, !dbg !1277
  %1 = load i8*, i8** %ptr, align 8, !dbg !1280
  %cmp = icmp ne i8* %1, null, !dbg !1281
  %conv = zext i1 %cmp to i32, !dbg !1281
  %conv1 = sext i32 %conv to i64, !dbg !1280
  call void @klee_assume(i64 %conv1), !dbg !1282
  %2 = load i8*, i8** %ptr, align 8, !dbg !1283
  ret i8* %2, !dbg !1284
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1285 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1286, metadata !DIExpression()), !dbg !1287
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1288, metadata !DIExpression()), !dbg !1289
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1290, metadata !DIExpression()), !dbg !1291
  %0 = load i64, i64* %count.addr, align 8, !dbg !1292
  %1 = load i64, i64* %size.addr, align 8, !dbg !1293
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1294
  store i8* %call, i8** %ptr, align 8, !dbg !1291
  %2 = load i8*, i8** %ptr, align 8, !dbg !1295
  %cmp = icmp ne i8* %2, null, !dbg !1296
  %conv = zext i1 %cmp to i32, !dbg !1296
  %conv1 = sext i32 %conv to i64, !dbg !1295
  call void @klee_assume(i64 %conv1), !dbg !1297
  %3 = load i8*, i8** %ptr, align 8, !dbg !1298
  ret i8* %3, !dbg !1299
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1300 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1306, metadata !DIExpression()), !dbg !1307
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1308, metadata !DIExpression()), !dbg !1309
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1310, metadata !DIExpression()), !dbg !1311
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1312, metadata !DIExpression()), !dbg !1314
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1315
  store i8* %0, i8** %dest, align 8, !dbg !1314
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1316, metadata !DIExpression()), !dbg !1317
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1318
  store i8* %1, i8** %src, align 8, !dbg !1317
  br label %while.cond, !dbg !1319

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1320
  %dec = add i64 %2, -1, !dbg !1320
  store i64 %dec, i64* %len.addr, align 8, !dbg !1320
  %cmp = icmp ugt i64 %2, 0, !dbg !1321
  br i1 %cmp, label %while.body, label %while.end, !dbg !1319

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1322
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1322
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1322
  %4 = load i8, i8* %3, align 1, !dbg !1323
  %5 = load i8*, i8** %dest, align 8, !dbg !1324
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1324
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1324
  store i8 %4, i8* %5, align 1, !dbg !1325
  br label %while.cond, !dbg !1319, !llvm.loop !1326

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1327
  ret i8* %6, !dbg !1328
}
...
!1 = !DIFile(filename: "test_add_three_symbolic_keys_preserves_validity.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_add_three_symbolic_keys_preserves_validity", scope: !1, file: !1, line: 22, type: !1054, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "k1", scope: !1053, file: !1, line: 24, type: !18)
!1057 = !DILocation(line: 24, column: 9, scope: !1053)
!1058 = !DILocation(line: 24, column: 14, scope: !1053)
!1059 = !DILocalVariable(name: "k2", scope: !1053, file: !1, line: 25, type: !18)
!1060 = !DILocation(line: 25, column: 9, scope: !1053)
!1061 = !DILocation(line: 25, column: 14, scope: !1053)
!1062 = !DILocalVariable(name: "k3", scope: !1053, file: !1, line: 26, type: !18)
!1063 = !DILocation(line: 26, column: 9, scope: !1053)
!1064 = !DILocation(line: 26, column: 14, scope: !1053)
!1065 = !DILocalVariable(name: "v1", scope: !1053, file: !1, line: 27, type: !18)
!1066 = !DILocation(line: 27, column: 9, scope: !1053)
!1067 = !DILocation(line: 27, column: 14, scope: !1053)
!1068 = !DILocalVariable(name: "v2", scope: !1053, file: !1, line: 28, type: !18)
!1069 = !DILocation(line: 28, column: 9, scope: !1053)
!1070 = !DILocation(line: 28, column: 14, scope: !1053)
!1071 = !DILocalVariable(name: "v3", scope: !1053, file: !1, line: 29, type: !18)
!1072 = !DILocation(line: 29, column: 9, scope: !1053)
!1073 = !DILocation(line: 29, column: 14, scope: !1053)
!1074 = !DILocation(line: 31, column: 17, scope: !1053)
!1075 = !DILocation(line: 31, column: 23, scope: !1053)
!1076 = !DILocation(line: 31, column: 20, scope: !1053)
!1077 = !DILocation(line: 31, column: 5, scope: !1053)
!1078 = !DILocation(line: 32, column: 17, scope: !1053)
!1079 = !DILocation(line: 32, column: 23, scope: !1053)
!1080 = !DILocation(line: 32, column: 20, scope: !1053)
!1081 = !DILocation(line: 32, column: 5, scope: !1053)
!1082 = !DILocation(line: 33, column: 17, scope: !1053)
!1083 = !DILocation(line: 33, column: 23, scope: !1053)
!1084 = !DILocation(line: 33, column: 20, scope: !1053)
!1085 = !DILocation(line: 33, column: 5, scope: !1053)
!1086 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 35, type: !107)
!1087 = !DILocation(line: 35, column: 16, scope: !1053)
!1088 = !DILocation(line: 35, column: 24, scope: !1053)
!1089 = !DILocation(line: 37, column: 5, scope: !1053)
!1090 = !DILocation(line: 38, column: 5, scope: !1053)
!1091 = !DILocation(line: 39, column: 5, scope: !1053)
!1092 = !DILocation(line: 41, column: 5, scope: !1053)
!1093 = !DILocation(line: 42, column: 5, scope: !1053)
!1094 = !DILocation(line: 43, column: 5, scope: !1053)
!1095 = !DILocation(line: 45, column: 23, scope: !1053)
!1096 = !DILocation(line: 45, column: 5, scope: !1053)
!1097 = !DILocation(line: 46, column: 1, scope: !1053)
!1098 = distinct !DISubprogram(name: "symbolic_int", scope: !1099, file: !1099, line: 32, type: !1100, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1099 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1100 = !DISubroutineType(types: !1101)
!1101 = !{!18, !1102, !18}
!1102 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1103, size: 64)
!1103 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1104 = !DILocalVariable(name: "name", arg: 1, scope: !1098, file: !1099, line: 32, type: !1102)
!1105 = !DILocation(line: 32, column: 37, scope: !1098)
!1106 = !DILocalVariable(name: "concrete_fallback", arg: 2, scope: !1098, file: !1099, line: 32, type: !18)
!1107 = !DILocation(line: 32, column: 47, scope: !1098)
!1108 = !DILocalVariable(name: "value", scope: !1098, file: !1099, line: 34, type: !18)
!1109 = !DILocation(line: 34, column: 9, scope: !1098)
!1110 = !DILocation(line: 34, column: 17, scope: !1098)
!1111 = !DILocation(line: 35, column: 24, scope: !1098)
!1112 = !DILocation(line: 35, column: 47, scope: !1098)
!1113 = !DILocation(line: 35, column: 5, scope: !1098)
!1114 = !DILocation(line: 36, column: 12, scope: !1098)
!1115 = !DILocation(line: 36, column: 5, scope: !1098)
!1116 = distinct !DISubprogram(name: "make_table", scope: !1099, file: !1099, line: 53, type: !1117, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1117 = !DISubroutineType(types: !1118)
!1118 = !{!107}
!1119 = !DILocalVariable(name: "conf", scope: !1116, file: !1099, line: 55, type: !67)
!1120 = !DILocation(line: 55, column: 19, scope: !1116)
!1121 = !DILocalVariable(name: "table", scope: !1116, file: !1099, line: 56, type: !107)
!1122 = !DILocation(line: 56, column: 16, scope: !1116)
!1123 = !DILocation(line: 57, column: 5, scope: !1116)
!1124 = !DILocation(line: 58, column: 10, scope: !1116)
!1125 = !DILocation(line: 58, column: 22, scope: !1116)
!1126 = !DILocation(line: 59, column: 10, scope: !1116)
!1127 = !DILocation(line: 59, column: 22, scope: !1116)
!1128 = !DILocation(line: 60, column: 5, scope: !1116)
!1129 = !DILocation(line: 61, column: 5, scope: !1116)
!1130 = !DILocation(line: 62, column: 12, scope: !1116)
!1131 = !DILocation(line: 62, column: 5, scope: !1116)
!1132 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 48, type: !1133, scopeLine: 49, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1133 = !DISubroutineType(types: !1134)
!1134 = !{!18}
!1135 = !DILocation(line: 50, column: 5, scope: !1132)
!1136 = !DILocation(line: 51, column: 5, scope: !1132)
!1137 = distinct !DISubprogram(name: "rotate_left", scope: !30, file: !30, line: 547, type: !225, scopeLine: 548, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1138 = !DILocalVariable(name: "table", arg: 1, scope: !1137, file: !30, line: 547, type: !107)
!1139 = !DILocation(line: 547, column: 36, scope: !1137)
!1140 = !DILocalVariable(name: "x", arg: 2, scope: !1137, file: !30, line: 547, type: !112)
!1141 = !DILocation(line: 547, column: 51, scope: !1137)
!1142 = !DILocalVariable(name: "y", scope: !1137, file: !30, line: 549, type: !112)
!1143 = !DILocation(line: 549, column: 13, scope: !1137)
!1144 = !DILocation(line: 549, column: 17, scope: !1137)
!1145 = !DILocation(line: 549, column: 20, scope: !1137)
!1146 = !DILocation(line: 551, column: 16, scope: !1137)
!1147 = !DILocation(line: 551, column: 19, scope: !1137)
!1148 = !DILocation(line: 551, column: 5, scope: !1137)
!1149 = !DILocation(line: 551, column: 8, scope: !1137)
!1150 = !DILocation(line: 551, column: 14, scope: !1137)
!1151 = !DILocation(line: 553, column: 9, scope: !1152)
!1152 = distinct !DILexicalBlock(scope: !1137, file: !30, line: 553, column: 9)
!1153 = !DILocation(line: 553, column: 12, scope: !1152)
!1154 = !DILocation(line: 553, column: 20, scope: !1152)
!1155 = !DILocation(line: 553, column: 27, scope: !1152)
!1156 = !DILocation(line: 553, column: 17, scope: !1152)
!1157 = !DILocation(line: 553, column: 9, scope: !1137)
!1158 = !DILocation(line: 554, column: 27, scope: !1152)
!1159 = !DILocation(line: 554, column: 9, scope: !1152)
!1160 = !DILocation(line: 554, column: 12, scope: !1152)
!1161 = !DILocation(line: 554, column: 18, scope: !1152)
!1162 = !DILocation(line: 554, column: 25, scope: !1152)
!1163 = !DILocation(line: 556, column: 17, scope: !1137)
!1164 = !DILocation(line: 556, column: 20, scope: !1137)
!1165 = !DILocation(line: 556, column: 5, scope: !1137)
!1166 = !DILocation(line: 556, column: 8, scope: !1137)
!1167 = !DILocation(line: 556, column: 15, scope: !1137)
!1168 = !DILocation(line: 558, column: 9, scope: !1169)
!1169 = distinct !DILexicalBlock(scope: !1137, file: !30, line: 558, column: 9)
!1170 = !DILocation(line: 558, column: 12, scope: !1169)
!1171 = !DILocation(line: 558, column: 22, scope: !1169)
!1172 = !DILocation(line: 558, column: 29, scope: !1169)
!1173 = !DILocation(line: 558, column: 19, scope: !1169)
!1174 = !DILocation(line: 558, column: 9, scope: !1137)
!1175 = !DILocation(line: 559, column: 23, scope: !1169)
!1176 = !DILocation(line: 559, column: 9, scope: !1169)
!1177 = !DILocation(line: 559, column: 16, scope: !1169)
!1178 = !DILocation(line: 559, column: 21, scope: !1169)
!1179 = !DILocation(line: 560, column: 14, scope: !1180)
!1180 = distinct !DILexicalBlock(scope: !1169, file: !30, line: 560, column: 14)
!1181 = !DILocation(line: 560, column: 19, scope: !1180)
!1182 = !DILocation(line: 560, column: 22, scope: !1180)
!1183 = !DILocation(line: 560, column: 30, scope: !1180)
!1184 = !DILocation(line: 560, column: 16, scope: !1180)
!1185 = !DILocation(line: 560, column: 14, scope: !1169)
!1186 = !DILocation(line: 561, column: 27, scope: !1180)
!1187 = !DILocation(line: 561, column: 9, scope: !1180)
!1188 = !DILocation(line: 561, column: 12, scope: !1180)
!1189 = !DILocation(line: 561, column: 20, scope: !1180)
!1190 = !DILocation(line: 561, column: 25, scope: !1180)
!1191 = !DILocation(line: 563, column: 28, scope: !1180)
!1192 = !DILocation(line: 563, column: 9, scope: !1180)
!1193 = !DILocation(line: 563, column: 12, scope: !1180)
!1194 = !DILocation(line: 563, column: 20, scope: !1180)
!1195 = !DILocation(line: 563, column: 26, scope: !1180)
!1196 = !DILocation(line: 565, column: 17, scope: !1137)
!1197 = !DILocation(line: 565, column: 5, scope: !1137)
!1198 = !DILocation(line: 565, column: 8, scope: !1137)
!1199 = !DILocation(line: 565, column: 15, scope: !1137)
!1200 = !DILocation(line: 566, column: 17, scope: !1137)
!1201 = !DILocation(line: 566, column: 5, scope: !1137)
!1202 = !DILocation(line: 566, column: 8, scope: !1137)
!1203 = !DILocation(line: 566, column: 15, scope: !1137)
!1204 = !DILocation(line: 567, column: 1, scope: !1137)
!1205 = distinct !DISubprogram(name: "rotate_right", scope: !30, file: !30, line: 518, type: !225, scopeLine: 519, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1206 = !DILocalVariable(name: "table", arg: 1, scope: !1205, file: !30, line: 518, type: !107)
!1207 = !DILocation(line: 518, column: 37, scope: !1205)
!1208 = !DILocalVariable(name: "x", arg: 2, scope: !1205, file: !30, line: 518, type: !112)
!1209 = !DILocation(line: 518, column: 52, scope: !1205)
!1210 = !DILocalVariable(name: "y", scope: !1205, file: !30, line: 520, type: !112)
!1211 = !DILocation(line: 520, column: 13, scope: !1205)
!1212 = !DILocation(line: 520, column: 17, scope: !1205)
!1213 = !DILocation(line: 520, column: 20, scope: !1205)
!1214 = !DILocation(line: 522, column: 15, scope: !1205)
!1215 = !DILocation(line: 522, column: 18, scope: !1205)
!1216 = !DILocation(line: 522, column: 5, scope: !1205)
!1217 = !DILocation(line: 522, column: 8, scope: !1205)
!1218 = !DILocation(line: 522, column: 13, scope: !1205)
!1219 = !DILocation(line: 524, column: 9, scope: !1220)
!1220 = distinct !DILexicalBlock(scope: !1205, file: !30, line: 524, column: 9)
!1221 = !DILocation(line: 524, column: 12, scope: !1220)
!1222 = !DILocation(line: 524, column: 21, scope: !1220)
!1223 = !DILocation(line: 524, column: 28, scope: !1220)
!1224 = !DILocation(line: 524, column: 18, scope: !1220)
!1225 = !DILocation(line: 524, column: 9, scope: !1205)
!1226 = !DILocation(line: 525, column: 28, scope: !1220)
!1227 = !DILocation(line: 525, column: 9, scope: !1220)
!1228 = !DILocation(line: 525, column: 12, scope: !1220)
!1229 = !DILocation(line: 525, column: 19, scope: !1220)
!1230 = !DILocation(line: 525, column: 26, scope: !1220)
!1231 = !DILocation(line: 527, column: 17, scope: !1205)
!1232 = !DILocation(line: 527, column: 20, scope: !1205)
!1233 = !DILocation(line: 527, column: 5, scope: !1205)
!1234 = !DILocation(line: 527, column: 8, scope: !1205)
!1235 = !DILocation(line: 527, column: 15, scope: !1205)
!1236 = !DILocation(line: 529, column: 9, scope: !1237)
!1237 = distinct !DILexicalBlock(scope: !1205, file: !30, line: 529, column: 9)
!1238 = !DILocation(line: 529, column: 12, scope: !1237)
!1239 = !DILocation(line: 529, column: 22, scope: !1237)
!1240 = !DILocation(line: 529, column: 29, scope: !1237)
!1241 = !DILocation(line: 529, column: 19, scope: !1237)
!1242 = !DILocation(line: 529, column: 9, scope: !1205)
!1243 = !DILocation(line: 530, column: 23, scope: !1237)
!1244 = !DILocation(line: 530, column: 9, scope: !1237)
!1245 = !DILocation(line: 530, column: 16, scope: !1237)
!1246 = !DILocation(line: 530, column: 21, scope: !1237)
!1247 = !DILocation(line: 531, column: 14, scope: !1248)
!1248 = distinct !DILexicalBlock(scope: !1237, file: !30, line: 531, column: 14)
!1249 = !DILocation(line: 531, column: 19, scope: !1248)
!1250 = !DILocation(line: 531, column: 22, scope: !1248)
!1251 = !DILocation(line: 531, column: 30, scope: !1248)
!1252 = !DILocation(line: 531, column: 16, scope: !1248)
!1253 = !DILocation(line: 531, column: 14, scope: !1237)
!1254 = !DILocation(line: 532, column: 28, scope: !1248)
!1255 = !DILocation(line: 532, column: 9, scope: !1248)
!1256 = !DILocation(line: 532, column: 12, scope: !1248)
!1257 = !DILocation(line: 532, column: 20, scope: !1248)
!1258 = !DILocation(line: 532, column: 26, scope: !1248)
!1259 = !DILocation(line: 534, column: 27, scope: !1248)
!1260 = !DILocation(line: 534, column: 9, scope: !1248)
!1261 = !DILocation(line: 534, column: 12, scope: !1248)
!1262 = !DILocation(line: 534, column: 20, scope: !1248)
!1263 = !DILocation(line: 534, column: 25, scope: !1248)
!1264 = !DILocation(line: 536, column: 17, scope: !1205)
!1265 = !DILocation(line: 536, column: 5, scope: !1205)
!1266 = !DILocation(line: 536, column: 8, scope: !1205)
!1267 = !DILocation(line: 536, column: 15, scope: !1205)
!1268 = !DILocation(line: 537, column: 17, scope: !1205)
!1269 = !DILocation(line: 537, column: 5, scope: !1205)
!1270 = !DILocation(line: 537, column: 8, scope: !1205)
!1271 = !DILocation(line: 537, column: 15, scope: !1205)
!1272 = !DILocation(line: 538, column: 1, scope: !1205)
!1273 = distinct !DISubprogram(name: "safe_malloc", scope: !1099, file: !1099, line: 39, type: !75, scopeLine: 40, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1274 = !DILocalVariable(name: "size", arg: 1, scope: !1273, file: !1099, line: 39, type: !77)
!1275 = !DILocation(line: 39, column: 33, scope: !1273)
!1276 = !DILocalVariable(name: "ptr", scope: !1273, file: !1099, line: 41, type: !19)
!1277 = !DILocation(line: 41, column: 11, scope: !1273)
!1278 = !DILocation(line: 41, column: 24, scope: !1273)
!1279 = !DILocation(line: 41, column: 17, scope: !1273)
!1280 = !DILocation(line: 42, column: 17, scope: !1273)
!1281 = !DILocation(line: 42, column: 21, scope: !1273)
!1282 = !DILocation(line: 42, column: 5, scope: !1273)
!1283 = !DILocation(line: 43, column: 12, scope: !1273)
!1284 = !DILocation(line: 43, column: 5, scope: !1273)
!1285 = distinct !DISubprogram(name: "safe_calloc", scope: !1099, file: !1099, line: 46, type: !82, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1286 = !DILocalVariable(name: "count", arg: 1, scope: !1285, file: !1099, line: 46, type: !77)
!1287 = !DILocation(line: 46, column: 33, scope: !1285)
!1288 = !DILocalVariable(name: "size", arg: 2, scope: !1285, file: !1099, line: 46, type: !77)
!1289 = !DILocation(line: 46, column: 47, scope: !1285)
!1290 = !DILocalVariable(name: "ptr", scope: !1285, file: !1099, line: 48, type: !19)
!1291 = !DILocation(line: 48, column: 11, scope: !1285)
!1292 = !DILocation(line: 48, column: 24, scope: !1285)
!1293 = !DILocation(line: 48, column: 31, scope: !1285)
!1294 = !DILocation(line: 48, column: 17, scope: !1285)
!1295 = !DILocation(line: 49, column: 17, scope: !1285)
!1296 = !DILocation(line: 49, column: 21, scope: !1285)
!1297 = !DILocation(line: 49, column: 5, scope: !1285)
!1298 = !DILocation(line: 50, column: 12, scope: !1285)
!1299 = !DILocation(line: 50, column: 5, scope: !1285)
!1300 = distinct !DISubprogram(name: "memcpy", scope: !1301, file: !1301, line: 12, type: !1302, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1301 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1302 = !DISubroutineType(types: !1303)
!1303 = !{!19, !19, !33, !1304}
!1304 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1305, line: 46, baseType: !79)
!1305 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1306 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1300, file: !1301, line: 12, type: !19)
!1307 = !DILocation(line: 12, column: 20, scope: !1300)
!1308 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1300, file: !1301, line: 12, type: !33)
!1309 = !DILocation(line: 12, column: 42, scope: !1300)
!1310 = !DILocalVariable(name: "len", arg: 3, scope: !1300, file: !1301, line: 12, type: !1304)
!1311 = !DILocation(line: 12, column: 58, scope: !1300)
!1312 = !DILocalVariable(name: "dest", scope: !1300, file: !1301, line: 13, type: !1313)
!1313 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1314 = !DILocation(line: 13, column: 9, scope: !1300)
!1315 = !DILocation(line: 13, column: 16, scope: !1300)
!1316 = !DILocalVariable(name: "src", scope: !1300, file: !1301, line: 14, type: !1102)
!1317 = !DILocation(line: 14, column: 15, scope: !1300)
!1318 = !DILocation(line: 14, column: 21, scope: !1300)
!1319 = !DILocation(line: 16, column: 3, scope: !1300)
!1320 = !DILocation(line: 16, column: 13, scope: !1300)
!1321 = !DILocation(line: 16, column: 16, scope: !1300)
!1322 = !DILocation(line: 17, column: 19, scope: !1300)
!1323 = !DILocation(line: 17, column: 15, scope: !1300)
!1324 = !DILocation(line: 17, column: 10, scope: !1300)
!1325 = !DILocation(line: 17, column: 13, scope: !1300)
!1326 = distinct !{!1326, !1319, !1322, !332}
!1327 = !DILocation(line: 18, column: 10, scope: !1300)
!1328 = !DILocation(line: 18, column: 3, scope: !1300)
