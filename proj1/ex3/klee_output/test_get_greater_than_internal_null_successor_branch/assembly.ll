; ModuleID = 'test_get_greater_than_internal_null_successor_branch.bc'
source_filename = "test_get_greater_than_internal_null_successor_branch.c"
...
@.str = private unnamed_addr constant [27 x i8] c"greater_null_successor_key\00", align 1
@.str.1 = private unnamed_addr constant [29 x i8] c"greater_null_successor_value\00", align 1
@.str.2 = private unnamed_addr constant [71 x i8] c"treetable_get_greater_than(&table, &key, &out) == CC_ERR_KEY_NOT_FOUND\00", align 1
@.str.3 = private unnamed_addr constant [55 x i8] c"test_get_greater_than_internal_null_successor_branch.c\00", align 1
@__PRETTY_FUNCTION__.test_get_greater_than_internal_null_successor_branch = private unnamed_addr constant [64 x i8] c"void test_get_greater_than_internal_null_successor_branch(void)\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_get_greater_than_internal_null_successor_branch() #0 !dbg !1053 {
entry:
  %table = alloca %struct.treetable_s, align 8
  %node = alloca %struct.rbnode_s, align 8
  ...
  call void @llvm.dbg.declare(metadata %struct.rbnode_s* %node, metadata !1058, metadata !DIExpression()), !dbg !1059
  call void @llvm.dbg.declare(metadata i32* %key, metadata !1060, metadata !DIExpression()), !dbg !1061
  %call = call i32 @symbolic_int(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0), i32 50), !dbg !1062
  store i32 %call, i32* %key, align 4, !dbg !1061
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1063, metadata !DIExpression()), !dbg !1064
  %call1 = call i32 @symbolic_int(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i64 0, i64 0), i32 500), !dbg !1065
  store i32 %call1, i32* %value, align 4, !dbg !1064
  call void @llvm.dbg.declare(metadata i8** %out, metadata !1066, metadata !DIExpression()), !dbg !1067
  store i8* null, i8** %out, align 8, !dbg !1067
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %table, i32 0, i32 0, !dbg !1068
  store %struct.rbnode_s* %node, %struct.rbnode_s** %root, align 8, !dbg !1069
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %table, i32 0, i32 1, !dbg !1070
  store %struct.rbnode_s* null, %struct.rbnode_s** %sentinel, align 8, !dbg !1071
  %size = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %table, i32 0, i32 2, !dbg !1072
  store i64 1, i64* %size, align 8, !dbg !1073
  %cmp = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %table, i32 0, i32 3, !dbg !1074
  store i32 (i8*, i8*)* @cmp, i32 (i8*, i8*)** %cmp, align 8, !dbg !1075
  %mem_alloc = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %table, i32 0, i32 4, !dbg !1076
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1077
  %mem_calloc = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %table, i32 0, i32 5, !dbg !1078
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1079
  %mem_free = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %table, i32 0, i32 6, !dbg !1080
  store void (i8*)* @free, void (i8*)** %mem_free, align 8, !dbg !1081
  %0 = bitcast i32* %key to i8*, !dbg !1082
  %key2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %node, i32 0, i32 0, !dbg !1083
  store i8* %0, i8** %key2, align 8, !dbg !1084
  %1 = bitcast i32* %value to i8*, !dbg !1085
  %value3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %node, i32 0, i32 1, !dbg !1086
  store i8* %1, i8** %value3, align 8, !dbg !1087
  %color = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %node, i32 0, i32 2, !dbg !1088
  store i8 1, i8* %color, align 8, !dbg !1089
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %node, i32 0, i32 3, !dbg !1090
  store %struct.rbnode_s* null, %struct.rbnode_s** %parent, align 8, !dbg !1091
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %node, i32 0, i32 4, !dbg !1092
  store %struct.rbnode_s* null, %struct.rbnode_s** %left, align 8, !dbg !1093
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %node, i32 0, i32 5, !dbg !1094
  store %struct.rbnode_s* null, %struct.rbnode_s** %right, align 8, !dbg !1095
  %2 = bitcast i32* %key to i8*, !dbg !1096
  %call4 = call i32 @treetable_get_greater_than(%struct.treetable_s* %table, i8* %2, i8** %out), !dbg !1096
  %cmp5 = icmp eq i32 %call4, 6, !dbg !1096
  br i1 %cmp5, label %cond.end, label %cond.false, !dbg !1096

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.3, i64 0, i64 0), i32 51, i8* getelementptr inbounds ([64 x i8], [64 x i8]* @__PRETTY_FUNCTION__.test_get_greater_than_internal_null_successor_branch, i64 0, i64 0)) #6, !dbg !1096
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1116 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1117, metadata !DIExpression()), !dbg !1118
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1119, metadata !DIExpression()), !dbg !1120
  %0 = load i64, i64* %size.addr, align 8, !dbg !1121
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1122
  store i8* %call, i8** %ptr, align 8, !dbg !1120
  %1 = load i8*, i8** %ptr, align 8, !dbg !1123
  %cmp = icmp ne i8* %1, null, !dbg !1124
  %conv = zext i1 %cmp to i32, !dbg !1124
  %conv1 = sext i32 %conv to i64, !dbg !1123
  call void @klee_assume(i64 %conv1), !dbg !1125
  %2 = load i8*, i8** %ptr, align 8, !dbg !1126
  ret i8* %2, !dbg !1127
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1128 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1129, metadata !DIExpression()), !dbg !1130
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1131, metadata !DIExpression()), !dbg !1132
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1133, metadata !DIExpression()), !dbg !1134
  %0 = load i64, i64* %count.addr, align 8, !dbg !1135
  %1 = load i64, i64* %size.addr, align 8, !dbg !1136
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1137
  store i8* %call, i8** %ptr, align 8, !dbg !1134
  %2 = load i8*, i8** %ptr, align 8, !dbg !1138
  %cmp = icmp ne i8* %2, null, !dbg !1139
  %conv = zext i1 %cmp to i32, !dbg !1139
  %conv1 = sext i32 %conv to i64, !dbg !1138
  call void @klee_assume(i64 %conv1), !dbg !1140
  %3 = load i8*, i8** %ptr, align 8, !dbg !1141
  ret i8* %3, !dbg !1142
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1143 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_get_greater_than_internal_null_successor_branch(), !dbg !1146
  ret i32 0, !dbg !1147
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1148 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1149, metadata !DIExpression()), !dbg !1150
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1151, metadata !DIExpression()), !dbg !1152
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1153, metadata !DIExpression()), !dbg !1154
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1155
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1156
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1156
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1154
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1157
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1158
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1158
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1159
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1160
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1161
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1162
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1164
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1164
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1165
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1166
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1166
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1167
  br i1 %cmp, label %if.then, label %if.end, !dbg !1168

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1169
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1170
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1171
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1171
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1172
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1173
  br label %if.end, !dbg !1170

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1174
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1175
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1175
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1176
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1177
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1178
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1179
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1181
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1181
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1182
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1183
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1183
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1184
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1185

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1186
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1187
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1188
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1189
  br label %if.end20, !dbg !1187

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1190
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1192
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1193
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1193
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1194
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1194
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1195
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1196

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1197
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1198
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1199
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1199
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1200
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1201
  br label %if.end20, !dbg !1198

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1202
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1203
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1204
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1204
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1205
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1206
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1207
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1208
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1209
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1210
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1211
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1212
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1213
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1214
  ret void, !dbg !1215
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1216 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1217, metadata !DIExpression()), !dbg !1218
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1219, metadata !DIExpression()), !dbg !1220
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1221, metadata !DIExpression()), !dbg !1222
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1223
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1224
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1224
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1222
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1225
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1226
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1226
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1227
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1228
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1229
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1230
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1232
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1232
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1233
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1234
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1234
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1235
  br i1 %cmp, label %if.then, label %if.end, !dbg !1236

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1237
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1238
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1239
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1239
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1240
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1241
  br label %if.end, !dbg !1238

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1242
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1243
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1243
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1244
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1245
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1246
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1247
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1249
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1249
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1250
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1251
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1251
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1252
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1253

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1254
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1255
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1256
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1257
  br label %if.end20, !dbg !1255

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1258
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1260
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1261
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1261
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1262
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1262
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1263
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1264

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1265
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1266
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1267
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1267
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1268
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1269
  br label %if.end20, !dbg !1266

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1270
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1271
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1272
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1272
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1273
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1274
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1275
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1276
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1277
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1278
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1279
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1280
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1281
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1282
  ret void, !dbg !1283
}
...
!1 = !DIFile(filename: "test_get_greater_than_internal_null_successor_branch.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_get_greater_than_internal_null_successor_branch", scope: !1, file: !1, line: 26, type: !1054, scopeLine: 27, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 28, type: !108)
!1057 = !DILocation(line: 28, column: 15, scope: !1053)
!1058 = !DILocalVariable(name: "node", scope: !1053, file: !1, line: 29, type: !113)
!1059 = !DILocation(line: 29, column: 15, scope: !1053)
!1060 = !DILocalVariable(name: "key", scope: !1053, file: !1, line: 30, type: !18)
!1061 = !DILocation(line: 30, column: 9, scope: !1053)
!1062 = !DILocation(line: 30, column: 17, scope: !1053)
!1063 = !DILocalVariable(name: "value", scope: !1053, file: !1, line: 31, type: !18)
!1064 = !DILocation(line: 31, column: 9, scope: !1053)
!1065 = !DILocation(line: 31, column: 17, scope: !1053)
!1066 = !DILocalVariable(name: "out", scope: !1053, file: !1, line: 32, type: !19)
!1067 = !DILocation(line: 32, column: 11, scope: !1053)
!1068 = !DILocation(line: 35, column: 11, scope: !1053)
!1069 = !DILocation(line: 35, column: 22, scope: !1053)
!1070 = !DILocation(line: 36, column: 11, scope: !1053)
!1071 = !DILocation(line: 36, column: 22, scope: !1053)
!1072 = !DILocation(line: 37, column: 11, scope: !1053)
!1073 = !DILocation(line: 37, column: 22, scope: !1053)
!1074 = !DILocation(line: 38, column: 11, scope: !1053)
!1075 = !DILocation(line: 38, column: 22, scope: !1053)
!1076 = !DILocation(line: 39, column: 11, scope: !1053)
!1077 = !DILocation(line: 39, column: 22, scope: !1053)
!1078 = !DILocation(line: 40, column: 11, scope: !1053)
!1079 = !DILocation(line: 40, column: 22, scope: !1053)
!1080 = !DILocation(line: 41, column: 11, scope: !1053)
!1081 = !DILocation(line: 41, column: 22, scope: !1053)
!1082 = !DILocation(line: 43, column: 19, scope: !1053)
!1083 = !DILocation(line: 43, column: 10, scope: !1053)
!1084 = !DILocation(line: 43, column: 17, scope: !1053)
!1085 = !DILocation(line: 44, column: 19, scope: !1053)
!1086 = !DILocation(line: 44, column: 10, scope: !1053)
!1087 = !DILocation(line: 44, column: 17, scope: !1053)
!1088 = !DILocation(line: 45, column: 10, scope: !1053)
!1089 = !DILocation(line: 45, column: 17, scope: !1053)
!1090 = !DILocation(line: 46, column: 10, scope: !1053)
!1091 = !DILocation(line: 46, column: 17, scope: !1053)
!1092 = !DILocation(line: 47, column: 10, scope: !1053)
!1093 = !DILocation(line: 47, column: 17, scope: !1053)
!1094 = !DILocation(line: 48, column: 10, scope: !1053)
!1095 = !DILocation(line: 48, column: 17, scope: !1053)
!1096 = !DILocation(line: 50, column: 5, scope: !1053)
!1097 = !DILocation(line: 52, column: 1, scope: !1053)
...
!1116 = distinct !DISubprogram(name: "safe_malloc", scope: !1099, file: !1099, line: 39, type: !75, scopeLine: 40, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1117 = !DILocalVariable(name: "size", arg: 1, scope: !1116, file: !1099, line: 39, type: !77)
!1118 = !DILocation(line: 39, column: 33, scope: !1116)
!1119 = !DILocalVariable(name: "ptr", scope: !1116, file: !1099, line: 41, type: !19)
!1120 = !DILocation(line: 41, column: 11, scope: !1116)
!1121 = !DILocation(line: 41, column: 24, scope: !1116)
!1122 = !DILocation(line: 41, column: 17, scope: !1116)
!1123 = !DILocation(line: 42, column: 17, scope: !1116)
!1124 = !DILocation(line: 42, column: 21, scope: !1116)
!1125 = !DILocation(line: 42, column: 5, scope: !1116)
!1126 = !DILocation(line: 43, column: 12, scope: !1116)
!1127 = !DILocation(line: 43, column: 5, scope: !1116)
!1128 = distinct !DISubprogram(name: "safe_calloc", scope: !1099, file: !1099, line: 46, type: !82, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!