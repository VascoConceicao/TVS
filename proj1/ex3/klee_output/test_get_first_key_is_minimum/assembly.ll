; ModuleID = 'test_get_first_key_is_minimum.bc'
source_filename = "test_get_first_key_is_minimum.c"
...
@.str = private unnamed_addr constant [9 x i8] c"first_k1\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"first_k2\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"first_k3\00", align 1
@.str.3 = private unnamed_addr constant [12 x i8] c"first_value\00", align 1
@.str.4 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k1, &value) == CC_OK\00", align 1
@.str.5 = private unnamed_addr constant [32 x i8] c"test_get_first_key_is_minimum.c\00", align 1
@__PRETTY_FUNCTION__.test_get_first_key_is_minimum = private unnamed_addr constant [41 x i8] c"void test_get_first_key_is_minimum(void)\00", align 1
@.str.6 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k2, &value) == CC_OK\00", align 1
@.str.7 = private unnamed_addr constant [43 x i8] c"treetable_add(table, &k3, &value) == CC_OK\00", align 1
@.str.8 = private unnamed_addr constant [46 x i8] c"treetable_get_first_key(table, &out) == CC_OK\00", align 1
@.str.9 = private unnamed_addr constant [18 x i8] c"*(int *)out <= k1\00", align 1
@.str.10 = private unnamed_addr constant [18 x i8] c"*(int *)out <= k2\00", align 1
@.str.11 = private unnamed_addr constant [18 x i8] c"*(int *)out <= k3\00", align 1
@.str.12 = private unnamed_addr constant [43 x i8] c"treetable_new_conf(&conf, &table) == CC_OK\00", align 1
@.str.13 = private unnamed_addr constant [17 x i8] c"./klee_helpers.h\00", align 1
@__PRETTY_FUNCTION__.make_table = private unnamed_addr constant [28 x i8] c"TreeTable *make_table(void)\00", align 1
@.str.14 = private unnamed_addr constant [14 x i8] c"table != NULL\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @test_get_first_key_is_minimum() #0 !dbg !1053 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1065, metadata !DIExpression()), !dbg !1066
  %call3 = call i32 @symbolic_int(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i64 0, i64 0), i32 3), !dbg !1067
  store i32 %call3, i32* %value, align 4, !dbg !1066
  call void @llvm.dbg.declare(metadata i8** %out, metadata !1068, metadata !DIExpression()), !dbg !1069
  store i8* null, i8** %out, align 8, !dbg !1069
  %0 = load i32, i32* %k1, align 4, !dbg !1070
  %1 = load i32, i32* %k2, align 4, !dbg !1071
  %cmp = icmp ne i32 %0, %1, !dbg !1072
  %conv = zext i1 %cmp to i32, !dbg !1072
  %conv4 = sext i32 %conv to i64, !dbg !1070
  call void @klee_assume(i64 %conv4), !dbg !1073
  %2 = load i32, i32* %k1, align 4, !dbg !1074
  %3 = load i32, i32* %k3, align 4, !dbg !1075
  %cmp5 = icmp ne i32 %2, %3, !dbg !1076
  %conv6 = zext i1 %cmp5 to i32, !dbg !1076
  %conv7 = sext i32 %conv6 to i64, !dbg !1074
  call void @klee_assume(i64 %conv7), !dbg !1077
  %4 = load i32, i32* %k2, align 4, !dbg !1078
  %5 = load i32, i32* %k3, align 4, !dbg !1079
  %cmp8 = icmp ne i32 %4, %5, !dbg !1080
  %conv9 = zext i1 %cmp8 to i32, !dbg !1080
  %conv10 = sext i32 %conv9 to i64, !dbg !1078
  call void @klee_assume(i64 %conv10), !dbg !1081
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1082, metadata !DIExpression()), !dbg !1083
  %call11 = call %struct.treetable_s* @make_table(), !dbg !1084
  store %struct.treetable_s* %call11, %struct.treetable_s** %table, align 8, !dbg !1083
  %6 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1085
  %7 = bitcast i32* %k1 to i8*, !dbg !1085
  %8 = bitcast i32* %value to i8*, !dbg !1085
  %call12 = call i32 @treetable_add(%struct.treetable_s* %6, i8* %7, i8* %8), !dbg !1085
  %cmp13 = icmp eq i32 %call12, 0, !dbg !1085
  br i1 %cmp13, label %cond.end, label %cond.false, !dbg !1085

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0), i32 34, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_is_minimum, i64 0, i64 0)) #6, !dbg !1085
  unreachable, !dbg !1085

cond.end:                                         ; preds = %entry
  %9 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1086
  %10 = bitcast i32* %k2 to i8*, !dbg !1086
  %11 = bitcast i32* %value to i8*, !dbg !1086
  %call15 = call i32 @treetable_add(%struct.treetable_s* %9, i8* %10, i8* %11), !dbg !1086
  %cmp16 = icmp eq i32 %call15, 0, !dbg !1086
  br i1 %cmp16, label %cond.end20, label %cond.false19, !dbg !1086

cond.false19:                                     ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0), i32 35, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_is_minimum, i64 0, i64 0)) #6, !dbg !1086
  unreachable, !dbg !1086

cond.end20:                                       ; preds = %cond.end
  %12 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1087
  %13 = bitcast i32* %k3 to i8*, !dbg !1087
  %14 = bitcast i32* %value to i8*, !dbg !1087
  %call21 = call i32 @treetable_add(%struct.treetable_s* %12, i8* %13, i8* %14), !dbg !1087
  %cmp22 = icmp eq i32 %call21, 0, !dbg !1087
  br i1 %cmp22, label %cond.end26, label %cond.false25, !dbg !1087

cond.false25:                                     ; preds = %cond.end20
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0), i32 36, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_is_minimum, i64 0, i64 0)) #6, !dbg !1087
  unreachable, !dbg !1087

cond.end26:                                       ; preds = %cond.end20
  %15 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1088
  %call27 = call i32 @treetable_get_first_key(%struct.treetable_s* %15, i8** %out), !dbg !1088
  %cmp28 = icmp eq i32 %call27, 0, !dbg !1088
  br i1 %cmp28, label %cond.end32, label %cond.false31, !dbg !1088

cond.false31:                                     ; preds = %cond.end26
  call void @__assert_fail(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0), i32 38, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_is_minimum, i64 0, i64 0)) #6, !dbg !1088
  unreachable, !dbg !1088

cond.end32:                                       ; preds = %cond.end26
  %16 = load i8*, i8** %out, align 8, !dbg !1089
  %17 = bitcast i8* %16 to i32*, !dbg !1089
  %18 = load i32, i32* %17, align 4, !dbg !1089
  %19 = load i32, i32* %k1, align 4, !dbg !1089
  %cmp33 = icmp sle i32 %18, %19, !dbg !1089
  br i1 %cmp33, label %cond.end37, label %cond.false36, !dbg !1089

cond.false36:                                     ; preds = %cond.end32
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.9, i64 0, i64 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0), i32 41, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_is_minimum, i64 0, i64 0)) #6, !dbg !1089
  unreachable, !dbg !1089

cond.end37:                                       ; preds = %cond.end32
  %20 = load i8*, i8** %out, align 8, !dbg !1090
  %21 = bitcast i8* %20 to i32*, !dbg !1090
  %22 = load i32, i32* %21, align 4, !dbg !1090
  %23 = load i32, i32* %k2, align 4, !dbg !1090
  %cmp38 = icmp sle i32 %22, %23, !dbg !1090
  br i1 %cmp38, label %cond.end42, label %cond.false41, !dbg !1090

cond.false41:                                     ; preds = %cond.end37
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0), i32 42, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_is_minimum, i64 0, i64 0)) #6, !dbg !1090
  unreachable, !dbg !1090

cond.end42:                                       ; preds = %cond.end37
  %24 = load i8*, i8** %out, align 8, !dbg !1091
  %25 = bitcast i8* %24 to i32*, !dbg !1091
  %26 = load i32, i32* %25, align 4, !dbg !1091
  %27 = load i32, i32* %k3, align 4, !dbg !1091
  %cmp43 = icmp sle i32 %26, %27, !dbg !1091
  br i1 %cmp43, label %cond.end47, label %cond.false46, !dbg !1091

cond.false46:                                     ; preds = %cond.end42
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.11, i64 0, i64 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0), i32 43, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.test_get_first_key_is_minimum, i64 0, i64 0)) #6, !dbg !1091
  unreachable, !dbg !1091

cond.end47:                                       ; preds = %cond.end42
  %28 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1092
  call void @treetable_destroy(%struct.treetable_s* %28), !dbg !1093
  ret void, !dbg !1094
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @symbolic_int(i8* %name, i32 %concrete_fallback) #0 !dbg !1095 {
entry:
  %name.addr = alloca i8*, align 8
  %concrete_fallback.addr = alloca i32, align 4
  %value = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %name.addr, metadata !1101, metadata !DIExpression()), !dbg !1102
  store i32 %concrete_fallback, i32* %concrete_fallback.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %concrete_fallback.addr, metadata !1103, metadata !DIExpression()), !dbg !1104
  call void @llvm.dbg.declare(metadata i32* %value, metadata !1105, metadata !DIExpression()), !dbg !1106
  %0 = load i32, i32* %concrete_fallback.addr, align 4, !dbg !1107
  store i32 %0, i32* %value, align 4, !dbg !1106
  %1 = bitcast i32* %value to i8*, !dbg !1108
  %2 = load i8*, i8** %name.addr, align 8, !dbg !1109
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %2), !dbg !1110
  %3 = load i32, i32* %value, align 4, !dbg !1111
  ret i32 %3, !dbg !1112
}
...
; Function Attrs: noinline nounwind uwtable
define internal %struct.treetable_s* @make_table() #0 !dbg !1113 {
entry:
  %conf = alloca %struct.treetable_conf_s, align 8
  %table = alloca %struct.treetable_s*, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_conf_s* %conf, metadata !1116, metadata !DIExpression()), !dbg !1117
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table, metadata !1118, metadata !DIExpression()), !dbg !1119
  store %struct.treetable_s* null, %struct.treetable_s** %table, align 8, !dbg !1119
  call void @treetable_conf_init(%struct.treetable_conf_s* %conf), !dbg !1120
  %mem_alloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 1, !dbg !1121
  store i8* (i64)* @safe_malloc, i8* (i64)** %mem_alloc, align 8, !dbg !1122
  %mem_calloc = getelementptr inbounds %struct.treetable_conf_s, %struct.treetable_conf_s* %conf, i32 0, i32 2, !dbg !1123
  store i8* (i64, i64)* @safe_calloc, i8* (i64, i64)** %mem_calloc, align 8, !dbg !1124
  %call = call i32 @treetable_new_conf(%struct.treetable_conf_s* %conf, %struct.treetable_s** %table), !dbg !1125
  %cmp = icmp eq i32 %call, 0, !dbg !1125
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !1125

cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.12, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.13, i64 0, i64 0), i32 60, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1125
  unreachable, !dbg !1125

cond.end:                                         ; preds = %entry
  %0 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1126
  %cmp1 = icmp ne %struct.treetable_s* %0, null, !dbg !1126
  br i1 %cmp1, label %cond.end4, label %cond.false3, !dbg !1126

cond.false3:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.14, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.13, i64 0, i64 0), i32 61, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.make_table, i64 0, i64 0)) #6, !dbg !1126
  unreachable, !dbg !1126

cond.end4:                                        ; preds = %cond.end
  %1 = load %struct.treetable_s*, %struct.treetable_s** %table, align 8, !dbg !1127
  ret %struct.treetable_s* %1, !dbg !1128
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !1129 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void @test_get_first_key_is_minimum(), !dbg !1132
  ret i32 0, !dbg !1133
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_left(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1134 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1135, metadata !DIExpression()), !dbg !1136
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1137, metadata !DIExpression()), !dbg !1138
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1139, metadata !DIExpression()), !dbg !1140
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1141
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 5, !dbg !1142
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1142
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1140
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1143
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 4, !dbg !1144
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1144
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1145
  %right1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 5, !dbg !1146
  store %struct.rbnode_s* %3, %struct.rbnode_s** %right1, align 8, !dbg !1147
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1148
  %left2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 4, !dbg !1150
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %left2, align 8, !dbg !1150
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1151
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1152
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1152
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1153
  br i1 %cmp, label %if.then, label %if.end, !dbg !1154

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1155
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1156
  %left3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 4, !dbg !1157
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %left3, align 8, !dbg !1157
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1158
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1159
  br label %if.end, !dbg !1156

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1160
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1161
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1161
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1162
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1163
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1164
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1165
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1167
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1167
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1168
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1169
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1169
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1170
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1171

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1172
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1173
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1174
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1175
  br label %if.end20, !dbg !1173

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1176
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1178
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1179
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1179
  %left11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 4, !dbg !1180
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %left11, align 8, !dbg !1180
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1181
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1182

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1183
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1184
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1185
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1185
  %left15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 4, !dbg !1186
  store %struct.rbnode_s* %25, %struct.rbnode_s** %left15, align 8, !dbg !1187
  br label %if.end20, !dbg !1184

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1188
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1189
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1190
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1190
  %right18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 5, !dbg !1191
  store %struct.rbnode_s* %28, %struct.rbnode_s** %right18, align 8, !dbg !1192
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1193
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1194
  %left21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 4, !dbg !1195
  store %struct.rbnode_s* %31, %struct.rbnode_s** %left21, align 8, !dbg !1196
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1197
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1198
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1199
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1200
  ret void, !dbg !1201
}

; Function Attrs: noinline nounwind uwtable
define internal void @rotate_right(%struct.treetable_s* %table, %struct.rbnode_s* %x) #0 !dbg !1202 {
entry:
  %table.addr = alloca %struct.treetable_s*, align 8
  %x.addr = alloca %struct.rbnode_s*, align 8
  %y = alloca %struct.rbnode_s*, align 8
  store %struct.treetable_s* %table, %struct.treetable_s** %table.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.treetable_s** %table.addr, metadata !1203, metadata !DIExpression()), !dbg !1204
  store %struct.rbnode_s* %x, %struct.rbnode_s** %x.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %x.addr, metadata !1205, metadata !DIExpression()), !dbg !1206
  call void @llvm.dbg.declare(metadata %struct.rbnode_s** %y, metadata !1207, metadata !DIExpression()), !dbg !1208
  %0 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1209
  %left = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %0, i32 0, i32 4, !dbg !1210
  %1 = load %struct.rbnode_s*, %struct.rbnode_s** %left, align 8, !dbg !1210
  store %struct.rbnode_s* %1, %struct.rbnode_s** %y, align 8, !dbg !1208
  %2 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1211
  %right = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %2, i32 0, i32 5, !dbg !1212
  %3 = load %struct.rbnode_s*, %struct.rbnode_s** %right, align 8, !dbg !1212
  %4 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1213
  %left1 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %4, i32 0, i32 4, !dbg !1214
  store %struct.rbnode_s* %3, %struct.rbnode_s** %left1, align 8, !dbg !1215
  %5 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1216
  %right2 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %5, i32 0, i32 5, !dbg !1218
  %6 = load %struct.rbnode_s*, %struct.rbnode_s** %right2, align 8, !dbg !1218
  %7 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1219
  %sentinel = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %7, i32 0, i32 1, !dbg !1220
  %8 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel, align 8, !dbg !1220
  %cmp = icmp ne %struct.rbnode_s* %6, %8, !dbg !1221
  br i1 %cmp, label %if.then, label %if.end, !dbg !1222

if.then:                                          ; preds = %entry
  %9 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1223
  %10 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1224
  %right3 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %10, i32 0, i32 5, !dbg !1225
  %11 = load %struct.rbnode_s*, %struct.rbnode_s** %right3, align 8, !dbg !1225
  %parent = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %11, i32 0, i32 3, !dbg !1226
  store %struct.rbnode_s* %9, %struct.rbnode_s** %parent, align 8, !dbg !1227
  br label %if.end, !dbg !1224

if.end:                                           ; preds = %if.then, %entry
  %12 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1228
  %parent4 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %12, i32 0, i32 3, !dbg !1229
  %13 = load %struct.rbnode_s*, %struct.rbnode_s** %parent4, align 8, !dbg !1229
  %14 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1230
  %parent5 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %14, i32 0, i32 3, !dbg !1231
  store %struct.rbnode_s* %13, %struct.rbnode_s** %parent5, align 8, !dbg !1232
  %15 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1233
  %parent6 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %15, i32 0, i32 3, !dbg !1235
  %16 = load %struct.rbnode_s*, %struct.rbnode_s** %parent6, align 8, !dbg !1235
  %17 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1236
  %sentinel7 = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %17, i32 0, i32 1, !dbg !1237
  %18 = load %struct.rbnode_s*, %struct.rbnode_s** %sentinel7, align 8, !dbg !1237
  %cmp8 = icmp eq %struct.rbnode_s* %16, %18, !dbg !1238
  br i1 %cmp8, label %if.then9, label %if.else, !dbg !1239

if.then9:                                         ; preds = %if.end
  %19 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1240
  %20 = load %struct.treetable_s*, %struct.treetable_s** %table.addr, align 8, !dbg !1241
  %root = getelementptr inbounds %struct.treetable_s, %struct.treetable_s* %20, i32 0, i32 0, !dbg !1242
  store %struct.rbnode_s* %19, %struct.rbnode_s** %root, align 8, !dbg !1243
  br label %if.end20, !dbg !1241

if.else:                                          ; preds = %if.end
  %21 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1244
  %22 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1246
  %parent10 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %22, i32 0, i32 3, !dbg !1247
  %23 = load %struct.rbnode_s*, %struct.rbnode_s** %parent10, align 8, !dbg !1247
  %right11 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %23, i32 0, i32 5, !dbg !1248
  %24 = load %struct.rbnode_s*, %struct.rbnode_s** %right11, align 8, !dbg !1248
  %cmp12 = icmp eq %struct.rbnode_s* %21, %24, !dbg !1249
  br i1 %cmp12, label %if.then13, label %if.else16, !dbg !1250

if.then13:                                        ; preds = %if.else
  %25 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1251
  %26 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1252
  %parent14 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %26, i32 0, i32 3, !dbg !1253
  %27 = load %struct.rbnode_s*, %struct.rbnode_s** %parent14, align 8, !dbg !1253
  %right15 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %27, i32 0, i32 5, !dbg !1254
  store %struct.rbnode_s* %25, %struct.rbnode_s** %right15, align 8, !dbg !1255
  br label %if.end20, !dbg !1252

if.else16:                                        ; preds = %if.else
  %28 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1256
  %29 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1257
  %parent17 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %29, i32 0, i32 3, !dbg !1258
  %30 = load %struct.rbnode_s*, %struct.rbnode_s** %parent17, align 8, !dbg !1258
  %left18 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %30, i32 0, i32 4, !dbg !1259
  store %struct.rbnode_s* %28, %struct.rbnode_s** %left18, align 8, !dbg !1260
  br label %if.end20

if.end20:                                         ; preds = %if.then13, %if.else16, %if.then9
  %31 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1261
  %32 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1262
  %right21 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %32, i32 0, i32 5, !dbg !1263
  store %struct.rbnode_s* %31, %struct.rbnode_s** %right21, align 8, !dbg !1264
  %33 = load %struct.rbnode_s*, %struct.rbnode_s** %y, align 8, !dbg !1265
  %34 = load %struct.rbnode_s*, %struct.rbnode_s** %x.addr, align 8, !dbg !1266
  %parent22 = getelementptr inbounds %struct.rbnode_s, %struct.rbnode_s* %34, i32 0, i32 3, !dbg !1267
  store %struct.rbnode_s* %33, %struct.rbnode_s** %parent22, align 8, !dbg !1268
  ret void, !dbg !1269
}
...
; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_malloc(i64 %size) #0 !dbg !1270 {
entry:
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1271, metadata !DIExpression()), !dbg !1272
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1273, metadata !DIExpression()), !dbg !1274
  %0 = load i64, i64* %size.addr, align 8, !dbg !1275
  %call = call noalias align 16 i8* @malloc(i64 %0) #7, !dbg !1276
  store i8* %call, i8** %ptr, align 8, !dbg !1274
  %1 = load i8*, i8** %ptr, align 8, !dbg !1277
  %cmp = icmp ne i8* %1, null, !dbg !1278
  %conv = zext i1 %cmp to i32, !dbg !1278
  %conv1 = sext i32 %conv to i64, !dbg !1277
  call void @klee_assume(i64 %conv1), !dbg !1279
  %2 = load i8*, i8** %ptr, align 8, !dbg !1280
  ret i8* %2, !dbg !1281
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @safe_calloc(i64 %count, i64 %size) #0 !dbg !1282 {
entry:
  %count.addr = alloca i64, align 8
  %size.addr = alloca i64, align 8
  %ptr = alloca i8*, align 8
  store i64 %count, i64* %count.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %count.addr, metadata !1283, metadata !DIExpression()), !dbg !1284
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !1285, metadata !DIExpression()), !dbg !1286
  call void @llvm.dbg.declare(metadata i8** %ptr, metadata !1287, metadata !DIExpression()), !dbg !1288
  %0 = load i64, i64* %count.addr, align 8, !dbg !1289
  %1 = load i64, i64* %size.addr, align 8, !dbg !1290
  %call = call noalias align 16 i8* @calloc(i64 %0, i64 %1) #7, !dbg !1291
  store i8* %call, i8** %ptr, align 8, !dbg !1288
  %2 = load i8*, i8** %ptr, align 8, !dbg !1292
  %cmp = icmp ne i8* %2, null, !dbg !1293
  %conv = zext i1 %cmp to i32, !dbg !1293
  %conv1 = sext i32 %conv to i64, !dbg !1292
  call void @klee_assume(i64 %conv1), !dbg !1294
  %3 = load i8*, i8** %ptr, align 8, !dbg !1295
  ret i8* %3, !dbg !1296
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #0 !dbg !1297 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %destaddr.addr, metadata !1303, metadata !DIExpression()), !dbg !1304
  store i8* %srcaddr, i8** %srcaddr.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %srcaddr.addr, metadata !1305, metadata !DIExpression()), !dbg !1306
  store i64 %len, i64* %len.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %len.addr, metadata !1307, metadata !DIExpression()), !dbg !1308
  call void @llvm.dbg.declare(metadata i8** %dest, metadata !1309, metadata !DIExpression()), !dbg !1311
  %0 = load i8*, i8** %destaddr.addr, align 8, !dbg !1312
  store i8* %0, i8** %dest, align 8, !dbg !1311
  call void @llvm.dbg.declare(metadata i8** %src, metadata !1313, metadata !DIExpression()), !dbg !1314
  %1 = load i8*, i8** %srcaddr.addr, align 8, !dbg !1315
  store i8* %1, i8** %src, align 8, !dbg !1314
  br label %while.cond, !dbg !1316

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i64, i64* %len.addr, align 8, !dbg !1317
  %dec = add i64 %2, -1, !dbg !1317
  store i64 %dec, i64* %len.addr, align 8, !dbg !1317
  %cmp = icmp ugt i64 %2, 0, !dbg !1318
  br i1 %cmp, label %while.body, label %while.end, !dbg !1316

while.body:                                       ; preds = %while.cond
  %3 = load i8*, i8** %src, align 8, !dbg !1319
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1, !dbg !1319
  store i8* %incdec.ptr, i8** %src, align 8, !dbg !1319
  %4 = load i8, i8* %3, align 1, !dbg !1320
  %5 = load i8*, i8** %dest, align 8, !dbg !1321
  %incdec.ptr1 = getelementptr inbounds i8, i8* %5, i32 1, !dbg !1321
  store i8* %incdec.ptr1, i8** %dest, align 8, !dbg !1321
  store i8 %4, i8* %5, align 1, !dbg !1322
  br label %while.cond, !dbg !1316, !llvm.loop !1323

while.end:                                        ; preds = %while.cond
  %6 = load i8*, i8** %destaddr.addr, align 8, !dbg !1324
  ret i8* %6, !dbg !1325
}
...
!1 = !DIFile(filename: "test_get_first_key_is_minimum.c", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!2 = !{!3}
...
!1053 = distinct !DISubprogram(name: "test_get_first_key_is_minimum", scope: !1, file: !1, line: 20, type: !1054, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1054 = !DISubroutineType(types: !1055)
!1055 = !{null}
!1056 = !DILocalVariable(name: "k1", scope: !1053, file: !1, line: 22, type: !18)
!1057 = !DILocation(line: 22, column: 9, scope: !1053)
!1058 = !DILocation(line: 22, column: 17, scope: !1053)
!1059 = !DILocalVariable(name: "k2", scope: !1053, file: !1, line: 23, type: !18)
!1060 = !DILocation(line: 23, column: 9, scope: !1053)
!1061 = !DILocation(line: 23, column: 17, scope: !1053)
!1062 = !DILocalVariable(name: "k3", scope: !1053, file: !1, line: 24, type: !18)
!1063 = !DILocation(line: 24, column: 9, scope: !1053)
!1064 = !DILocation(line: 24, column: 17, scope: !1053)
!1065 = !DILocalVariable(name: "value", scope: !1053, file: !1, line: 25, type: !18)
!1066 = !DILocation(line: 25, column: 9, scope: !1053)
!1067 = !DILocation(line: 25, column: 17, scope: !1053)
!1068 = !DILocalVariable(name: "out", scope: !1053, file: !1, line: 26, type: !19)
!1069 = !DILocation(line: 26, column: 11, scope: !1053)
!1070 = !DILocation(line: 28, column: 17, scope: !1053)
!1071 = !DILocation(line: 28, column: 23, scope: !1053)
!1072 = !DILocation(line: 28, column: 20, scope: !1053)
!1073 = !DILocation(line: 28, column: 5, scope: !1053)
!1074 = !DILocation(line: 29, column: 17, scope: !1053)
!1075 = !DILocation(line: 29, column: 23, scope: !1053)
!1076 = !DILocation(line: 29, column: 20, scope: !1053)
!1077 = !DILocation(line: 29, column: 5, scope: !1053)
!1078 = !DILocation(line: 30, column: 17, scope: !1053)
!1079 = !DILocation(line: 30, column: 23, scope: !1053)
!1080 = !DILocation(line: 30, column: 20, scope: !1053)
!1081 = !DILocation(line: 30, column: 5, scope: !1053)
!1082 = !DILocalVariable(name: "table", scope: !1053, file: !1, line: 32, type: !107)
!1083 = !DILocation(line: 32, column: 16, scope: !1053)
!1084 = !DILocation(line: 32, column: 24, scope: !1053)
!1085 = !DILocation(line: 34, column: 5, scope: !1053)
!1086 = !DILocation(line: 35, column: 5, scope: !1053)
!1087 = !DILocation(line: 36, column: 5, scope: !1053)
!1088 = !DILocation(line: 38, column: 5, scope: !1053)
!1089 = !DILocation(line: 41, column: 5, scope: !1053)
!1090 = !DILocation(line: 42, column: 5, scope: !1053)
!1091 = !DILocation(line: 43, column: 5, scope: !1053)
!1092 = !DILocation(line: 45, column: 23, scope: !1053)
!1093 = !DILocation(line: 45, column: 5, scope: !1053)
!1094 = !DILocation(line: 46, column: 1, scope: !1053)
!1095 = distinct !DISubprogram(name: "symbolic_int", scope: !1096, file: !1096, line: 32, type: !1097, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1096 = !DIFile(filename: "./klee_helpers.h", directory: "/home/klee/work/ex3/Ex3SymbTestSuite")
!1097 = !DISubroutineType(types: !1098)
!1098 = !{!18, !1099, !18}
!1099 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1100, size: 64)
!1100 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !119)
!1101 = !DILocalVariable(name: "name", arg: 1, scope: !1095, file: !1096, line: 32, type: !1099)
!1102 = !DILocation(line: 32, column: 37, scope: !1095)
!1103 = !DILocalVariable(name: "concrete_fallback", arg: 2, scope: !1095, file: !1096, line: 32, type: !18)
!1104 = !DILocation(line: 32, column: 47, scope: !1095)
!1105 = !DILocalVariable(name: "value", scope: !1095, file: !1096, line: 34, type: !18)
!1106 = !DILocation(line: 34, column: 9, scope: !1095)
!1107 = !DILocation(line: 34, column: 17, scope: !1095)
!1108 = !DILocation(line: 35, column: 24, scope: !1095)
!1109 = !DILocation(line: 35, column: 47, scope: !1095)
!1110 = !DILocation(line: 35, column: 5, scope: !1095)
!1111 = !DILocation(line: 36, column: 12, scope: !1095)
!1112 = !DILocation(line: 36, column: 5, scope: !1095)
!1113 = distinct !DISubprogram(name: "make_table", scope: !1096, file: !1096, line: 53, type: !1114, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1114 = !DISubroutineType(types: !1115)
!1115 = !{!107}
!1116 = !DILocalVariable(name: "conf", scope: !1113, file: !1096, line: 55, type: !67)
!1117 = !DILocation(line: 55, column: 19, scope: !1113)
!1118 = !DILocalVariable(name: "table", scope: !1113, file: !1096, line: 56, type: !107)
!1119 = !DILocation(line: 56, column: 16, scope: !1113)
!1120 = !DILocation(line: 57, column: 5, scope: !1113)
!1121 = !DILocation(line: 58, column: 10, scope: !1113)
!1122 = !DILocation(line: 58, column: 22, scope: !1113)
!1123 = !DILocation(line: 59, column: 10, scope: !1113)
!1124 = !DILocation(line: 59, column: 22, scope: !1113)
!1125 = !DILocation(line: 60, column: 5, scope: !1113)
!1126 = !DILocation(line: 61, column: 5, scope: !1113)
!1127 = !DILocation(line: 62, column: 12, scope: !1113)
!1128 = !DILocation(line: 62, column: 5, scope: !1113)
!1129 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line:
scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !22)
!1283 = !DILocalVariable(name: "count", arg: 1, scope: !1282, file: !1096, line: 46, type: !77)
!1284 = !DILocation(line: 46, column: 33, scope: !1282)
!1285 = !DILocalVariable(name: "size", arg: 2, scope: !1282, file: !1096, line: 46, type: !77)
!1286 = !DILocation(line: 46, column: 47, scope: !1282)
!1287 = !DILocalVariable(name: "ptr", scope: !1282, file: !1096, line: 48, type: !19)
!1288 = !DILocation(line: 48, column: 11, scope: !1282)
!1289 = !DILocation(line: 48, column: 24, scope: !1282)
!1290 = !DILocation(line: 48, column: 31, scope: !1282)
!1291 = !DILocation(line: 48, column: 17, scope: !1282)
!1292 = !DILocation(line: 49, column: 17, scope: !1282)
!1293 = !DILocation(line: 49, column: 21, scope: !1282)
!1294 = !DILocation(line: 49, column: 5, scope: !1282)
!1295 = !DILocation(line: 50, column: 12, scope: !1282)
!1296 = !DILocation(line: 50, column: 5, scope: !1282)
!1297 = distinct !DISubprogram(name: "memcpy", scope: !1298, file: !1298, line: 12, type: !1299, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !22)
!1298 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1299 = !DISubroutineType(types: !1300)
!1300 = !{!19, !19, !33, !1301}
!1301 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1302, line: 46, baseType: !79)
!1302 = !DIFile(filename: "llvm-130-install_O_D_A/lib/clang/13.0.1/include/stddef.h", directory: "/tmp")
!1303 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1297, file: !1298, line: 12, type: !19)
!1304 = !DILocation(line: 12, column: 20, scope: !1297)
!1305 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1297, file: !1298, line: 12, type: !33)
!1306 = !DILocation(line: 12, column: 42, scope: !1297)
!1307 = !DILocalVariable(name: "len", arg: 3, scope: !1297, file: !1298, line: 12, type: !1301)
!1308 = !DILocation(line: 12, column: 58, scope: !1297)
!1309 = !DILocalVariable(name: "dest", scope: !1297, file: !1298, line: 13, type: !1310)
!1310 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64)
!1311 = !DILocation(line: 13, column: 9, scope: !1297)
!1312 = !DILocation(line: 13, column: 16, scope: !1297)
!1313 = !DILocalVariable(name: "src", scope: !1297, file: !1298, line: 14, type: !1099)
!1314 = !DILocation(line: 14, column: 15, scope: !1297)
!1315 = !DILocation(line: 14, column: 21, scope: !1297)
!1316 = !DILocation(line: 16, column: 3, scope: !1297)
!1317 = !DILocation(line: 16, column: 13, scope: !1297)
!1318 = !DILocation(line: 16, column: 16, scope: !1297)
!1319 = !DILocation(line: 17, column: 19, scope: !1297)
!1320 = !DILocation(line: 17, column: 15, scope: !1297)
!1321 = !DILocation(line: 17, column: 10, scope: !1297)
!1322 = !DILocation(line: 17, column: 13, scope: !1297)
!1323 = distinct !{!1323, !1316, !1319, !332}
!1324 = !DILocation(line: 18, column: 10, scope: !1297)
!1325 = !DILocation(line: 18, column: 3, scope: !1297)
